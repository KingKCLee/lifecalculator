...
inherit:`<h2>상속세 완벽 가이드</h2><h3>상속세란?</h3><p>피상속인(사망자)의 재산이 상속인에게 이전될 때 부과되는 국세입니다. 상속개시일(사망일)이 속하는 달의 말일부터 6개월 이내에 관할 세무서에 신고·납부해야 합니다.</p><h3>공제 체계</h3><p>기초공제 2억원 + 인적공제(자녀 1인당 5천만원 등). 기초+인적 합산이 5억원 미만이면 일괄공제 5억원 적용. 배우자공제는 5~30억원 한도 내 법정상속분. 금융재산공제, 동거주택상속공제(6억 한도), 영농상속공제(15억 한도)도 별도.</p><h3>세율</h3><p>과세표준 1억 이하 10%, 5억 이하 20%, 10억 이하 30%, 30억 이하 40%, 30억 초과 50%. 신고기한 내 자진신고 시 3% 세액공제.</p><h3>절세 팁</h3><p>사전증여로 상속재산 분산, 배우자공제 극대화, 금융재산공제 활용이 핵심입니다. 10년 이내 증여재산은 상속재산에 합산되므로 장기 계획이 필요합니다.</p>`,

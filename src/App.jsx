...
function CalcComm({isMo=false,onNav=()=>{}}){const[ty,sTy]=useState("res");const[tx,sTx]=useState("sale");const[p,sP]=useState("90000");const[dep,sDep]=useState("5000");const[mon,sMon]=useState("50");const[mult,sMult]=useState("100");

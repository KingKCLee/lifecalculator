        ...
        <div style={{display:"flex",alignItems:"center",height:64,padding:"0 24px",gap:16,position:"relative"}}>
          ...
          <div style={{position:"absolute",left:"50%",top:0,bottom:0,transform:"translateX(-50%)",display:"flex",alignItems:"center",gap:4}}>
            ...
            <div onMouseEnter={megaOpen} onMouseLeave={megaClose} style={{position:"relative"}}>
              <button type="button" onMouseDown={(e)=>e.preventDefault()} onMouseEnter={()=>{setShowInfoMenu(true);setClickedCat("info");}} onClick={(e)=>{e.preventDefault();e.stopPropagation();const next=!showInfoMenu;setShowInfoMenu(next);setClickedCat(next?"info":null);}} style={{padding:"0 16px",border:"none",borderRadius:0,background:showInfoMenu?"#ffffff":"transparent",color:page==="info"?"#0747A6":"#6B7280",fontSize:16,fontWeight:showInfoMenu?500:(page==="info"?700:600),cursor:"pointer",fontFamily:"inherit",borderBottom:showInfoMenu?"none":(page==="info"?"3px solid #0747A6":"3px solid transparent"),transition:"transform 0.2s cubic-bezier(0.34, 1.56, 0.64, 1), background .15s, color .15s, box-shadow .15s",height:64,display:"inline-flex",alignItems:"center",gap:6,transform:showInfoMenu?"scale(1.08)":"scale(1)",transformOrigin:"center center",willChange:"transform",position:"relative",zIndex:showInfoMenu?1001:"auto",boxShadow:showInfoMenu?"0 1px 0 0 #ffffff":"none",outline:"none"}}><span style={{display:"inline-flex"}}>{TAB_ICONS.info}</span>정보센터</button>

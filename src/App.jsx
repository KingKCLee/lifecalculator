...
compre:{q:"종합부동산세는 누가 내나요?",a:"매년 6.1 기준 보유 주택 공시가격 합계가 공제금액(1주택 12억, 다주택 9억)을 초과하면 부과됩니다. 과세표준은 (공시가-공제)×공정시장가액비율(60%)이며, 세율은 일반 0.5~2.7%, 3주택 중과 0.5~5.0%입니다. 1주택자는 고령자 공제(10~30%)+장기보유 공제(20~50%)를 합산하여 최대 80% 감면 가능합니다.",
  ...
  {icon:"❓",title:"종합부동산세란?",body:"보유 주택의 공시가격 합계가 기준(1주택 12억, 다주택 9억)을 초과할 때 부과되는 국세입니다."},
  {icon:"💡",title:"절세 팁",body:"• 부부 공동명의: 각각 9억 공제 = 총 18억 공제 (1주택 12억보다 유리할 수 있음)\n• 1주택자 고령+장기보유 합산 최대 80% 공제\n• 임대사업자 등록 주택은 합산 배제 가능 (요건 충족 시)\n• 공시가격 이의신청 (4~5월) 활용"},
  {icon:"📅",title:"신고 기한 및 방법",body:"• 매년 12월 1일~15일 (고지서 기반 납부)\n• 250만원 초과 시 분납 가능 (6개월 이내)\n• 신고: 홈택스 → 종합부동산세"},
  {icon:"⚠️",title:"주의사항",body:"• 과세기준일 6월 1일 기준 보유자에게 과세\n• 5월 31일 매도 → 종부세 없음, 6월 1일 보유 → 종부세 부과\n• 공정시장가액비율 60% (2023년~)"}
]},
property:{q:"재산세는 얼마나 나오나요?",a:"매년 6.1 기준 부동산 보유자에게 부과되는 지방세입니다. 주택의 과세표준은 공시가격×60%이며, 세율 0.1~0.4%가 누진 적용됩니다. 도시지역분(과세표준의 0.14%)과 지방교육세(재산세의 20%)가 별도 부과됩니다. 7월 건물분+토지분 절반, 9월 나머지 절반을 나누어 납부합니다. 상가 건축물은 0.25% 단일세율입니다.",
  ...
  {icon:"❓",title:"재산세란?",body:"매년 6월 1일 기준 부동산 보유자에게 부과되는 지방세입니다."},
  {icon:"💡",title:"절세 팁",body:"• 1세대1주택 공정시장가액비율 특례 (43~45%, 2026년까지)\n• 9억 이하 1주택은 세부담상한 105%로 인상폭 제한\n• 공시가격 이의신청으로 과세표준 낮추기 가능"},
  {icon:"📅",title:"납부 기한 및 방법",body:"• 7월: 건축물분 + 주택 1/2\n• 9월: 토지분 + 주택 나머지 1/2\n• 고지서 기반 납부 (별도 신고 불요)\n• 위택스 또는 은행 납부"},
  {icon:"⚠️",title:"주의사항",body:"• 재산세와 종부세는 이중과세 조정 (종부세에서 재산세 차감)\n• 공동소유 시 지분별 각자 납부"}
]},
gift:{q:"증여세 공제한도는?",a:"재산을 무상으로 받으면 부과되는 국세입니다. 10년 합산 기준으로 배우자 6억, 성년자녀 5천만, 미성년자녀 2천만, 기타 친족 1천만원을 공제받습니다. 동일인으로부터 10년 이내 증여받은 금액은 합산하여 누진세율이 적용되며, 기납부세액은 차감됩니다. 2024년부터 혼인·출산 시 1억원 추가공제가 신설되었습니다. 세율은 10~50% 5단계 누진이며, 기한 내 신고 시 3% 세액공제됩니다.",
  ...
  {icon:"❓",title:"증여세란?",body:"타인으로부터 무상으로 재산을 받을 때 수증자(받는 사람)가 납부하는 국세입니다."},
  {icon:"💡",title:"절세 팁",body:"• 10년 단위 공제한도 활용: 배우자 6억, 성년자녀 5천만 → 10년마다 리셋\n• 혼인·출산 시 추가 1억 공제 (2024년~)\n• 부담부증여: 채무 인수분은 양도세 과세 → 증여세보다 낮을 수 있음\n• 자녀에게 미리 증여 → 향후 상속세 절감 효과"},
  {icon:"📅",title:"신고 기한 및 방법",body:"• 증여받은 날이 속한 달의 말일부터 3개월 이내\n• 신고세액공제 3% (기한 내 신고 시)\n• 신고: 홈택스 → 증여세 신고"},
  {icon:"⚠️",title:"주의사항",body:"• 동일인 10년 합산 과세 (직계존속은 그룹 합산)\n• 부동산 증여는 취득세 3.5% 별도 부과\n• 조정지역 공시가 3억 초과 주택 증여 시 취득세 12% 중과"}
]},
inherit:{q:"상속세 계산 구조는?",a:"사망으로 재산이 이전될 때 부과됩니다. 기초공제 5억+일괄공제 5억으로 최소 10억이 공제되며, 배우자 상속공제는 실제 상속액의 법정상속분 내에서 5~30억까지 가능합니다. 배우자가 없으면 일괄공제 5억만 적용됩니다. 세율은 10~50%이며, 장례비용은 최대 1,500만원까지 공제. 신고기한은 사망일로부터 6개월, 연부연납 최대 10년 가능합니다.",
  rates:[["1억↓","10%","없음"],["~5억","20%","1천만"],["~10억","30%","6천만"],["~30억","40%","1.6억"],["30억↑","50%","4.6억"]],rh:["과세표준","세율","누진공제"],faqList:[
  {icon:"❓",title:"상속세란?",body:"사망으로 인해 상속인에게 재산이 이전될 때 부과되는 국세입니다."},
  {icon:"💡",title:"절세 팁",body:"• 일괄공제 5억 vs 기초+인적공제 비교하여 유리한 것 선택\n• 배우자 상속공제 최소 5억 (법정상속분 한도 내 최대 30억)\n• 사전증여 활용: 10년 전 증여분은 상속재산 합산 제외\n• 동거주택 상속공제: 10년 동거+무주택 상속인 → 최대 6억"},
  {icon:"📅",title:"신고 기한 및 방법",body:"• 사망일이 속한 달의 말일부터 6개월 이내\n• 신고세액공제 3%\n• 신고: 홈택스 → 상속세 신고\n• 연부연납: 2천만원 초과 시 5년 분납 가능 (부동산 비중↑ 시 최대 10년)"},
  {icon:"⚠️",title:"주의사항",body:"• 사망 전 1년 이내 2억, 2년 이내 5억 초과 처분 시 용도 소명 필요\n• 보험금, 퇴직금도 상속재산에 포함"}
]},
dsr:{q:"DSR 규제 기준은?",a:"연소득 대비 모든 금융권 대출의 연간 원리금 상환비율입니다. 은행 40%, 비은행 50% 이내여야 합니다. 2025년부터 스트레스 DSR 3단계가 전면 시행되어, 변동금리 대출 시 가산금리 +1.5%p, 혼합형 +0.75%p가 적용됩니다. 차주 연령에 따라 만기도 제한(50대 20년, 40대 30년 등)되므로 실제 대출 한도는 단순 계산보다 낮을 수 있습니다.",
  ...
  {icon:"❓",title:"DSR이란?",body:"총부채원리금상환비율. 연소득 대비 모든 금융권 대출의 연간 원리금 상환비율. 은행 40%, 비은행 50% 이내."},
  {icon:"💡",title:"유리한 대출 팁",body:"• 원금균등 > 원리금균등 (총이자 절감, 초기 부담 큼)\n• 고정금리: 스트레스DSR 가산 적어 한도 유리할 수 있음\n• 생애최초: 비규제 LTV 80%, 규제 70% (한도 6억)\n• 서민실수요자: 투기과열 60%, 조정 70%\n• 중도상환수수료: 3년 후 면제 (대부분 은행)"},
  {icon:"📅",title:"대출 관련 기한",body:"• 잔금일 전 대출 승인 필요 (최소 2~3주 전 신청)\n• 전입신고: 규제지역 주담대 실행 후 6개월 이내 전입 의무\n• 기존주택 처분: 규제지역 2년 이내"},
  {icon:"⚠️",title:"주의사항",body:"• 스트레스DSR 3단계(+1.5%p) 적용 중 → 실제 한도 예상보다 적음\n• 전세대출도 DSR 산정에 포함될 수 있음\n• 15억 초과 주택: 주담대 최대 6억 한도"}
]},
dti:{q:"DTI란 무엇인가요?",a:"총부채상환비율로, 연소득 대비 신규 주담대 원리금+기존 대출 이자의 비율입니다. DSR과 달리 기존 대출은 이자만 포함합니다. 투기과열지구 40%, 조정대상지역 50%, 비규제 60%가 한도입니다.",
  ...
  {icon:"❓",title:"DTI란?",body:"총부채상환비율. 연소득 대비 신규 주담대 원리금+기존 대출 이자의 비율. DSR과 달리 기존 대출은 이자만 포함."},
  {icon:"💡",title:"유리한 대출 팁",body:"• 원금균등 > 원리금균등 (총이자 절감, 초기 부담 큼)\n• 고정금리: 스트레스DSR 가산 적어 한도 유리할 수 있음\n• 생애최초: 비규제 LTV 80%, 규제 70% (한도 6억)\n• 서민실수요자: 투기과열 60%, 조정 70%\n• 중도상환수수료: 3년 후 면제 (대부분 은행)"},
  {icon:"📅",title:"대출 관련 기한",body:"• 잔금일 전 대출 승인 필요 (최소 2~3주 전 신청)\n• 전입신고: 규제지역 주담대 실행 후 6개월 이내 전입 의무\n• 기존주택 처분: 규제지역 2년 이내"},
  {icon:"⚠️",title:"주의사항",body:"• 스트레스DSR 3단계(+1.5%p) 적용 중 → 실제 한도 예상보다 적음\n• 전세대출도 DSR 산정에 포함될 수 있음\n• 15억 초과 주택: 주담대 최대 6억 한도"}
]},
ltv:{q:"LTV 한도는?",a:"주택담보대출비율로, 주택가격 대비 최대 대출 가능 비율입니다. 투기과열지구 40%, 조정대상 50%, 비규제 70%가 기본이며, 생애최초 구입자는 80%까지 가능합니다. 규제지역 다주택자(2주택+)는 원칙적으로 주택담보대출이 제한됩니다.",
  ...
  {icon:"❓",title:"LTV란?",body:"주택담보대출비율. 주택가격 대비 최대 대출 가능 비율. 투기과열 40%, 조정 50%, 비규제 70% 기본."},
  {icon:"💡",title:"유리한 대출 팁",body:"• 원금균등 > 원리금균등 (총이자 절감, 초기 부담 큼)\n• 고정금리: 스트레스DSR 가산 적어 한도 유리할 수 있음\n• 생애최초: 비규제 LTV 80%, 규제 70% (한도 6억)\n• 서민실수요자: 투기과열 60%, 조정 70%\n• 중도상환수수료: 3년 후 면제 (대부분 은행)"},
  {icon:"📅",title:"대출 관련 기한",body:"• 잔금일 전 대출 승인 필요 (최소 2~3주 전 신청)\n• 전입신고: 규제지역 주담대 실행 후 6개월 이내 전입 의무\n• 기존주택 처분: 규제지역 2년 이내"},
  {icon:"⚠️",title:"주의사항",body:"• 스트레스DSR 3단계(+1.5%p) 적용 중 → 실제 한도 예상보다 적음\n• 전세대출도 DSR 산정에 포함될 수 있음\n• 15억 초과 주택: 주담대 최대 6억 한도"}
]},
mortgage:{q:"대출 상환 방식 차이는?",a:"원리금균등은 매월 동일한 금액을 납부하여 초기 부담이 낮습니다. 원금균등은 원금을 균등 분할하여 이자가 점차 줄어들어 총이자가 적습니다. 만기일시는 매월 이자만 내고 만기에 원금을 일시 상환합니다. 총이자는 만기일시 > 원리금균등 > 원금균등 순으로 많습니다.",
  ...
  {icon:"❓",title:"대출이자 계산",body:"주택담보대출 시 상환 방식·기간·금리에 따른 월 납입금·총 이자를 계산합니다."},
  {icon:"💡",title:"유리한 대출 팁",body:"• 원금균등 > 원리금균등 (총이자 절감, 초기 부담 큼)\n• 고정금리: 스트레스DSR 가산 적어 한도 유리할 수 있음\n• 생애최초: 비규제 LTV 80%, 규제 70% (한도 6억)\n• 서민실수요자: 투기과열 60%, 조정 70%\n• 중도상환수수료: 3년 후 면제 (대부분 은행)"},
  {icon:"📅",title:"대출 관련 기한",body:"• 잔금일 전 대출 승인 필요 (최소 2~3주 전 신청)\n• 전입신고: 규제지역 주담대 실행 후 6개월 이내 전입 의무\n• 기존주택 처분: 규제지역 2년 이내"},
  {icon:"⚠️",title:"주의사항",body:"• 스트레스DSR 3단계(+1.5%p) 적용 중 → 실제 한도 예상보다 적음\n• 전세대출도 DSR 산정에 포함될 수 있음\n• 15억 초과 주택: 주담대 최대 6억 한도"}
]},
commission:{q:"중개보수 요율은?",a:"매매 시 9억 이하 0.4%, 15억 이상 0.7%가 상한입니다. 전세·월세는 6억 이하 0.3%가 적용됩니다. 월세 거래 시 거래금액은 '보증금 + (월세 × 100)'으로 산정하되, 보증금보다 작으면 보증금 기준입니다. 상가·토지·오피스텔은 0.9% 이내 협의합니다. 부가세 10%가 별도 부과됩니다.",
  ...
  {icon:"❓",title:"중개보수란?",body:"부동산 거래 시 공인중개사에게 지불하는 수수료입니다."},
  {icon:"💡",title:"절감 팁",body:"• 요율 상한이므로 협의 가능\n• 매도·매수 각각 부담\n• 부가세 별도(일반과세 사업자)"},
  {icon:"📅",title:"지급 시기",body:"• 잔금 지급 시 지불이 관행"},
  {icon:"⚠️",title:"주의사항",body:"• 상가·토지·오피스텔은 0.9% 이내 협의\n• 월세 환산 거래금액 = 보증금 + (월세×100), 보증금보다 작으면 보증금 기준"}
]},
registration:{q:"등기비용 구성은?",a:"소유권이전등기 시 인지세(1억 이하 비과세, 1~10억 15만원, 10억 초과 35만원), 국민주택채권 할인비용(매매가의 3~5%를 매입 후 할인 매도), 법원 등기수수료(15,000원)가 발생합니다. 취득세·등록면허세는 별도 납부합니다.",
  ...
  {icon:"❓",title:"등기비용이란?",body:"소유권 이전 시 발생하는 등록면허세+국민주택채권+법원수수료입니다."},
  {icon:"💡",title:"절감 팁",body:"• 국민주택채권은 즉시 할인매도 가능 (할인율 확인 후 실부담 계산)"},
  {icon:"📅",title:"등기 기한",body:"• 잔금일로부터 60일 이내 등기 신청"},
  {icon:"⚠️",title:"주의사항",body:"• 취득세·등록면허세는 별도 납부\n• 인지세는 거래금액별 차등 (1억↓ 비과세)"}
]},
legal:{q:"법무사 수수료 기준은?",a:"대한법무사협회 보수표를 기준으로 부동산 가액에 따라 11만~77만원의 기본보수가 책정됩니다. 상속·증여는 약 30% 가산, 근저당설정은 약 50% 수준입니다. 기본보수 외 부가세(10%), 서류작성비, 교통비 등이 추가됩니다. 실제 비용은 법무사에 따라 다를 수 있습니다.",faqList:[
  {icon:"❓",title:"법무사 수수료란?",body:"등기 대행 시 법무사에게 지불하는 보수입니다."},
  {icon:"💡",title:"절감 팁",body:"• 대한법무사협회 보수표 기준이나 법무사별 차이 있음\n• 견적 비교 권장"},
  {icon:"📅",title:"업무 시점",body:"• 잔금 시 등기 대행 계약 · 잔금일로부터 60일 이내 등기 접수"},
  {icon:"⚠️",title:"주의사항",body:"• 기본보수 외 부가세(10%), 서류작성비, 교통비 등 추가\n• 상속·증여는 약 30% 가산, 근저당설정은 약 50% 수준"}
]},
...
yearend:{q:"연말정산이란?",a:"매년 1~2월 직장인이 전년도 소득과 공제 내역을 정산하여 세금을 돌려받거나 추가 납부하는 절차입니다. 신용카드·의료비·교육비·연금저축·보험료·기부금 등의 공제를 빠짐없이 챙기면 환급액을 극대화할 수 있습니다. 연봉 5천만원 기준 보통 30~100만원 환급이 가능합니다.",
  ...
  {icon:"❓",title:"연말정산이란?",body:"근로소득자의 1년간 세금을 재계산하여 과납 시 환급, 부족 시 추가 납부하는 절차입니다."},
  {icon:"💡",title:"절세 팁",body:"• 총급여 25% 초과분부터 카드공제 → 25%까지는 신용카드, 초과분은 체크카드·현금영수증 사용\n• 연금저축 600만 + IRP 합산 900만 세액공제 꼭 활용\n• 월세 세액공제 (7천만 이하, 최대 17%)는 확정일자 없어도 가능\n• 안경·콘택트렌즈 구입비도 의료비 공제 대상\n• 교복 구입비 (중·고생) 50만원 한도 교육비 공제"},
  {icon:"📅",title:"신고 기한",body:"• 1월 15일경: 간소화서비스 오픈\n• 1월~2월: 회사에 공제 증빙 제출\n• 2월 급여에서 환급 또는 추가 징수\n• 누락 시 5월 종소세 기간에 경정청구 가능 (5년 이내)"},
  {icon:"⚠️",title:"주의사항",body:"• 맞벌이 부부는 소득 높은 쪽에 공제 몰아주기가 유리 (의료비 제외)\n• 부양가족 중복 공제 불가\n• 월세공제와 주택자금공제 중복 불가"}
]},
netsalary:{q:"실수령액 계산법은?",a:"연봉에서 4대보험료(국민연금 4.75%, 건강보험 3.595%, 장기요양 12.95%, 고용보험 0.9%)와 소득세·지방소득세를 공제한 금액입니다.",faqList:[
  {icon:"❓",title:"연봉에서 빠지는 돈은?",body:"4대보험 + 소득세 + 지방소득세를 공제한 금액이 실수령액입니다."},
  {icon:"💡",title:"절세 팁",body:"• 비과세 식대 월 20만원, 자가운전보조금 월 20만원, 자녀보육수당 월 20만원 등 활용\n• 비과세 항목은 4대보험·소득세 기준에서 제외되어 실수령액이 증가"},
  {icon:"📅",title:"정산 주기",body:"• 매월 급여 지급 시 원천징수\n• 연말정산으로 소득세 정산"},
  {icon:"⚠️",title:"주의사항",body:"• 2026년 4대보험 요율 인상 (국민연금 9.5%, 건강보험 7.19%)"}
]},
inctax:{q:"종합소득세란?",a:"개인이 1년간 얻은 모든 소득(근로·사업·이자·배당·연금·기타)을 합산하여 과세하는 국세입니다. 매년 5월 1일~31일에 전년도 소득을 확정신고합니다. 근로소득만 있으면 연말정산으로 대체되며, 사업소득·프리랜서 소득이 있으면 종합소득세 신고가 필수입니다. 세율은 6~45% 8단계 누진구조이며, 각종 공제를 활용하면 세부담을 줄일 수 있습니다.",
  ...
  {icon:"❓",title:"종합소득세란?",body:"근로·사업·이자·배당·연금·기타소득을 합산하여 과세하는 국세입니다."},
  {icon:"💡",title:"절세 팁",body:"• 사업자: 간편장부 대상자도 복식장부 기장 시 20% 세액공제\n• 노란우산공제: 연 최대 500만원 소득공제\n• 연금저축+IRP 합산 900만원 세액공제 활용\n• 기부금 공제 (법정15%, 종교10%)"},
  {icon:"📅",title:"신고 기한 및 방법",body:"• 매년 5월 1일~31일 (성실신고확인 대상은 6월 30일)\n• 신고: 홈택스 → 종합소득세 신고\n• 중간예납: 11월 (직전년도 세액의 1/2)"},
  {icon:"⚠️",title:"주의사항",body:"• 금융소득 2,000만원 초과 시 종합과세\n• 주택임대소득 2,000만원 이하도 분리과세 또는 종합과세 선택\n• 프리랜서 3.3% 원천징수 ≠ 최종 세액 (5월 정산 필수)"}
]},
pension:{q:"국민연금 수령 조건은?",a:"최소 10년(120개월) 이상 납입해야 수령 자격이 됩니다. 정상 수령 나이는 65세이며, 60세부터 조기수령(연 6% 감액)하거나 70세까지 연기수령(연 7.2% 가산)할 수 있습니다. 2025년 기준 소득대체율은 40%이며, 기준소득월액 상한은 637만원입니다.",
  ...
  {icon:"❓",title:"국민연금이란?",body:"가입기간과 평균소득에 따라 노후 수령액이 결정되는 공적연금입니다."},
  {icon:"💡",title:"수령액 늘리기 팁",body:"• 추납(추후납부): 미납기간 보험료를 나중에 납부하여 가입기간 늘리기 가능\n• 임의가입·임의계속가입 활용\n• 70세까지 연기연금 신청으로 최대 36% 가산\n• 기준소득 상한(637만)까지 납부"},
  {icon:"📅",title:"수급 개시",body:"• 출생연도별 62~65세 (1969년생 이후 65세)\n• 조기수급(5년 앞당김) 가능하나 연 6% 감액\n• 연기수급(최대 5년) 시 연 7.2% 가산"},
  {icon:"⚠️",title:"주의사항",body:"• 최소 10년(120개월) 이상 납입해야 수급 자격\n• 10년 미만이면 일시금 반환"}
]},
cartax:{q:"자동차세 계산법은?",a:"배기량(cc) 기준으로 과세됩니다. 비영업 승용차는 1,000cc 이하 cc당 80원, 1,600cc 이하 140원, 초과 200원입니다. 전기·수소차는 10만원 정액입니다. 차령 3년부터 매년 5%씩 최대 50%까지 할인됩니다. 6월·12월 연 2회 납부하며, 1월 연납 시 약 5% 추가 할인됩니다.",
  ...
  {icon:"❓",title:"자동차세란?",body:"배기량 기준으로 과세되는 지방세입니다."},
  {icon:"💡",title:"할인 팁",body:"• 1월 연납 시 약 4.6% 할인\n• 3년 이상 보유 시 매년 5%씩 최대 50% 할인\n• 전기·수소차는 10만원 정액"},
  {icon:"📅",title:"납부 기한",body:"• 6월(1기분), 12월(2기분) 납부\n• 1월·3월·6월·9월 연납 가능"},
  {icon:"⚠️",title:"주의사항",body:"• 6월 1일·12월 1일 기준 보유자에게 과세\n• 연도 중간 명의변경 시 일할 계산"}
]},
insurance4:{q:"4대보험 요율은?",a:"2025년 기준 직장인 부담률은 국민연금 4.75%, 건강보험 3.595%, 장기요양 건보의 12.95%, 고용보험 0.9%입니다. 산재보험은 사업주 전액 부담입니다. 국민연금 기준소득월액 상한은 637만원입니다.",
  ...
  {icon:"❓",title:"4대보험이란?",body:"2026년 4대보험 요율이 인상됐습니다. 국민연금 9%→9.5%, 건강보험 7.09%→7.19%."},
  {icon:"💡",title:"절감 팁",body:"• 비과세 급여(식대 등) 제외 후 보수월액 기준 산정\n• 비과세 항목 활용으로 보험료 기준 낮추기"},
  {icon:"📅",title:"납부 주기",body:"• 매월 급여에서 원천공제\n• 7월에 국민연금 상하한 변경"},
  {icon:"⚠️",title:"주의사항",body:"• 산재보험은 사업주 전액 부담\n• 국민연금 기준소득월액 상하한은 매년 7월 1일 변경"}
]},
...
retire:{q:"퇴직금 계산법?",a:"1년 이상 근무 시 퇴직 전 3개월 평균임금×30일×근속일수/365로 계산됩니다.",faqList:[
  {icon:"❓",title:"퇴직금이란?",body:"1년 이상 근무 시 퇴직 전 3개월 평균임금×30일×근속일수/365로 계산됩니다."},
  {icon:"💡",title:"절세 팁",body:"• 퇴직연금(DC/DB) 가입 시 세액공제 혜택\n• IRP 이체 시 퇴직소득세 30% 감면\n• 연분연승법으로 낮은 세율 적용"},
  {icon:"📅",title:"지급 기한",body:"• 퇴직일로부터 14일 이내 지급 의무"},
  {icon:"⚠️",title:"주의사항",body:"• 1년 미만 근무자는 지급 의무 없음\n• 상여금·성과급 포함 여부에 따라 평균임금 달라짐"}
]},
unemploy:{q:"실업급여란?",a:"비자발적 퇴직 시 평균임금의 60% (상한 66,000원/일)를 지급받는 제도입니다.",faqList:[
  {icon:"❓",title:"실업급여란?",body:"비자발적 퇴직 시 평균임금의 60% (상한 66,000원/일)를 지급받는 제도입니다."},
  {icon:"💡",title:"수급 팁",body:"• 자발적 퇴직도 정당한 사유 있으면 수급 가능 (임금체불, 직장 내 괴롭힘 등)\n• 이직확인서 발급 지연 시 고용센터에 직권조사 요청"},
  {icon:"📅",title:"신청 기한 및 방법",body:"• 퇴직 후 지체 없이 고용센터 방문→구직등록→수급자격 신청\n• 퇴직 후 1년 이내 신청해야 함\n• 매 1~4주마다 실업인정일에 출석/온라인 신고"},
  {icon:"⚠️",title:"주의사항",body:"• 고용보험 180일 이상 가입 필요\n• 수급 기간: 연령·가입기간별 120~270일\n• 상한 66,000원/일, 하한 최저임금 80%"}
]},
};
...
function RP({title,total,sub,items,isExample=false,deadline,deadlineLink,deadlineLinkLabel,alertMsg,alertType="info",consultFunnel}){
  ...
  <div style={{background:"linear-gradient(180deg,#0747A6 0%,#0052CC 100%)",borderRadius:20,padding:"28px 24px",color:"#fff",position:isMo?"relative":"sticky",top:isMo?0:80,alignSelf:"start",boxShadow:"0 8px 28px rgba(7,71,166,.22)",width:"100%",minWidth:isMo?"auto":320,boxSizing:"border-box"}}>
    ...
    <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:6,marginTop:8}}>
      {[
        {fn:()=>window.dispatchEvent(new CustomEvent('lc-ai-explain',{detail:{title,total,items,sub}})),icon:"🤖",l:"AI 해설"},
        {fn:()=>window.dispatchEvent(new CustomEvent('lc-brand-pdf',{detail:{title,total,items,sub}})),icon:"📄",l:"중개사 PDF"},
        {fn:()=>window.dispatchEvent(new CustomEvent('lc-consult',{detail:{title,total}})),icon:"👨‍💼",l:"전문가 상담"}
      ].map((b,i)=>(
...
function CalcTrans({isMo=false,onNav=()=>{}}){
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"1fr 1fr",gap:isMo?16:32,alignItems:"start",minWidth:0}}><div>{!isMo&&<h3 style={{fontSize:18,fontWeight:700,color:P.tx,margin:"0 0 20px"}}>양도소득세 계산기</h3>}
...
function CalcCompre({isMo=false,onNav=()=>{}}){
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"1fr 1fr",gap:isMo?16:32,alignItems:"start",minWidth:0}}><div>{!isMo&&<h3 style={{fontSize:18,fontWeight:700,color:P.tx,margin:"0 0 20px"}}>종합부동산세 계산기</h3>}
...
function CalcRti({isMo=false,onNav=()=>{}}){
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"1fr 1fr",gap:isMo?16:32,alignItems:"start",minWidth:0}}><div>
    {!isMo&&<h3 style={{fontSize:18,fontWeight:700,color:P.tx,margin:"0 0 20px"}}>RTI 계산기</h3>}
...
function CalcSubscription({isMo=false,onNav=()=>{}}){
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"1fr 1fr",gap:isMo?16:32,alignItems:"start",minWidth:0}}><div>
    {!isMo&&<h3 style={{fontSize:18,fontWeight:700,color:P.tx,margin:"0 0 20px"}}>청약가점 계산기</h3>}
...
function CalcNetSale({isMo=false,onNav=()=>{}}){
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"1fr 1fr",gap:isMo?16:32,alignItems:"start",minWidth:0}}><div>
    {!isMo&&<h3 style={{fontSize:18,fontWeight:700,color:P.tx,margin:"0 0 20px"}}>매도 실수령액 계산기</h3>}
...
function CalcIncTax({isMo=false,onNav=()=>{}}){const[incType,sIT]=useState("salary");const[gross,sGross]=useState("");const[deductions,sDed]=useState("");const[bizType,sBT]=useState("simple");const[bizRate,sBR]=useState("60");
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"1fr 1fr",gap:isMo?16:32,alignItems:"start",minWidth:0}}><div>{!isMo&&<h3 style={{fontSize:18,fontWeight:700,color:P.tx,margin:"0 0 20px"}}>종합소득세</h3>}
...
function CalcYearEnd({isMo=false,onNav=()=>{}}){const[salary,sSal]=useState("");const[card,sCard]=useState("");const[medical,sMed]=useState("");const[edu,sEdu]=useState("");const[donate,sDon]=useState("");const[insurance,sIns]=useState("");const[pension,sPen]=useState("");const[monthlyRent,sMR]=useState("");
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"1fr 1fr",gap:isMo?16:32,alignItems:"start",minWidth:0}}><div>{!isMo&&<h3 style={{fontSize:18,fontWeight:700,color:P.tx,margin:"0 0 20px"}}>연말정산</h3>}
...
function CalcNetSalary({isMo=false,onNav=()=>{}}){const[salary,sSal]=useState("");const[family,sFamily]=useState("1");const[child,sChild]=useState("0");const[nonTax,sNT]=useState("20");
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"1fr 1fr",gap:isMo?16:32,alignItems:"start",minWidth:0}}><div>{!isMo&&<h3 style={{fontSize:18,fontWeight:700,color:P.tx,margin:"0 0 20px"}}>연봉 실수령액</h3>}
...
function CalcPension({isMo=false,onNav=()=>{}}){const[age,sAge]=useState("35");const[salary,sSal]=useState("350");const[paidYears,sPY]=useState("10");const[retireAge,sRA]=useState("65");
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"1fr 1fr",gap:isMo?16:32,alignItems:"start",minWidth:0}}><div>{!isMo&&<h3 style={{fontSize:18,fontWeight:700,color:P.tx,margin:"0 0 20px"}}>국민연금 예상수령액</h3>}
...
function CalcRetire({isMo=false,onNav=()=>{}}){const[monthly,sM]=useState("");const[years,sY]=useState("");const[months,sMo]=useState("0");
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"1fr 1fr",gap:isMo?16:32,alignItems:"start",minWidth:0}}><div>{!isMo&&<h3 style={{fontSize:18,fontWeight:700,color:P.tx,margin:"0 0 20px"}}>퇴직금 계산기</h3>}
...
function CalcUnemploy({isMo=false,onNav=()=>{}}){const[age,sAge]=useState("30");const[years,sY]=useState("3");const[daily,sD]=useState("");
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"1fr 1fr",gap:isMo?16:32,alignItems:"start",minWidth:0}}><div>{!isMo&&<h3 style={{fontSize:18,fontWeight:700,color:P.tx,margin:"0 0 20px"}}>실업급여 계산기</h3>}
...
function CalcCarTax({isMo=false,onNav=()=>{}}){const[carType,sCT]=useState("normal");const[cc,sCC]=useState("2000");const[year,sYear]=useState("0");const[isElec,sElec]=useState("no");
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"1fr 1fr",gap:isMo?16:32,alignItems:"start",minWidth:0}}><div>{!isMo&&<h3 style={{fontSize:18,fontWeight:700,color:P.tx,margin:"0 0 20px"}}>자동차세</h3>}
...
function CalcInsurance4({isMo=false,onNav=()=>{}}){const[type,sType]=useState("worker");const[salary,sSal]=useState("");const[bonus,sBonus]=useState("");
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"1fr 1fr",gap:isMo?16:32,alignItems:"start",minWidth:0}}><div>{!isMo&&<h3 style={{fontSize:18,fontWeight:700,color:P.tx,margin:"0 0 20px"}}>4대보험료</h3>}

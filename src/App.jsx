...
function CalcRti({isMo=false,onNav=()=>{}}){
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"1fr 1fr",gap:isMo?16:32,alignItems:"start",minWidth:0}}><div>
    ...
    <div style={{fontSize:13,color:"#374151",fontWeight:600,marginBottom:4,display:"flex",alignItems:"center",gap:6}}>건물 유형 <TipModal title="RTI (Rent To Interest)"><p>임대사업자 주택담보대출 심사 비율.</p><p><b>RTI = 연간 임대소득 / 연간 이자비용</b></p><ul style={{paddingLeft:20}}><li>주거용 (주택): 1.25배 이상</li><li>비주거용 (상가·오피스텔·공장): 1.5배 이상</li></ul><p>2018.3.26 여신심사 가이드라인 도입. 임대사업자 등록 대출 시 필수.</p></TipModal></div>
...
function CalcSubscription({isMo=false,onNav=()=>{}}){
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"1fr 1fr",gap:isMo?16:32,alignItems:"start",minWidth:0}}><div>
    ...
    <div style={{fontSize:13,color:"#374151",fontWeight:600,marginBottom:4,display:"flex",alignItems:"center",gap:6}}>무주택기간 <TipModal title="무주택기간 산정"><p>만 30세부터 기산. 기혼자는 혼인신고일이 빠르면 혼인신고일부터. 주택 처분 후 재취득 시 초기화.</p><p>최대 32점 (1년 미만 2점, 1~2년 4점, ..., 15년 이상 32점).</p></TipModal></div>
    <Sel label="" value={noHouseY} onChange={setNoHouseY} options={ySel}/>
    <div style={{fontSize:13,color:"#374151",fontWeight:600,marginBottom:4,display:"flex",alignItems:"center",gap:6}}>부양가족 수 <TipModal title="부양가족 수"><p>본인 제외, 배우자·직계존속·직계비속 중 세대를 같이하는 사람. 최대 35점 (0명 5점, 1명 10점, ..., 6명 이상 35점).</p></TipModal></div>
    ...
    <div style={{fontSize:13,color:"#374151",fontWeight:600,marginBottom:4,display:"flex",alignItems:"center",gap:6}}>청약통장 <TipModal title="청약통장 가입기간"><p>청약저축·청약예금·청약부금·주택청약종합저축. 최대 17점 (6개월 미만 1점, 6~12개월 2점, 1~2년 3점, 이후 매년 +1점).</p></TipModal></div>
...
function CalcNetSalary({isMo=false,onNav=()=>{}}){const[salary,sSal]=useState("");const[family,sFamily]=useState("1");const[child,sChild]=useState("0");const[nonTax,sNT]=useState("");
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"1fr 1fr",gap:isMo?16:32,alignItems:"start",minWidth:0}}><div>{!isMo&&<h3 style={{fontSize:isMo?16:18,fontWeight:700,color:P.tx,margin:"0 0 20px"}}>연봉 실수령액</h3>}
    ...
    <div style={{fontSize:13,color:"#374151",fontWeight:600,marginBottom:4,display:"flex",alignItems:"center",gap:6}}>비과세 <TipModal title="비과세 항목"><p>식대 월 20만원 등 비과세 항목. 비과세 금액은 세금 계산에서 제외됩니다.</p><p>근로계약서/급여명세서에서 확인하세요.</p></TipModal></div>

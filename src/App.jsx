...
netsalary:{q:"실수령액 계산법은?",a:"연봉에서 4대보험료(국민연금 4.75%, 건강보험 3.595%, 장기요양 12.95%, 고용보험 0.9%)와 소득세·지방소득세를 공제한 금액입니다. 비과세 항목(식대 월 20만원, 자가운전보조 월 20만원 등)은 과세 대상에서 제외됩니다."},
...
insurance4:{q:"4대보험 요율은?",a:"2025년 기준 직장인 부담률은 국민연금 4.75%, 건강보험 3.595%, 장기요양 건보의 12.95%, 고용보험 0.9%입니다. 산재보험은 사업주 전액 부담입니다. 국민연금 기준소득월액 상한은 637만원입니다.",
  rates:[["국민연금","4.75%","4.75%","9.5%"],["건강보험","3.595%","3.595%","7.19%"],["장기요양","건보×12.95%","건보×12.95%","건보×12.95%"],["고용보험","0.9%","0.9%","1.8%"],["산재보험","없음","업종별","업종별"]],rh:["구분","근로자","사업주","합계"]},
...
function Tip({text}){const[show,sS]=useState(false);const stop=e=>e.stopPropagation();return(<span className="tip-wrap" onClick={stop} onMouseDown={stop} onPointerDown={stop} style={{position:"relative",display:"inline-flex",alignItems:"center",verticalAlign:"middle",marginLeft:4,flexShrink:0}}><span onClick={e=>{e.stopPropagation();e.preventDefault();sS(!show)}} onMouseDown={stop} onPointerDown={stop} style={{cursor:"pointer",color:"#888",border:"1px solid #ccc",borderRadius:"50%",width:16,height:16,minWidth:16,minHeight:16,display:"inline-flex",alignItems:"center",justifyContent:"center",fontSize:10,fontWeight:700,lineHeight:1,boxSizing:"border-box",userSelect:"none",flexShrink:0}}>?</span>{show&&<div onClick={e=>{e.stopPropagation();sS(false)}} style={{position:"absolute",bottom:"calc(100% + 8px)",left:"50%",transform:"translateX(-50%)",background:"#333",color:"#fff",padding:"10px 14px",borderRadius:8,fontSize:12,lineHeight:1.6,width:260,zIndex:999,boxShadow:"0 4px 12px rgba(0,0,0,0.15)",whiteSpace:"normal",fontWeight:400,textAlign:"left"}}>{text}<div style={{position:"absolute",bottom:-6,left:"50%",transform:"translateX(-50%)",width:0,height:0,borderLeft:"6px solid transparent",borderRight:"6px solid transparent",borderTop:"6px solid #333"}}/></div>}</span>);}
function TipModal({title,children}){const[show,setShow]=useState(false);const stop=e=>e.stopPropagation();return(<><span onClick={e=>{e.stopPropagation();e.preventDefault();setShow(true)}} onMouseDown={stop} onPointerDown={stop} style={{cursor:"pointer",border:"1px solid #ccc",borderRadius:"50%",width:18,height:18,minWidth:18,minHeight:18,display:"inline-flex",alignItems:"center",justifyContent:"center",fontSize:11,color:"#888",marginLeft:4,verticalAlign:"middle",lineHeight:1,boxSizing:"border-box",userSelect:"none",flexShrink:0}}>?</span>{show&&<div onClick={()=>setShow(false)} style={{position:"fixed",top:0,left:0,right:0,bottom:0,background:"rgba(0,0,0,0.4)",zIndex:10000,display:"flex",alignItems:"center",justifyContent:"center",padding:20}}><div onClick={stop} onMouseDown={stop} onPointerDown={stop} style={{background:"#fff",borderRadius:12,padding:24,maxWidth:500,width:"100%",maxHeight:"80vh",overflowY:"auto",position:"relative",wordBreak:"keep-all"}}><button onClick={e=>{e.stopPropagation();setShow(false)}} style={{position:"absolute",top:12,right:16,background:"none",border:"none",fontSize:20,cursor:"pointer",color:"#666"}}>✕</button><h4 style={{fontWeight:700,marginBottom:16,fontSize:16,paddingRight:30}}>{title}</h4><div style={{fontSize:14,lineHeight:1.8,color:"#333"}}>{children}</div></div></div>}</>);}

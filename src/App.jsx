...
import CalcInvestTiming from './calcs/CalcInvestTiming';
...
const CALC_SUBTITLE={
  ...
  investTiming:"코스톨라니 달걀 모델 · 금리 사이클 기반 자산 배분 가이드 (교육자료)"
};
...
investTiming:{title:"투자타이밍계산기 - 코스톨라니 달걀 모델 | 생활계산기",desc:"금리 사이클로 보는 자산 투자 적기. 주식·부동산·채권·예금 4가지 자산 배분 가이드 + 부동산 진입 적합도 점수. 교육자료, 투자권유 아님."}
};

const CALC_KEYWORDS={
acquisition:"취득세,취득세계산기,취득세계산,부동산취득세,아파트취득세,주택취득세,취득세율,취득세납부,취득세감면,생애최초취득세,다주택취득세,법인취득세,증여취득세,상속취득세,오피스텔취득세,취득세자동계산,2026취득세",
transfer:"양도소득세,양도세,양도세계산기,양도소득세계산,부동산양도세,아파트양도세,주택양도세,양도세율,장기보유특별공제,장특공제,1세대1주택비과세,다주택양도세,양도세중과,양도세절세,양도세신고,단기양도세,2026양도세",
compre:"종합부동산세,종부세,종부세계산기,종부세계산,1주택종부세,다주택종부세,종부세납부,종부세기준,공시가격종부세,종부세공제,종부세율,종부세절세,보유세계산기,부동산보유세,2026종부세",
property:"재산세,재산세계산기,재산세계산,주택재산세,토지재산세,건물재산세,재산세납부,재산세율,공시가격재산세,세부담상한,도시지역분,지방교육세,2026재산세",
gift:"증여세,증여세계산기,증여세계산,부동산증여세,아파트증여세,현금증여세,자녀증여세,배우자증여세,증여세율,증여공제,10년합산증여,혼인출산공제,증여세신고,2026증여세",
inherit:"상속세,상속세계산기,상속세계산,부동산상속세,상속세율,상속공제,배우자상속공제,일괄공제,상속세신고,피상속인,상속포기,사전증여합산,2026상속세",
rental:"임대소득세,임대소득세계산기,주택임대소득,임대소득과세,분리과세,종합과세,임대수입,월세세금,임대사업자세금,간주임대료,2026임대소득세",
inctax:"종합소득세,종합소득세계산기,소득세계산,프리랜서세금,사업소득세,근로소득세,3.3%환급,원천징수환급,5월종합소득세,단순경비율,2026종합소득세",
yearend:"연말정산,연말정산계산기,연말정산환급,13월의월급,신용카드공제,의료비공제,교육비공제,연금저축공제,월세공제,연말정산미리보기,2026연말정산",
holdtax:"보유세,보유세계산기,재산세종부세,부동산보유세,연간보유세,보유세통합계산,2026보유세",
mortgage:"대출이자,대출이자계산기,대출상환계산기,원리금균등,원금균등,만기일시,주택담보대출이자,대출월상환액,상환스케줄,중도상환수수료,2026대출이자",
dsr:"DSR,DSR계산기,DSR계산,총부채원리금상환비율,스트레스DSR,대출한도계산,대출가능금액,주택담보대출한도,DSR40%,대출규제,은행대출한도,연봉대출한도,2026DSR",
dti:"DTI,DTI계산기,DTI계산,총부채상환비율,투기과열DTI,조정대상DTI,DTI40%,DTI50%,DTI한도,대출심사,2026DTI",
ltv:"LTV,LTV계산기,LTV계산,담보인정비율,주택담보대출한도,생애최초LTV,투기과열LTV,15억초과대출,수도권주담대한도,2026LTV",
loanmax:"대출가능액,대출가능액계산기,최대대출금액,소득기준대출,DSR역산,대출한도역산,연봉별대출한도,2026대출가능액",
rti:"RTI,RTI계산기,임대업이자상환비율,임대사업자대출,주거용RTI,비주거용RTI,임대수입대비이자,2026RTI",
commission:"중개보수,중개수수료,복비,복비계산기,부동산수수료,공인중개사수수료,매매수수료,전세수수료,월세수수료,중개보수계산기,아파트복비,오피스텔복비,2026중개보수",
registration:"등기비용,등기비용계산기,소유권이전등기,등록면허세,등기수수료,부동산등기비용,셀프등기,2026등기비용",
netsalary:"연봉실수령액,연봉계산기,실수령액계산기,세후연봉,월급계산기,월급실수령액,연봉세금,4대보험공제,연봉3000실수령액,연봉4000실수령액,연봉5000실수령액,세후월급,2026연봉실수령액",
insurance4:"4대보험,4대보험료계산기,국민연금요율,건강보험요율,고용보험요율,장기요양보험,사업주부담,직장인4대보험,2026년4대보험",
pension:"국민연금,국민연금수령액,국민연금계산기,예상연금수령액,국민연금조기수령,국민연금연기수령,노령연금,2026국민연금",
cartax:"자동차세,자동차세계산기,자동차세연납,배기량세금,전기차자동차세,차령할인,자동차세납부,2026자동차세",
retire:"퇴직금,퇴직금계산기,퇴직금계산,퇴직소득세,근속연수퇴직금,평균임금퇴직금,퇴직금정산,2026퇴직금",
unemploy:"실업급여,실업급여계산기,실업급여수급액,구직급여,실업급여기간,실업급여조건,고용보험실업급여,2026실업급여",
minwage:"최저임금,최저임금계산기,2026최저임금,시급계산,월급계산,주휴수당,최저시급,10030원",
deposit:"예적금이자,예금이자계산기,적금이자계산기,세후이자,이자소득세,복리계산,단리계산,예금금리비교",
convert:"전월세전환,전월세전환계산기,전세월세전환,전환율계산,법정전환율,보증금월세전환",
yield:"임대수익률,임대수익률계산기,부동산수익률,월세수익률,전세수익률,투자수익률,순수익률,총수익률",
joint:"공동명의,공동명의계산기,부부공동명의,종부세절세,공동명의종부세,지분비율,단독명의비교",
area:"평수변환,평수계산기,평방미터,제곱미터,평수환산,전용면적,공급면적,1평3.3제곱미터",
auction:"경매비용,경매비용계산기,경매취득세,경매등기비용,낙찰가비용,경매부동산",
auction2:"경매입찰가,경매적정입찰가,경매낙찰률,감정가대비,경매시세",
refinance:"대환대출,대환대출계산기,갈아타기대출,대출비교,중도상환수수료,손익분기점",
subscription:"청약가점,청약가점계산기,청약점수,무주택기간,부양가족,청약통장,아파트청약,2026청약",
netsale:"매도실수령액,매도실수령액계산기,부동산매도수익,매도비용,양도세차감,중개수수료차감",
far:"용적률,건폐율,용적률계산기,건폐율계산기,대지면적,건축면적,연면적",
remodel:"리모델링수익,리모델링계산기,리모델링분담금,시세상승,리모델링투자",
bldvalue:"건물잔존가치,감가상각,내용연수,건물가치,잔존가액,경과연수",
investTiming:"투자타이밍,투자타이밍계산기,코스톨라니달걀,금리사이클,자산배분,부동산진입시점,분양타이밍,주식부동산채권예금,경기사이클,투자교육",
};
...
investTiming:[{id:"acquisition",label:"취득세 계산하기"},{id:"mortgage",label:"대출이자 계산하기"},{id:"yield",label:"임대수익률 분석"},{id:"totalcost",label:"부동산 총비용 시뮬레이터"}],
...
insurance4:`<h2>4대보험 완벽 가이드</h2><h3>2026년 직장가입자 요율</h3><p>국민연금 4.75%(상한 월 637만원), 건강보험 3.595%, 장기요양 건보료의 13.14%, 고용보험 0.9%. 사업주 부담분 별도.</p><h3>산재보험</h3><p>사업주 전액 부담(업종별 0.6~18.6%), 근로자 부담 없음.</p><h3>비과세 활용</h3><p>식대·자가운전보조금(각 월 20만원) 비과세로 처리하면 보험료 기준이 낮아져 실수령액 증가.</p>`,
...
netsalary:{q:"실수령액 계산법은?",a:"연봉에서 4대보험료(국민연금 4.75%, 건강보험 3.595%, 장기요양 13.14%, 고용보험 0.9%)와 소득세·지방소득세를 공제한 금액입니다.",faqList:[
...
insurance4:{q:"4대보험 요율은?",a:"2025년 기준 직장인 부담률은 국민연금 4.75%, 건강보험 3.595%, 장기요양 건보의 13.14%, 고용보험 0.9%입니다. 산재보험은 사업주 전액 부담입니다. 국민연금 기준소득월액 상한은 637만원입니다.",
  rates:[["국민연금","4.75%","4.75%","9.5%"],["건강보험","3.595%","3.595%","7.19%"],["장기요양","건보×13.14%","건보×13.14%","건보×13.14%"],["고용보험","0.9%","0.9%","1.8%"],["산재보험","없음","업종별","업종별"]],rh:["구분","근로자","사업주","합계"],faqList:[
...
investTiming:{q:"지금 부동산 사도 되나요?",a:"코스톨라니 달걀에서 D(채권 하락기) 또는 B 초입(금리 상승 초기 + 부동산 냉각)이 부동산 진입 적합 구간으로 분류됩니다. C(금리 정점)는 회피. 본 진단은 교육 자료이며 투자권유가 아닙니다.",rates:[["A 주식","저점","우량주","낮음 (이미 회복)"],["B 부동산","상승","실물·부동산","중간 (정점 임박)"],["C 예금","정점","예금·파킹","매우 낮음"],["D 채권","하락","장기채권","높음 (진입 적기)"]],rh:["국면","금리 상태","추천 자산","부동산 진입 적합도"],faqList:[
  {icon:<IconQ/>,title:"코스톨라니 달걀이란?",body:"헝가리 출신 투자자 앙드레 코스톨라니가 제시한 금리 사이클별 자산 순환 모델입니다. 금리 정점→하락→저점→상승의 순환에 따라 예금·채권·주식·부동산이 차례로 유리해진다는 가설을 시각화한 것입니다."},
  {icon:<IconBulb/>,title:"한국 부동산에도 그대로 적용되나요?",body:"기본 사이클의 참고 모델로 활용할 수 있습니다. 다만 한국은 분양가상한제·DSR·LTV·미분양·인허가 물량·전세제도 등 추가 변수가 많아 단일 지표만으로 결정하기에는 정보가 부족합니다."},
  {icon:<IconWarn/>,title:"이 진단으로 매매 결정해도 되나요?",body:"본 도구는 교육 목적의 정보 제공이며 투자권유가 아닙니다. 실제 매매·매수 결정은 본인 판단과 책임으로 하시기 바랍니다. 자본시장법 제9조 투자자문업/투자일임업에 해당하지 않습니다."},
  {icon:<IconCal/>,title:"기준금리는 어디서 확인하나요?",body:"한국은행 홈페이지(bok.or.kr) 통화정책방향 또는 ECOS 통계 시스템에서 확인합니다. 금융통화위원회 결정문이 공식 출처입니다."},
  {icon:<IconBank/>,title:"분양 진입 시점은 어떻게 정하나요?",body:"기준금리 사이클 외에 분양가·입지·도시기본계획·DSR/LTV 한도·미분양 추이를 종합 검토해야 합니다. 단일 지표 의존은 위험합니다."}
]},
};
...
const CALC_ICONS={
  ...
  investTiming:IC(<><ellipse cx="12" cy="12" rx="7" ry="9"/><line x1="5" y1="12" x2="19" y2="12"/><line x1="12" y1="3" x2="12" y2="21"/></>),
...
const CL=[
  ...
  {id:"investTiming",l:"투자 타이밍",c:"realestate"},
];
    ...
    <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:8,gap:8,flexWrap:"wrap"}}>
      ...
      <div style={{display:"flex",alignItems:"center",gap:6}}>
        <input type="text" value={displayVal} onChange={handleText} placeholder="직접 입력"
          style={{width:isMo?"100%":240,maxWidth:"100%",textAlign:"right",padding:isMo?"12px 14px":"10px 14px",border:`1.5px solid ${P.bd}`,borderRadius:10,fontSize:isMo?16:15,fontWeight:700,color:P.tx,background:P.lt,outline:"none",fontFamily:"inherit",boxSizing:"border-box",height:isMo?48:44}}
...
function AcqGuide({isMo}){
  ...
  return(
    <div style={{width:"100%",marginTop:32,marginBottom:64,background:"#fff",border:"1px solid #e5e7eb",borderRadius:16,overflow:"hidden",padding:isMo?16:24,display:"flex",flexDirection:"column",gap:16}}>
...
function RPFull({title,total,sub,items,isExample=false,deadline,deadlineLink,deadlineLinkLabel,alertMsg,alertType="info",miss,itemFilter,onAdjustPrice,nextStep}){
  const hasMiss=Array.isArray(miss)&&miss.length>0;
  if(isExample||hasMiss){total=total||0;if(hasMiss){items=[];sub="필수 항목을 입력해주세요";}else{items=[];sub="입력값을 입력하면 결과가 표시됩니다";}}
...
function CalcAcq({isMo=false,onNav=()=>{}}){
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"3fr 2fr",gap:isMo?12:28,alignItems:"start",minWidth:0,width:"100%",maxWidth:"100%"}}><div style={{minWidth:0,width:"100%",maxWidth:"100%"}}>
      ...
      <div style={{marginBottom:isMo?8:12}}>
        <div style={isMo?{display:"flex",alignItems:"stretch",flexDirection:"column",gap:6,marginBottom:4}:{display:"flex",flexDirection:"column",gap:4,marginBottom:4}}>
          ...
          <div style={{display:"flex",alignItems:"center",gap:6,width:"100%"}}>
            <input type="text" value={price?Number(String(price).replace(/,/g,"")).toLocaleString("ko-KR"):""} onChange={e=>{const raw=e.target.value.replace(/,/g,"");if(raw===""||/^\d+$/.test(raw)){sP(raw);setAutoPriceFlag(false);}}} placeholder="예: 12500" style={{flex:1,minWidth:0,width:"100%",maxWidth:"100%",textAlign:"right",padding:isMo?"12px 44px 12px 14px":"10px 44px 10px 14px",border:_hasErrors?"1.5px solid #3b82f6":"1.5px solid #dfe1e6",borderRadius:10,fontSize:isMo?16:15,fontWeight:700,color:P.tx,background:P.lt,outline:"none",fontFamily:"inherit",boxSizing:"border-box",height:isMo?48:44,boxShadow:_hasErrors?"0 0 0 3px rgba(59,130,246,0.1)":"none"}}/>
            <span style={{fontSize:13,color:P.mt,fontWeight:500,flexShrink:0,whiteSpace:"nowrap"}}>만원</span>
          </div>{price&&toKoreanUnit(price)&&<div style={{fontSize:11,color:"#0141f9",marginTop:3,fontWeight:500}}>= {toKoreanUnit(price)}</div>}
        </div>
      ...
      <div style={{marginBottom:isMo?8:12}}>
        <div style={isMo?{display:"flex",alignItems:"stretch",flexDirection:"column",gap:6,marginBottom:4}:{display:"flex",flexDirection:"column",gap:4,marginBottom:4}}>
          ...
          <div style={{display:"flex",alignItems:"center",gap:6,width:"100%"}}>
            <input type="text" value={stdPrice?Number(String(stdPrice).replace(/,/g,"")).toLocaleString("ko-KR"):""} onChange={e=>{const raw=e.target.value.replace(/,/g,"");if(raw===""||/^\d+$/.test(raw)){setStdPrice(raw);setAutoStdFlag(false);}}} placeholder="미입력 시 취득가 사용" style={{flex:1,minWidth:0,width:"100%",maxWidth:"100%",textAlign:"right",padding:isMo?"12px 44px 12px 14px":"10px 44px 10px 14px",border:"1.5px solid #dfe1e6",borderRadius:10,fontSize:isMo?16:15,fontWeight:700,color:P.tx,background:P.lt,outline:"none",fontFamily:"inherit",boxSizing:"border-box",height:isMo?48:44}}/>
            <span style={{fontSize:13,color:P.mt,fontWeight:500,flexShrink:0,whiteSpace:"nowrap"}}>만원</span>
          </div>{stdPrice&&toKoreanUnit(stdPrice)&&<div style={{fontSize:11,color:"#0141f9",marginTop:3,fontWeight:500}}>= {toKoreanUnit(stdPrice)}</div>}
        </div>
...
function CalcTrans({isMo=false,onNav=()=>{}}){
  ...
  function calculate(){
    ...
    if(ltcRate>0)items.push({l:"(-) 장기보유특별공제",v:fW(ltcAmount),note:(ltcRate*100).toFixed(0)+"% (소득세법 §95)"});
    items.push({l:"= 양도소득금액",v:fW(incomeAmount)});
    if(basicDed>0)items.push({l:"(-) 기본공제",v:fW(basicDed)});
    items.push({l:"= 과세표준",v:fW(taxBase)});
    items.push({l:"세율",v:appliedRate,note:"소득세법 §104"});
    if(surcharge>0)items.push({l:"중과/추가과세",v:fW(surcharge),note:surchargeNote});
    items.push({l:"양도소득세",v:fW(tax),note:"소득세법 §104"});
    items.push({l:"지방소득세 (10%)",v:fW(localTax),note:"양도세×10% (지방세법 §103)"});
  ...
  const moratoriumEnd=new Date('2026-05-09');const daysLeft=Math.ceil((moratoriumEnd-new Date())/(86400000));const showMoratoriumBanner=daysLeft>0;
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"3fr 2fr",gap:isMo?16:28,alignItems:"start",minWidth:0}}><div>
      {showMoratoriumBanner&&<div style={{padding:"10px 14px",background:daysLeft<=7?"#FEE2E2":"#FEF3C7",border:"1px solid "+(daysLeft<=7?"#FCA5A5":"#FCD34D"),borderRadius:8,marginBottom:12,display:"flex",alignItems:isMo?"flex-start":"center",gap:8,flexWrap:isMo?"wrap":"nowrap"}}><span style={{fontSize:13,fontWeight:600,color:daysLeft<=7?"#991B1B":"#92400E",whiteSpace:"nowrap"}}>⚠️ 다주택 중과 유예 종료 D-{daysLeft}</span><span style={{fontSize:12,color:daysLeft<=7?"#B91C1C":"#78350F",lineHeight:1.5}}>2026.05.09까지 양도 시 중과 미적용 → 05.10부터 조정 2주택 +20%p, 3주택+ +30%p 중과 부활</span></div>}
      <div style={{marginBottom:16}}>
    ...
    <div>
      ...
      </div>:<div><RPFull miss={MI.transfer} title="양도소득세" total={0} isExample={true} items={[]} nextStep={<NextStep calcId="transfer" onNav={onNav} isMo={isMo}/>}/></div>}
...
function CalcCompre({isMo=false,onNav=()=>{}}){
  ...
  const rpItems=[{l:"공시가격 합계",v:fW(pp),note:"물건 "+nRaw+"건"},{l:"공제금액",v:d>0?fW(d):"없음"},{l:"과세표준 (공정가액 60%)",v:fW(tb),note:"종부세법 시행령"},{l:"종부세 산출세액",v:fW(ct),note:"종부세법 §9"}];
  if(combinedCredit>0){
  ...
  rpItems.push({l:"농어촌특별세 (20%)",v:fW(fm),note:"종부세×20% (농특세법 §5)"});
  const _tips = [];
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"3fr 2fr",gap:isMo?16:28,alignItems:"start",minWidth:0}}><div>
    ...
    <hr style={{border:"none",borderTop:"1px solid #E5E7EB",margin:"16px 0"}}/>
  ...
  </div><div><RPFull miss={isDefault?MI.compre:null} isExample={isDefault} title="종합부동산세"
      ...
      total={total} sub={rateLabel+" ("+calcYear+"년 기준)"} items={rpItems} nextStep={<NextStep calcId="compre" onNav={onNav} isMo={isMo}/>}/></div></div>);}
...
function CalcProp({isMo=false,onNav=()=>{}}){
  ...
  const rpItems=[{l:"공시가격",v:fW(pp)},{l:"과세표준",v:fW(tb),note:"공정시장가액비율 "+(fr*100).toFixed(0)+"% (지방세법 시행령 §109)"},{l:"재산세 본세",v:fW(tx),note:"지방세법 §111"}];
  ...
  if(capApplied)rpItems.push({l:"세부담 상한 적용",v:fW(total),note:"전년 대비 "+(capRate*100-100).toFixed(0)+"%↑ 한도 (지방세법 §122)"});
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"3fr 2fr",gap:isMo?16:28,alignItems:"start",minWidth:0}}><div><Tog label="부동산 유형" value={pt} onChange={sPt} options={[{value:"house",label:"주택"},{value:"land",label:"토지"},{value:"com",label:"건축물"}]}/><div style={{fontSize:13,color:"#374151",fontWeight:600,marginBottom:4,display:"flex",alignItems:"center",gap:6}}>공시가격 <TipModal title=""><p>매년 1월 1일 기준 공시가격. realtyprice.kr에서 확인. 공정시장가액비율(60%)을 곱한 금액이 과세표준.</p></TipModal></div>{!isMo&&<div style={{marginBottom:10}}><button type="button" onClick={()=>setShowPropLookup(true)} style={{width:"100%",padding:"12px 16px",background:"linear-gradient(135deg,#eff6ff,#dbeafe)",border:"1.5px solid #bfdbfe",borderRadius:10,fontSize:13,fontWeight:700,color:"#1e40af",cursor:"pointer",fontFamily:"inherit",display:"flex",alignItems:"center",justifyContent:"center",gap:8}}>📍 주소로 공시가격 자동조회</button></div>}{showPropLookup&&<AddressModal calcType="holding" onClose={()=>setShowPropLookup(false)} onApplyStd={v=>{sP(String(Math.round(v/10000)));markModified();setAutoPropFill(true);}} onApplyInfo={info=>setSelectedPropInfo(info)}/>}{selectedPropInfo&&!isMo&&<div style={{background:"#eff6ff",border:"1px solid #bfdbfe",borderRadius:10,padding:"10px 14px",marginBottom:8,display:"flex",alignItems:"center",justifyContent:"space-between",gap:8}}>
      ...
      total={total} sub={"공정시장가액비율 "+(fr*100).toFixed(0)+"% 적용"} items={rpItems} nextStep={<NextStep calcId="property" onNav={onNav} isMo={isMo}/>}/></div></div>);}
...
return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"3fr 2fr",gap:isMo?16:28,alignItems:"start",minWidth:0}}><div>
    ...
    <div>{g<=0&&<StepsGuide steps={[{label:"증여 재산가액 입력",filled:g>0},{label:"수증자 관계 선택",filled:true}]}/>}<RPFull miss={g>0?null:MI.gift} title="증여세"
      ...
      total={finalTax} sub={"공제 "+fW(d)+" 적용"} items={[{l:"증여재산가액",v:fW(g)}].concat(burden==="yes"&&debtW>0?[{l:"채무 인수분 (양도세 대상)",v:"-"+fW(debtW)},{l:"증여세 과세 증여액",v:fW(giftPortion)}]:[]).concat(priorW>0?[{l:"10년 내 기증여 합산",v:fW(priorW)}]:[]).concat([{l:"증여재산 공제",v:"-"+fW(d),note:"상증세법 §53"},{l:"합산 과세표준",v:fW(tb)},{l:"합산 산출세액",v:fW(fullTax),note:"상증세법 §56"}]).concat(skipRate>0?[{l:"세대생략 할증 ("+(skipRate*100)+"%)",v:"+"+fW(surcharge)}]:[]).concat(priorW>0&&priorTax>0?[{l:"기납부 증여세 차감",v:"-"+fW(priorTax)}]:[]).concat([{l:"신고세액공제 (3%)",v:"-"+fW(Math.round(thisTax*0.03)),note:"상증세법 §69"},{l:"이번 납부 증여세",v:fW(finalTax)}]).concat(burden==="yes"&&debtW>0?[{l:"채무인수분 추정 양도세",v:"약 "+fW(Math.round(debtW*0.22)),note:"참고용·실제는 세무사 확인"}]:[])} nextStep={<NextStep calcId="gift" onNav={onNav} isMo={isMo}/>}/><div style={{marginTop:12,padding:"14px 16px",background:"#FFF8E1",border:"1px solid #FFE082",borderRadius:10,fontSize:13,color:"#92400E",lineHeight:1.6}}>※ 증여 시 취득세가 별도 부과됩니다. (일반 3.5%, 조정대상지역 다주택자 12%)<div style={{marginTop:8}}><button onClick={()=>onNav("tax","acquisition")} style={{padding:"8px 16px",background:"#fff",border:"1px solid #dfe1e6",borderRadius:8,fontSize:12,fontWeight:700,color:"#0747A6",cursor:"pointer",fontFamily:"inherit"}}>취득세 계산하기 →</button></div></div></div></div>);}
...
function CalcInherit({isMo=false,onNav=()=>{}}){const[ta,sTa]=useState("");const[finAsset,sFA]=useState("");const[db,sDb]=useState("");const[fn,sFn]=useState("");const[hasSpouse,sHS]=useState("yes");const[children,sCh]=useState("2");const[cohabit,sCohab]=useState("");const[farm,sFarm]=useState("");const[priorGift,sPG]=useState("");const[onTime,sOT]=useState("yes");const[showInheritLookup,setShowInheritLookup]=useState(false);const[autoInheritFill,setAutoInheritFill]=useState(false);const t=tW(ta),finW=tW(finAsset),d=tW(db),f=Math.min(tW(fn),15000000),priorW=tW(priorGift),cohabW=tW(cohabit),farmW=tW(farm);const gross=t+priorW;const netEstate=gross-d-f;const childN=parseInt(children)||0;const basicDed=2e8;const personalDed=childN*5e7;const basicPlusPersonal=basicDed+personalDed;const lumpSum=5e8;const mainDed=Math.max(basicPlusPersonal,lumpSum);let spouseDed=0;if(hasSpouse==="yes"){const spouseShare=netEstate>0?netEstate*1.5/(1.5+childN):0;spouseDed=Math.min(Math.max(spouseShare,5e8),30e8);}let financialDed=0;if(finW>0){if(finW<=2e7)financialDed=finW;else if(finW<=1e8)financialDed=2e7;else financialDed=Math.min(Math.round(finW*0.20),2e8);}const cohabDed=cohabW>0?Math.min(cohabW,6e8):0;const farmDed=farmW>0?Math.min(farmW,15e8):0;const totalDed=mainDed+spouseDed+financialDed+cohabDed+farmDed;const tb=Math.max(0,netEstate-totalDed);const tx=pTx(tb,GB);const rebate=onTime==="yes"?0.03:0;const finalTax=Math.round(tx*(1-rebate));return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"3fr 2fr",gap:isMo?16:28,alignItems:"start",minWidth:0}}><div>
    ...
    <div>{t<=0&&<StepsGuide steps={[{label:"총 상속재산가액 입력",filled:t>0},{label:"가족 구성 확인",filled:true}]}/>}<RPFull miss={t>0?null:MI.inherit} title="상속세"
      ...
      total={finalTax} sub={"상속공제 "+fW(totalDed)} items={[{l:"총 상속재산",v:fW(t)}].concat(priorW>0?[{l:"10년 내 사전증여",v:"+"+fW(priorW)}]:[]).concat([{l:"채무 차감",v:"-"+fW(d)},{l:"장례비 차감",v:"-"+fW(f)},{l:"과세가액",v:fW(netEstate)}]).concat(basicPlusPersonal>lumpSum?[{l:"기초공제 2억 + 인적공제",v:"-"+fW(basicPlusPersonal),note:"자녀"+childN+"명 × 5천만"}]:[{l:"일괄공제 (5억)",v:"-"+fW(lumpSum),note:"상증세법 §21"}]).concat(hasSpouse==="yes"?[{l:"배우자 법정상속분 ("+fP(1.5/(1.5+childN)*100)+")",v:fW(Math.round(netEstate*1.5/(1.5+childN)))},{l:"배우자 상속공제 (실제 적용)",v:"-"+fW(spouseDed),note:"5~30억 (상증세법 §19)"}]:[]).concat(financialDed>0?[{l:"금융재산 상속공제",v:"-"+fW(financialDed),note:finW<=2e7?"전액":finW<=1e8?"2천만 한도":"20% (최대 2억)"}]:[]).concat(cohabDed>0?[{l:"동거주택공제",v:"-"+fW(cohabDed)}]:[]).concat(farmDed>0?[{l:"영농상속공제",v:"-"+fW(farmDed)}]:[]).concat([{l:"공제 합계",v:"-"+fW(totalDed)},{l:"과세표준 (상속재산-공제)",v:fW(tb)},{l:"산출세액",v:fW(tx),note:"상증세법 §56"}]).concat(rebate>0?[{l:"신고세액공제 (3%)",v:"-"+fW(Math.round(tx*0.03)),note:"상증세법 §69"}]:[]).concat([{l:"납부 상속세",v:fW(finalTax)}]).concat(tx>2e7?[{l:"※ 연부연납 가능",v:"최대 5년 분납",note:"부동산 비중↑ 시 10년"}]:[])} nextStep={<NextStep calcId="inherit" onNav={onNav} isMo={isMo}/>}/></div></div>);}
...
function CalcDSR({isMo=false,onNav=()=>{}}){const[inc,sInc]=useState("");const[nl,sNl]=useState("");const[nr,sNr]=useState("");const[isDefault,setIsDefault]=useState(true);const markModified=()=>setIsDefault(false);const[ny,sNy]=useState("30");const[ep,sEp]=useState("");const[loanType,sLT]=useState("fixed");const[age,sAge]=useState("30");const ai=tW(inc),nlW=tW(nl),epW=tW(ep);const stressRate=loanType==="fixed"?0:loanType==="mixed"?0.0075:0.015;const adjRate=pN(nr)/100+stressRate;const nrV=adjRate/12;const ageVal=parseInt(age);let maxTerm=40;if(ageVal>=50)maxTerm=20;else if(ageVal>=40)maxTerm=30;else if(ageVal>=30)maxTerm=35;const adjYear=Math.min(parseInt(ny),maxTerm);const nn=adjYear*12;let nm=0;if(nlW>0&&nrV>0&&nn>0)nm=nlW*nrV*Math.pow(1+nrV,nn)/(Math.pow(1+nrV,nn)-1);const tot=nm*12+epW*12,dsr=ai>0?tot/ai*100:0;let st="양호",sc="#00875A";if(dsr>40){st="한도 초과";sc="#DE350B";}else if(dsr>30){st="주의";sc="#FF8B00";}
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"3fr 2fr",gap:isMo?16:28,alignItems:"start",minWidth:0}}><div><Inp label="연 소득" value={inc} onChange={sInc} suffix="만원" placeholder="예: 5000" error={!inc||inc==="0"}/><Inp label="신규 대출금액" value={nl} onChange={sNl} suffix="만원" placeholder="예: 30000" error={!nl||nl==="0"}/><Inp label="신규 대출 금리" value={nr} onChange={sNr} suffix="%" placeholder="예: 3.5" error={!nr||nr==="0"}/>{!isMo&&<BaseRateHint/>}<Tog label={<>대출 유형 <TipModal title="스트레스 DSR"><p>스트레스 DSR: 변동금리 +1.5%p, 혼합형 +0.75%p 가산금리 추가. 고정금리는 가산 없음.</p></TipModal></>} value={loanType} onChange={sLT} options={[{value:"fixed",label:"고정"},{value:"mixed",label:"혼합(+0.75p)"},{value:"variable",label:"변동(+1.5p)"}]}/><Sel label="대출 기간" value={ny} onChange={sNy} options={[5,10,15,20,25,30,35,40].map(y=>({value:String(y),label:y+"년"}))}/><Sel label="차주 연령대" value={age} onChange={sAge} options={[{value:"20",label:"20대"},{value:"30",label:"30대"},{value:"40",label:"40대"},{value:"50",label:"50대"},{value:"60",label:"60대"}]}/><Inp label="기존 대출 월 상환액 합계" value={ep} onChange={sEp} suffix="만원" placeholder="없으면 0"/></div><div>
    <RPFull miss={(ai>0&&nlW>0)?null:["연 소득을 입력해주세요","신규 대출금액을 입력해주세요","대출 금리를 입력해주세요"]}
      ...
      alertType={dsr>40?"danger":dsr>30?"warning":"success"}
      items={ai>0?[
        {l:"연 소득",v:fW(ai)},
        {l:"신규 월 상환액",v:fW(nm)},
        {l:"기존 대출 월 상환액",v:fW(epW)},
        {l:"연간 총 원리금",v:fW(tot)},
        {l:"스트레스 가산",v:stressRate>0?"+"+fP(stressRate*100)+"p":"없음 (고정)",note:stressRate>0?"+1.5%p (2024.9~)":""},
        {l:"실제 적용 금리",v:fP(adjRate*100)},
        {l:"연령별 최대 만기",v:maxTerm+"년",note:parseInt(ny)>maxTerm?"초과→"+maxTerm+"년 적용":""},
        {l:"DSR",v:fP(dsr),note:st},
        {l:"은행 40% 기준 최대대출",v:fW(dsrLimitAmt40),note:"금융위 고시"},
        {l:"비은행 50% 기준 최대대출",v:fW(dsrLimitAmt50),note:"금융위 고시"},
      ]:[]}
    />
  </div></div>);}

function CalcComm({isMo=false,onNav=()=>{}}){
  const[ty,sTy]=useState("res");const[tx,sTx]=useState("sale");const[p,sP]=useState("0");const[isDefault,setIsDefault]=useState(true);const markModified=()=>setIsDefault(false);
  const[dep,sDep]=useState("");const[mon,sMon]=useState("");
  const[customRate,setCustomRate]=useState("");const[useCustom,setUseCustom]=useState(false);
  const[vatIncl,setVatIncl]=useState(true);
  const[showAddr,setShowAddr]=useState(false);const[autoFill,setAutoFill]=useState(null);
  // 거래금액 계산 (제20조 제5항)
  let amt=0;
  if(tx==="rent"){const depW=tW(dep),monW=tW(mon);const conv100=depW+monW*100;amt=conv100<5e7?(depW+monW*70):conv100;}
  else{amt=tW(p);}
  // 요율 계산
  const HOUSE_SALE=[[5e7,.006,25e4],[2e8,.005,80e4],[9e8,.004,null],[12e8,.005,null],[15e8,.006,null],[Infinity,.007,null]];
  const HOUSE_RENT=[[5e7,.005,20e4],[1e8,.004,30e4],[6e8,.003,null],[12e8,.004,null],[15e8,.005,null],[Infinity,.006,null]];
  const findRate=(tbl,a)=>{for(const[max,rate,limit]of tbl){if(a<max)return{rate,limit};} return{rate:tbl[tbl.length-1][1],limit:null};};
  let r=0,mf=null,rateLabel="";
  if(ty==="res"){
    const tbl=tx==="sale"?HOUSE_SALE:HOUSE_RENT;const found=findRate(tbl,amt);r=found.rate;mf=found.limit;rateLabel="주택 "+(tx==="sale"?"매매":"임대차");
  }else if(ty==="offi85"){
    r=tx==="sale"?0.005:0.004;rateLabel="오피스텔(85㎡이하) "+(tx==="sale"?"매매":"임대차");
  }else{
    r=0.009;rateLabel="상가·토지 등 (0.9% 이내 협의)";
  }
  if(useCustom&&pN(customRate)>0)r=pN(customRate)/100;
  const fee=mf?Math.min(Math.floor(amt*r),mf):Math.floor(amt*r);
  const vat=ty==="res"?0:Math.round(fee*0.1);
  const total=vatIncl?fee+vat:fee;
  const amtDesc=tx==="rent"?"보증금 "+fW(tW(dep))+" + 월세 "+fW(tW(mon))+" (환산 "+fW(amt)+")":fW(amt);
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"3fr 2fr",gap:isMo?16:28,alignItems:"start",minWidth:0}}><div>
    <Tog label="물건 종류" value={ty} onChange={v=>{sTy(v);markModified();}} options={[{value:"res",label:"주택"},{value:"offi85",label:"오피스텔(85㎡↓)"},{value:"offi",label:"오피스텔(85㎡↑)"},{value:"com",label:"상가·토지 등"}]}/>
    <Tog label="거래 유형" value={tx} onChange={v=>{sTx(v);markModified();}} options={[{value:"sale",label:"매매"},{value:"lease",label:"전세"},{value:"rent",label:"월세"}]}/>
    {!isMo&&<div style={{marginBottom:10}}><button type="button" onClick={()=>setShowAddr(true)} style={{width:"100%",padding:"12px 16px",background:"linear-gradient(135deg,#eff6ff,#dbeafe)",border:"1.5px solid #bfdbfe",borderRadius:10,fontSize:13,fontWeight:700,color:"#1e40af",cursor:"pointer",fontFamily:"inherit",display:"flex",alignItems:"center",justifyContent:"center",gap:8}}>📍 주소로 실거래가 자동입력</button></div>}
    {showAddr&&<AddressModal onClose={()=>setShowAddr(false)} onApplyPrice={v=>{if(tx==="rent"){sDep(String(Math.round(v/10000)));}else{sP(String(Math.round(v/10000)));}markModified();setAutoFill(true);}} buildingType={ty==="offi85"||ty==="offi"?"officetel":ty==="com"?"commercial":"apt"} calcType="transfer"/>}
    {autoFill&&<div style={{fontSize:11,color:"#60a5fa",fontWeight:600,marginBottom:8,lineHeight:1.5}}>📍 실거래가 자동입력됨 · 직접 수정 가능</div>}
    {tx==="rent"?(<><Inp label="보증금" value={dep} onChange={v=>{sDep(v);markModified();setAutoFill(false);}} suffix="만원" placeholder="예: 5000"/><Inp label="월세" value={mon} onChange={v=>{sMon(v);markModified();setAutoFill(false);}} suffix="만원" placeholder="예: 50"/><div style={{padding:"10px 14px",background:P.lt,borderRadius:8,fontSize:12,color:"#6b778c",lineHeight:1.6,marginBottom:16}}>거래금액 = 보증금 + 월세×{amt<5e7?"70":"100"} = {fW(amt)}</div></>):(<Slider label="거래금액" value={p} onChange={v=>{sP(v);markModified();}} min={1000} max={500000} step={500}/>)}
    <label style={{display:"flex",alignItems:"center",gap:8,fontSize:13,cursor:"pointer",marginBottom:12}}><input type="checkbox" checked={useCustom} onChange={e=>setUseCustom(e.target.checked)} style={{width:16,height:16}}/> 요율 직접 입력</label>
    {useCustom&&<Inp label="직접 입력 요율" value={customRate} onChange={setCustomRate} suffix="%" placeholder="예: 0.4"/>}
    <label style={{display:"flex",alignItems:"center",gap:8,fontSize:13,cursor:"pointer",marginBottom:16}}><input type="checkbox" checked={vatIncl} onChange={e=>setVatIncl(e.target.checked)} style={{width:16,height:16}}/> 부가세(10%) 포함 합계</label>
  </div><div><RPFull miss={isDefault?MI.commission:null} isExample={isDefault} title="중개보수 합계"
      deadline="잔금 지급 시 관행 · 공인중개사법 시행규칙 제20조 (2021.10.19 개정)"
      alertMsg={rateLabel+" · 상한요율 "+fP(r*100)+(mf?" · 한도 "+fW(mf):"")}
      alertType="info"
      total={total}
      sub={amtDesc+" 기준 · 요율 "+fP(r*100)+(vat>0?" · VAT "+(vatIncl?"포함":"별도"):"")}
      items={[{l:"거래금액",v:fW(amt),note:tx==="rent"?"보증금+월세×"+(amt<5e7?"70":"100"):""},{l:"적용 요율",v:fP(r*100),note:useCustom?"직접 입력":(rateLabel+" (공인중개사법 시행규칙 §20)")},{l:"중개보수",v:fW(fee)}].concat(mf&&amt*r>mf?[{l:"상한 적용",v:fW(mf)}]:[]).concat(ty!=="res"?[{l:"부가세 (10%)",v:fW(vat),note:vatIncl?"합계 포함":"별도"}]:[{l:"부가세",v:"해당없음 (개인거래 면세)"}]).concat([{l:"합계 (보수"+(vat>0&&vatIncl?"+VAT":"")+")  ",v:fW(total)}])}/>
    <div style={{fontSize:12,color:"#64748b",padding:"12px 16px",lineHeight:1.7,marginTop:12}}>
      ※ 상한요율 이내에서 중개의뢰인과 협의하여 결정 가능<br/>
      ※ 오피스텔: 전용 85㎡ 이하 + 전용입식부엌·욕실 구비 시 저요율 적용<br/>
      ※ 월세 거래금액 = 보증금 + (월세 × 100), 5천만 미만 시 × 70<br/>
      ※ 근거: 공인중개사법 시행규칙 제20조 (2021.10.19 개정)
    </div>
  </div></div>);
}

function CalcConvert({isMo=false,onNav=()=>{}}){const[type,sType]=useState("m2j");const[deposit,sDep]=useState("");const[monthly,sMon]=useState("");const[rate,sRate]=useState("");const dep=tW(deposit),mon=tW(monthly),rt=pN(rate)/100;let result=0;if(type==="m2j"){result=rt>0?mon*12/rt+dep:0;}else{result=dep>0&&rt>0?(dep*rt)/12:0;}return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"3fr 2fr",gap:isMo?16:28,alignItems:"start",minWidth:0}}><div><Tog label="전환 방향" value={type} onChange={sType} options={[{value:"m2j",label:"월세 → 전세"},{value:"j2m",label:"전세 → 월세"}]}/>{type==="m2j"?<><Inp label="보증금" value={deposit} onChange={sDep} suffix="만원" placeholder="예: 5000"/><Inp label="월세" value={monthly} onChange={sMon} suffix="만원" placeholder="예: 80"/></>:<Inp label="전세보증금" value={deposit} onChange={sDep} suffix="만원" placeholder="예: 30000"/>}<div style={{fontSize:13,color:"#374151",fontWeight:600,marginBottom:4,display:"flex",alignItems:"center",gap:6}}>전환율 <TipModal title=""><p>법정 상한: 기준금리(3%)+2% = 5.0% (2026년). 임대인이 초과 요구 불가.</p></TipModal></div><Inp label="" value={rate} onChange={sRate} suffix="%" note="2025 법정 전환율 상한: 기준금리+2%"/>
    </div><RPFull miss={(dep>0||mon>0)?null:MI.convert} title={type==="m2j"?"전세 환산금액":"월세 환산금액"}
...
function CalcDTI({isMo=false,onNav=()=>{}}){const[inc,sInc]=useState("");const[la,sLa]=useState("");const[lr,sLr]=useState("");const[ly,sLy]=useState("30");const[ei,sEi]=useState("");const[existPrincipal,setExistPrincipal]=useState("");const ai=tW(inc),laW=tW(la),lrV=pN(lr)/100/12,lN=parseInt(ly)*12,eiW=tW(ei);const existPrinW=tW(existPrincipal);let na=0;if(laW>0&&lrV>0&&lN>0)na=laW*lrV*Math.pow(1+lrV,lN)/(Math.pow(1+lrV,lN)-1)*12;const tot=na+eiW*12,dti=ai>0?tot/ai*100:0;const newDTI=ai>0?(na+eiW*12+existPrinW*12)/ai*100:0;let st="양호",sc="#00875A";if(dti>60){st="한도 초과";sc="#DE350B";}else if(dti>50){st="주의";sc="#FF8B00";}return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"3fr 2fr",gap:isMo?16:28,alignItems:"start",minWidth:0}}><div><Inp label="연 소득" value={inc} onChange={sInc} suffix="만원" placeholder="예: 5000" error={!inc||inc==="0"}/><Inp label="신규 대출금액" value={la} onChange={sLa} suffix="만원" placeholder="예: 30000" error={!la||la==="0"}/><Inp label="대출 금리" value={lr} onChange={sLr} suffix="%" placeholder="예: 3.5" error={!lr||lr==="0"}/>{!isMo&&<BaseRateHint/>}<Sel label="대출 기간" value={ly} onChange={sLy} options={[5,10,15,20,25,30,35,40].map(y=>({value:String(y),label:y+"년"}))}/><div style={{fontSize:12,color:"#6b778c",marginBottom:6,marginLeft:2,display:"flex",alignItems:"center",gap:4,flexWrap:"nowrap"}}>DTI vs DSR <TipModal title="DTI와 DSR의 차이"><p><b>DTI:</b> 신규 원리금 + 기존 이자만 포함</p><p><b>DSR:</b> 모든 대출 원금+이자 포함 (더 엄격)</p></TipModal></div><Inp label="기존 대출 월이자 합계" value={ei} onChange={sEi} suffix="만원" placeholder="없으면 0" note="DTI는 기존 대출의 이자만 포함 (원금 미포함)"/><Inp label="기존 대출 월 원금상환액 (신DTI용)" value={existPrincipal} onChange={setExistPrincipal} suffix="만원" placeholder="없으면 0" note="신DTI 계산 시 기존 대출 원금도 포함"/></div><div>
    <RPFull miss={(ai>0&&laW>0)?null:["연 소득을 입력해주세요","신규 대출금액을 입력해주세요","대출 금리를 입력해주세요"]}
      title="DTI (총부채상환비율)"
      total={ai>0?fP(dti):"0%"}
      sub={ai>0?("DTI "+fP(dti)+" · "+st+" · 규제기준 투기과열40% 조정50% 비규제60%"):"필수 항목을 입력해주세요"}
      ...
      alertType={dti>60?"danger":dti>40?"warning":"success"}
      items={ai>0?[
        {l:"연 소득",v:fW(ai)},
        {l:"신규 대출 연간 원리금",v:fW(na)},
        {l:"기존 대출 연간 이자",v:fW(eiW*12)},
        {l:"DTI (구)",v:fP(dti),note:"신규원리금+기존이자"},
        {l:"신DTI",v:fP(newDTI),note:"신규원리금+기존원리금"},
        {l:"투기과열지구 한도",v:"40%",note:dti<=40?"✓ 통과":"✗ 초과"},
...
function CalcNetSale({isMo=false,onNav=()=>{}}){
  ...
  return(<>{showLookup&&<AddressModal onClose={()=>setShowLookup(false)} onApplyPrice={v=>{setSellP(String(Math.round(v/10000)));setShowLookup(false);setAutoSaleFill(true);}}/>}<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"3fr 2fr",gap:isMo?16:32,alignItems:"start",minWidth:0}}><div>
    ...
    <RPFull miss={sellW>0?null:MI.netsale} title="매도 실수령액" total={Math.max(0,net)} sub={"매도가 "+fW(sellW)+" 기준"}
      ...
      items={[
        ...
        {l:"(-) 기타비용",v:"-"+fW(otherW)},
        {l:"= 실수령액",v:fW(net)}
      ]} nextStep={<NextStep calcId="netsale" onNav={onNav} isMo={isMo}/>}/>
...
function CalcTerms({isMo=false,onNav=()=>{}}){
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"3fr 2fr",gap:isMo?16:28,alignItems:"start",minWidth:0}}><div><div style={{display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"60px 24px",textAlign:"center"}}>
...
function CalcReg({isMo=false,onNav=()=>{}}){const[tx,sTx]=useState("sale");const[propType,sPT]=useState("house");const[p,sP]=useState("");const[loan,sLoan]=useState("");const pW=tW(p),loanW=tW(loan);const _regErr=!p||p==="0";
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"3fr 2fr",gap:isMo?16:28,alignItems:"start",minWidth:0}}><div><Tog label="거래 유형" value={tx} onChange={sTx} options={[{value:"sale",label:"매매"},{value:"gift",label:"증여"},{value:"inherit",label:"상속"}]}/><Tog label="부동산 유형" value={propType} onChange={sPT} options={[{value:"house",label:"주택"},{value:"land",label:"토지·상가·건물"}]}/><Inp label="부동산 가액" value={p} onChange={sP} suffix="만원" placeholder="예: 90000" error={_regErr}/><Inp label="대출금액 (설정등기용)" value={loan} onChange={sLoan} suffix="만원" placeholder="없으면 0" note="채권최고액 = 대출액 × 120%"/></div><div><RPFull miss={pW>0?null:MI.registration} title="등기비용 통합"
      ...
      alertType="info"
      total={total} sub={"총 "+fW(total)+" (취득세 포함)"} items={[{l:"부동산 가액",v:fW(pW)},{l:"▼ 취득세 합계",v:fW(acqTotal),note:"세금 파트"},{l:"  취득세 ("+(acqR*100).toFixed(1)+"%)",v:fW(acqTax),note:"지방세법 §11"},{l:"  지방교육세",v:fW(acqEdu)}].concat(acqFarm>0?[{l:"  농어촌특별세",v:fW(acqFarm)}]:[]).concat([{l:"▼ 채권할인료",v:fW(bondCost),note:"할인율 4.5% 적용"},{l:"  매입률 "+fP(bondRate*100),v:"매입액 "+fW(bondAmt)},{l:"  실부담 (매입액×4.5%)",v:fW(bondCost)},{l:"인지세",v:fW(stamp),note:"인지세법 §3"},{l:"법원수수료",v:fW(court)},{l:"▼ 법무사 보수 합계",v:fW(legalTotal),note:"VAT·경비 포함"},{l:"  기본 보수",v:fW(legal)},{l:"  VAT (10%)",v:fW(legalVat)},{l:"  교통비·서류",v:fW(80000)}]).concat(loanW>0?[{l:"▼ 설정등기 (근저당)",v:fW(mortTotal),note:"채권최고액 = 대출×120%"},{l:"  등록면허세 (0.2%)",v:fW(mortReg),note:"지방세법 §28"},{l:"  지방교육세",v:fW(mortEdu)}]:[]).concat([{l:"※ 매수가 대비 총비용",v:pW>0?fP(total/pW*100):"0%",note:"세금+등기+법무사"}])} nextStep={<NextStep calcId="registration" onNav={onNav} isMo={isMo}/>}/></div></div>);}
...
function CalcJoint({isMo=false,onNav=()=>{}}){const[p,sP]=useState("");const[isDefault,setIsDefault]=useState(true);const markModified=()=>setIsDefault(false);const[showLookup,setShowLookup]=useState(false);const[autoJointFill,setAutoJointFill]=useState(false);const[r,sR]=useState("50");const pW=tW(p),rv=pN(r)/100;const sB=Math.max(0,(pW-12e8)*0.6);const j1B=Math.max(0,(pW*rv-9e8*rv)*0.6);const j2B=Math.max(0,(pW*(1-rv)-9e8*(1-rv))*0.6);const C2=[[3e8,.005],[6e8,.007],[12e8,.01],[25e8,.013],[50e8,.015],[94e8,.020],[Infinity,.027]];const sT=pTx(sB,C2),jT=pTx(j1B,C2)+pTx(j2B,C2),sv=sT-jT;return(<>{showLookup&&<AddressModal onClose={()=>setShowLookup(false)} onApplyStd={v=>{sP(String(Math.round(v/10000)));setShowLookup(false);setAutoJointFill(true);}}/>}<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"3fr 2fr",gap:isMo?16:32,alignItems:"start",minWidth:0}}><div><div style={{fontSize:12,color:"#6b778c",marginBottom:-8,marginLeft:2,display:"flex",alignItems:"center",gap:4,flexWrap:"nowrap"}}>공동명의 <TipModal title="공동명의 절세"><p>종부세: 단독 12억 vs 공동 각9억(합18억). 양도세: 각 250만 공제. 고령자·장기보유 공제 불가.</p></TipModal></div>{!isMo&&<button onClick={()=>setShowLookup(true)} style={{fontSize:12,color:"#0141f9",background:"none",border:"none",cursor:"pointer",fontWeight:700,fontFamily:"inherit",marginBottom:4,display:"flex",alignItems:"center",gap:4}}><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/></svg>주소로 공시가격 조회</button>}<Inp label="부동산 공시가격" value={p} onChange={v=>{sP(v);setAutoJointFill(false);}} suffix="만원" placeholder="예: 150000" error={!p||p==="0"}/>{autoJointFill&&p&&<div style={{fontSize:11,color:"#4285F4",marginTop:-8,marginBottom:8,fontWeight:500}}>📍 주소조회로 자동입력됨 · 직접 수정 가능</div>}<div style={{marginBottom:16}}><label style={{display:"block",fontSize:12,fontWeight:600,color:P.mt,marginBottom:6}}>{"지분 비율 — 본인 "+r+"% : 배우자 "+(100-parseInt(r))+"%"}</label><input type="range" min="10" max="90" step="10" value={r} onChange={e=>sR(e.target.value)} style={{width:"100%",accentColor:P.pri}}/><div style={{display:"flex",justifyContent:"space-between",fontSize:11,color:P.mt,marginTop:4}}><span>본인 10%</span><span>본인 90%</span></div></div><div style={{padding:"14px 16px",background:P.lt,borderRadius:10,fontSize:13,color:"#4a5568",lineHeight:1.6}}><b>단독명의:</b> 1주택 공제 12억, 고령자·장기보유 공제 가능<br/><b>공동명의:</b> 각 9억 공제 (합 18억), 고령자·장기보유 공제 불가</div>
      ...
      total={Math.abs(sv)} sub={"절세액 기준 비교"} items={[{l:"단독명의 (1주택 12억 공제)",v:fW(sT),note:sv<=0?"✓ 유리":""},{l:"공동명의 본인 ("+r+"%)",v:fW(pTx(j1B,C2))},{l:"공동명의 배우자 ("+(100-parseInt(r))+"%)",v:fW(pTx(j2B,C2))},{l:"공동명의 종부세 합계",v:fW(jT),note:sv>0?"✓ 유리":""},{l:"차이 (절세액)",v:fW(Math.abs(sv))},{l:"본인 지분 금액",v:fW(pW*rv)},{l:"배우자 지분 금액",v:fW(pW*(1-rv))}]} nextStep={<NextStep calcId="joint" onNav={onNav} isMo={isMo}/>}/></div></>);}
...
function CalcLoanMax({isMo=false,onNav=()=>{}}){
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"3fr 2fr",gap:isMo?16:28,alignItems:"start",minWidth:0}}><div><Inp label="연 소득" value={inc} onChange={sInc} suffix="만원" placeholder="예: 5000" error={!inc||inc==="0"}/><Inp label="주택가격 (시가)" value={price} onChange={sPrice} suffix="만원" placeholder="예: 90000" note="입력 시 LTV·주담대 한도 적용"/><Tog label="주택 소재지" value={region} onChange={sRegion} options={[{value:"metro",label:"수도권·규제지역"},{value:"non",label:"비수도권"}]}/><Tog label="DSR 기준" value={dsrLim} onChange={sDsrLim} options={[{value:"40",label:"은행 40%"},{value:"50",label:"비은행 50%"}]}/><Tog label="대출 유형 (스트레스)" value={loanType} onChange={sLT} options={[{value:"fixed",label:"고정"},{value:"mixed",label:"혼합(+0.75p)"},{value:"variable",label:"변동(+1.5p)"}]}/><Inp label="대출 금리" value={rt} onChange={sRt} suffix="%" placeholder="예: 3.5" note={stressRate>0?"스트레스 가산 후 "+fP(adjRate*100)+" 적용":"고정금리 가산 없음"}/>{!isMo&&<BaseRateHint/>}<div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12}}><Sel label="대출 기간" value={yr} onChange={sYr} options={[5,10,15,20,25,30,35,40].map(y=>({value:String(y),label:y+"년"}))}/><Sel label="차주 연령대" value={age} onChange={sAge} options={[{value:"20",label:"20대"},{value:"30",label:"30대"},{value:"40",label:"40대"},{value:"50",label:"50대"},{value:"60",label:"60대"}]}/></div><Inp label="기존 대출 월 상환액" value={ep} onChange={sEp} suffix="만원" placeholder="없으면 0"/>{region==="metro"&&pW>0&&<div style={{padding:"12px 16px",background:"#FFF8E1",border:"1px solid #FFE082",borderRadius:10,fontSize:13,color:"#F57F17",marginTop:12,lineHeight:1.6}}>수도권·규제지역 주담대 한도: 15억↓ 6억 / 25억↓ 4억 / 25억↑ 2억 (2025.6.28~ 시행)</div>}</div><div><RPFull miss={tW(inc)>0?null:MI.loanmax} title="최대 대출가능액"
      ...
      total={Math.max(0,maxLoan)} sub={"제한 요인: "+limitReason} items={[{l:"연 소득",v:fW(ai)},{l:"실제 적용 금리",v:fP(adjRate*100),note:stressRate>0?"스트레스 +"+fP(stressRate*100)+"p":"가산 없음"},{l:"적용 대출 기간",v:adjYear+"년",note:parseInt(yr)>maxTerm?"연령 최대 "+maxTerm+"년":""},{l:"DSR 기준 대출가능액",v:fW(Math.max(0,dsrLoan)),note:"금융위 고시"}].concat(pW>0?[{l:"LTV 70% 기준",v:fW(ltvLoan),note:"금융위 고시"}]:[]).concat(region==="metro"&&pW>0?[{l:"수도권 주담대 한도",v:metroCap===Infinity?"제한없음":fW(metroCap)}]:[]).concat([{l:"최대 대출가능액",v:fW(Math.max(0,maxLoan)),note:limitReason+" 적용"},{l:"적용 DSR",v:fP(actualDsr)}])} nextStep={<NextStep calcId="loanmax" onNav={onNav} isMo={isMo}/>}/></div></div>);}
...
function CalcHoldTax({isMo=false,onNav=()=>{}}){const[h,sH]=useState("1");const[p,sP]=useState("");const[isDefault,setIsDefault]=useState(true);const markModified=()=>setIsDefault(false);const[showHoldLookup,setShowHoldLookup]=useState(false);const[selectedHoldInfo,setSelectedHoldInfo]=useState(null);const[autoHoldFill,setAutoHoldFill]=useState(false);const pW=tW(p);const n=parseInt(h);const ptBase=pW*0.6;const PTB=[[6e7,.001],[1.5e8,.0015],[3e8,.0025],[Infinity,.004]];const ptTax=pTx(ptBase,PTB);const ptCity=Math.round(ptBase*0.0014);const ptEdu=Math.round(ptTax*0.2);const ptTotal=ptTax+ptCity+ptEdu;const cDed=n===1?12e8:9e8;const cBase=Math.max(0,(pW-cDed)*0.6);const CTB=[[3e8,.005],[6e8,.007],[12e8,.01],[25e8,.013],[50e8,.015],[94e8,.020],[Infinity,.027]];const cTax=pTx(cBase,CTB);const cFarm=Math.round(cTax*0.2);const cTotal=cTax+cFarm;const grand=ptTotal+cTotal;return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"3fr 2fr",gap:isMo?16:28,alignItems:"start",minWidth:0}}><div><Radio label="주택 수" value={h} onChange={sH} options={[{value:"1",label:"1주택"},{value:"2",label:"2주택"},{value:"3",label:"3주택 이상"}]}/><div style={{fontSize:13,color:"#374151",fontWeight:600,marginBottom:4,display:"flex",alignItems:"center",gap:6}}>공시가격 <TipModal title=""><p>매년 6.1 기준. realtyprice.kr에서 확인. 재산세: 공시가×60%</p></TipModal></div>{!isMo&&<div style={{marginBottom:10}}><button type="button" onClick={()=>setShowHoldLookup(true)} style={{width:"100%",padding:"12px 16px",background:"linear-gradient(135deg,#eff6ff,#dbeafe)",border:"1.5px solid #bfdbfe",borderRadius:10,fontSize:13,fontWeight:700,color:"#1e40af",cursor:"pointer",fontFamily:"inherit",display:"flex",alignItems:"center",justifyContent:"center",gap:8}}>📍 주소로 공시가격 자동조회</button></div>}{showHoldLookup&&<AddressModal calcType="holding" onClose={()=>setShowHoldLookup(false)} onApplyStd={v=>{sP(String(Math.round(v/10000)));markModified();setAutoHoldFill(true);}} onApplyInfo={info=>setSelectedHoldInfo(info)}/>}{selectedHoldInfo&&!isMo&&<div style={{background:"#eff6ff",border:"1px solid #bfdbfe",borderRadius:10,padding:"10px 14px",marginBottom:8,display:"flex",alignItems:"center",justifyContent:"space-between",gap:8}}>
      ...
      </div>}<Inp label="" value={p} onChange={v=>{sP(v);setAutoHoldFill(false);}} suffix="만원" placeholder="예: 150000" error={!p||p==="0"}/>{autoHoldFill&&p&&<div style={{fontSize:11,color:"#4285F4",marginTop:-8,marginBottom:8,fontWeight:500}}>📍 주소조회로 자동입력됨 · 직접 수정 가능</div>}</div><div><RPFull miss={isDefault?MI.holdtax:null} isExample={isDefault} title="연간 보유세 합계"
      ...
      total={grand} sub={"공시가 "+fW(pW)+" 기준 / 재산세+종부세"} items={[{l:"▼ 재산세 (7·9월 납부)",v:fW(ptTotal),note:"지방세법 §111"},{l:"  과세표준 (공정가 60%)",v:fW(ptBase),note:"지방세법 시행령 §109"},{l:"  재산세 본세",v:fW(ptTax)},{l:"  도시지역분 (0.14%)",v:fW(ptCity)},{l:"  지방교육세 (20%)",v:fW(ptEdu)},{l:"▼ 종합부동산세 (12월 납부)",v:fW(cTotal),note:"종부세법 §9"},{l:"  공제금액",v:fW(cDed)},{l:"  과세표준 (공정가 60%)",v:fW(cBase)},{l:"  종부세",v:fW(cTax)},{l:"  농어촌특별세 (20%)",v:fW(cFarm),note:"종부세×20% (농특세법 §5)"},{l:"연간 보유세 총합",v:fW(grand),note:"재산세+종부세"}]} nextStep={<NextStep calcId="loanmax" onNav={onNav} isMo={isMo}/>}/></div></div>);}
...
function CalcStamp({isMo=false,onNav=()=>{}}){
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"3fr 2fr",gap:isMo?16:28,alignItems:"start",minWidth:0}}><div><div style={{fontSize:12,color:"#6b778c",marginBottom:-8,marginLeft:2,display:"flex",alignItems:"center",gap:4,flexWrap:"nowrap"}}>인지세 <TipModal title="인지세"><p>매매계약서 작성 시 부과. 매도·매수인 각 50% 부담. 1억↓ 비과세.</p></TipModal></div><Inp label="거래금액" value={p} onChange={sP} suffix="만원" placeholder="예: 90000" error={!p||p==="0"}/><label style={{display:"flex",alignItems:"center",gap:6,fontSize:13,cursor:"pointer",marginTop:8}}><input type="checkbox" checked={electronic} onChange={e=>setElectronic(e.target.checked)}/> 전자문서 인지세 (70% 할인)</label><div style={{padding:"14px 16px",background:P.lt,borderRadius:10,fontSize:13,color:"#4a5568",lineHeight:1.6,marginTop:8}}>• 1억 이하: 비과세<br/>• 1억~10억: 15만원<br/>• 10억~30억: 35만원<br/>• 30억 초과: 50만원<br/>※ 전자계약 시 70% 할인</div></div><RPFull miss={tW(p)>0?null:MI.stamp} title="인지세"
      ...
      total={stamp} sub={stamp===0?"비과세 구간":"매도·매수인 각 50% 부담"} items={[{l:"거래금액",v:fW(pW)},{l:"기본 인지세액",v:fW(baseStamp),note:"인지세법 §3"}].concat(electronic?[{l:"전자문서 할인 (70%)",v:"-"+fW(baseStamp-stamp)}]:[]).concat([{l:"납부 인지세",v:fW(stamp)},{l:"매도인 부담",v:fW(half)},{l:"매수인 부담",v:fW(half)}])} nextStep={<NextStep calcId="stamp" onNav={onNav} isMo={isMo}/>}/></div>);}
...
function CalcRental({isMo=false,onNav=()=>{}}){const[h,sH]=useState("2");const[ri,sRi]=useState("");const[er,sEr]=useState("");const[bd,sBd]=useState("");const[mode,sMode]=useState("sep");const riW=tW(ri);const erV=pN(er)/100;const bdW=tW(bd);const n=parseInt(h);const sepBase=Math.max(0,riW*(1-erV)-bdW);const sepTax=Math.round(sepBase*0.14);const compBase=Math.max(0,riW-riW*0.6-2500000);const compTax=pTx(compBase,IB);const better=sepTax<=compTax?"분리과세":"종합과세";const isExempt=n===1&&riW<=0;return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"3fr 2fr",gap:isMo?16:28,alignItems:"start",minWidth:0}}><div><Radio label="주택 수" value={h} onChange={sH} options={[{value:"1",label:"1주택 (기준시가 12억↑만 과세)"},{value:"2",label:"2주택"},{value:"3",label:"3주택 이상"}]}/><Inp label="연간 임대수입" value={ri} onChange={sRi} suffix="만원" placeholder="예: 1500" error={!ri||ri==="0"}/><Inp label="필요경비율" value={er} onChange={sEr} suffix="%" note="분리과세 시 50%, 등록임대 60%"/><Inp label="기본공제" value={bd} onChange={sBd} suffix="만원" note="미등록 200만, 등록 400만"/><Tog label="과세 방식" value={mode} onChange={sMode} options={[{value:"sep",label:"분리과세 (14%)"},{value:"comp",label:"종합과세 (6~45%)"}]}/></div><div><RPFull miss={riW>0?null:MI.rental} title={mode==="sep"?"분리과세 임대소득세":"종합과세 임대소득세"}
      ...
      total={mode==="sep"?sepTax:compTax} sub={"유리한 방식: "+better} items={[{l:"연간 임대수입",v:fW(riW)},{l:"필요경비 ("+pN(er)+"%)",v:"-"+fW(Math.round(riW*erV)),note:"등록 60% / 미등록 50%"},{l:"기본공제",v:"-"+fW(bdW)},{l:"분리과세 과세표준",v:fW(sepBase)},{l:"분리과세액 (14%)",v:fW(sepTax),note:(sepTax<=compTax?"✓ 유리 · ":"")+"소득세법 §64의2"},{l:"종합과세 참고액",v:fW(compTax),note:compTax<sepTax?"✓ 유리":""},{l:"세액 차이",v:fW(Math.abs(sepTax-compTax))},{l:"유리한 방식",v:better}]} nextStep={<NextStep calcId="rental" onNav={onNav} isMo={isMo}/>}/></div></div>);}
...
function CalcRemodel({isMo=false,onNav=()=>{}}){const[cv,sCv]=useState("");const[cost,sCost]=useState("");const[ev,sEv]=useState("");const cvW=tW(cv),costW=tW(cost),evW=tW(ev);const profit=evW-cvW-costW;const roi=costW>0?profit/costW*100:0;const totalRoi=(cvW+costW)>0?profit/(cvW+costW)*100:0;return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"3fr 2fr",gap:isMo?16:28,alignItems:"start",minWidth:0}}><div><Inp label="기존 평가액 (현재 시세)" value={cv} onChange={sCv} suffix="만원" placeholder="예: 80000"/><Inp label="리모델링 분담금" value={cost} onChange={sCost} suffix="만원" placeholder="예: 15000"/><Inp label="리모델링 후 예상가" value={ev} onChange={sEv} suffix="만원" placeholder="예: 120000"/>
      ...
      total={Math.abs(profit)} sub={"분담금 대비 수익률 "+fP(roi)} items={[{l:"기존 평가액",v:fW(cvW)},{l:"리모델링 분담금",v:fW(costW)},{l:"총 투자액",v:fW(cvW+costW)},{l:"리모델링 후 예상가",v:fW(evW)},{l:"예상 수익",v:fW(profit),note:profit>=0?"+":"-"},{l:"분담금 대비 수익률",v:fP(roi)},{l:"총투자 대비 수익률",v:fP(totalRoi)},{l:"손익분기점",v:profit>=0?"달성":fW(Math.abs(profit))+" 부족",note:"예상가 기준"}]} nextStep={<NextStep calcId="remodel" onNav={onNav} isMo={isMo}/>}/></div>);}

/* 건물잔존가치 */
function CalcBldValue({isMo=false,onNav=()=>{}}){const[np,sNp]=useState("");const[ul,sUl]=useState("40");const[el,sEl]=useState("");const[mt,sMt]=useState("line");const npW=tW(np),ulV=parseInt(ul),elV=parseInt(el||"0");let remaining=0,depreciation=0;if(npW>0&&ulV>0){if(mt==="line"){const ratio=Math.max(0,Math.min(1,1-elV/ulV));remaining=Math.round(npW*ratio);depreciation=npW-remaining;}else{remaining=Math.round(npW*Math.pow(0.9,elV));depreciation=npW-remaining;}}const pct=npW>0?remaining/npW*100:0;return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"3fr 2fr",gap:isMo?16:28,alignItems:"start",minWidth:0}}><div><Inp label="신축 가격 (재조달원가)" value={np} onChange={sNp} suffix="만원" placeholder="예: 50000"/><Sel label="내용연수" value={ul} onChange={sUl} options={[{value:"20",label:"20년 (경량철골)"},{value:"30",label:"30년 (조적·블록)"},{value:"40",label:"40년 (철근콘크리트)"},{value:"50",label:"50년 (SRC)"}]}/><Inp label="경과연수" value={el} onChange={sEl} placeholder="예: 15"/><Tog label="감가 방법" value={mt} onChange={sMt} options={[{value:"line",label:"정액법"},{value:"declining",label:"정률법 (10%)"}]}/></div><RPFull miss={(npW>0&&el)?null:MI.bldvalue} title="건물 잔존가치"
      ...
      total={remaining} sub={"잔존률 "+fP(pct)} items={[{l:"신축 가격",v:fW(npW)},{l:"내용연수",v:ulV+"년"},{l:"경과연수",v:elV+"년"},{l:"감가방법",v:mt==="line"?"정액법":"정률법 (10%)"},{l:"정액법 기준 잔존률",v:fP(Math.max(0,Math.min(1,1-elV/ulV))*100)},{l:"정률법 기준 잔존률",v:fP(Math.pow(0.9,elV)*100)},{l:"감가상각 누계",v:fW(depreciation)},{l:"잔존가치",v:fW(remaining)},{l:"잔존률",v:fP(pct)}]} nextStep={<NextStep calcId="bldvalue" onNav={onNav} isMo={isMo}/>}/></div>);}
...
function CalcIncTax({isMo=false,onNav=()=>{}}){const[incType,sIT]=useState("salary");const[gross,sGross]=useState("");const[deductions,sDed]=useState("");const[bizType,sBT]=useState("simple");const[bizRate,sBR]=useState("");
  ...
  </div><div><RPFull miss={tW(gross)>0?null:MI.inctax} title="종합소득세"
...
function CalcYearEnd({isMo=false,onNav=()=>{}}){const[salary,sSal]=useState("");const[card,sCard]=useState("");const[medical,sMed]=useState("");const[edu,sEdu]=useState("");const[donate,sDon]=useState("");const[insurance,sIns]=useState("");const[pension,sPen]=useState("");const[monthlyRent,sMR]=useState("");
  ...
  const npn=salW*.045,hi=salW*.03595,ei=salW*.009,socialDed=npn+hi+ei;
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"3fr 2fr",gap:isMo?16:28,alignItems:"start",minWidth:0}}><div>
    ...
    {salW<=7e7&&<Inp label="월세 총액 (연간)" value={monthlyRent} onChange={sMR} suffix="만원" placeholder="예: 600" note="총급여 7천↓ 대상, 5500만↓17%·초과15%, 한도 1000만"/>}
  </div><div>{salW<=0&&<RequiredGuide items={[{label:"연봉 (세전)",filled:salW>0}]}/>}<RPFull miss={salW>0?null:MI.yearend} title={refund>=0?"예상 환급액":"추가 납부 예상"}
      ...
      total={Math.abs(refund)} sub={refund>=0?"돌려받는 금액":"더 내야 할 금액"} items={[{l:"총급여",v:fW(salW)},{l:"근로소득공제",v:"-"+fW(workDed),note:"소득세법 §47"},{l:"기본공제 (본인+가족 "+(1+spouseN+parentsN+childN)+"명)",v:"-"+fW(basicDed)}].concat(seniorN>0?[{l:"경로우대공제 ("+seniorN+"명)",v:"-"+fW(seniorDed)}]:[]).concat(disabledN>0?[{l:"장애인공제 ("+disabledN+"명)",v:"-"+fW(disabledDed)}]:[]).concat([{l:"인적공제 합계",v:"-"+fW(personalDed)},{l:"4대보험료 공제",v:"-"+fW(socialDed),note:"국민연금+건강+고용"},{l:"신용카드 소득공제",v:"-"+fW(cardDed),note:"조특법 §126의2"},{l:"과세표준",v:fW(taxableIncome)},{l:"산출세액",v:fW(tax),note:"소득세법 §55"},{l:"  연금저축 공제",v:"-"+fW(Math.round(penCredit))},{l:"  의료비 공제",v:"-"+fW(Math.round(medCredit))},{l:"  교육비 공제",v:"-"+fW(Math.round(eduCredit))},{l:"  기부금 공제",v:"-"+fW(Math.round(donCredit))},{l:"  자녀 세액공제",v:"-"+fW(childCredit)}]).concat(rentCredit>0?[{l:"  월세 세액공제",v:"-"+fW(rentCredit)}]:[]).concat([{l:"세액공제 합계",v:"-"+fW(totalCredit)},{l:"결정세액",v:fW(finalTax)},{l:"지방소득세 (10%)",v:fW(localTax)},{l:"기납부세액 (추정)",v:fW(prepaid)},{l:refund>=0?"예상 환급":"추가 납부",v:fW(Math.abs(refund)),note:refund>=0?"✓ 환급":"추가 납부"}])} nextStep={<NextStep calcId="yearend" onNav={onNav} isMo={isMo}/>}/><RequiredGuide items={[{label:"연간 총급여액",filled:false}]}/></div></div>);}
...
function CalcNetSalary({isMo=false,onNav=()=>{}}){const[salary,sSal]=useState("");const[family,sFamily]=useState("1");const[child,sChild]=useState("0");const[nonTax,sNT]=useState("");
  ...
  const monthlySal=taxableSal/12;const npn=Math.min(monthlySal,6370000)*.045,hi=monthlySal*.03595,ltc=hi*.1314,ei=monthlySal*.009;const monthlyIns=npn+hi+ltc+ei;const totalIns=monthlyIns*12;
...
function CalcRetire({isMo=false,onNav=()=>{}}){const[monthly,sM]=useState("");const[years,sY]=useState("");const[months,sMo]=useState("0");
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"3fr 2fr",gap:isMo?16:28,alignItems:"start",minWidth:0}}><div>
    ...
    <div style={{padding:"12px 16px",background:P.lt,borderRadius:10,fontSize:12,color:"#6b778c",lineHeight:1.6,marginTop:8}}>※ 퇴직금 = 1일 평균임금 × 30일 × (근속일수/365) / ※ 1년 이상 근무 시 수령 자격</div>
    ...
    </div><RPFull miss={(monthlyW>0&&y>0)?null:MI.retire} title="예상 퇴직금"
      ...
      total={severance} sub={y+"년 "+m+"개월 근속 기준"} items={[{l:"월 평균임금",v:fW(monthlyW),note:"최근 3개월 평균"},{l:"근속기간",v:y+"년 "+m+"개월 ("+totalDays+"일)"},{l:"1일 평균임금",v:fW(Math.round(monthlyW/30))},{l:"계산식",v:"월급×30일×근속일수÷365",note:"근로자퇴직급여보장법 §8"},{l:"퇴직금 (세전)",v:fW(severance)},{l:"퇴직소득세 (추정)",v:fW(Math.round(retireTax)),note:"간이 계산"},{l:"실수령 퇴직금 (추정)",v:fW(severance-Math.round(retireTax))}]} nextStep={<NextStep calcId="retire" onNav={onNav} isMo={isMo}/>}/></div>);}
...
function CalcUnemploy({isMo=false,onNav=()=>{}}){const[age,sAge]=useState("30");const[years,sY]=useState("3");const[daily,sD]=useState("");
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"3fr 2fr",gap:isMo?16:28,alignItems:"start",minWidth:0}}><div>
    ...
    <div style={{background:P.card,borderRadius:10,border:"1px solid "+P.bd,padding:"12px 14px",marginTop:12,fontSize:12}}>
    ...
    </div>{dailyW<=0&&<RequiredGuide items={[{label:"퇴직 전 평균임금",filled:dailyW>0}]}/>}<RPFull miss={dailyW>0?null:MI.unemploy} title="실업급여 예상"
      ...
      alertType="info"
      total={monthlyAmount} sub={"월 수령액 기준 · 최대 "+duration+"일"} items={[{l:"1일 평균임금",v:fmt(dailyW)+"원"},{l:"1일 실업급여액 (60%)",v:fmt(calcDaily)+"원",note:"고용보험법 §46"},{l:"상한액",v:fmt(maxDaily)+"원",note:"일 66,000원"},{l:"하한액 (최저임금80%)",v:fmt(minDaily)+"원"},{l:"수급 기간",v:duration+"일 (약 "+(duration/30).toFixed(1)+"개월)",note:ageV+"세 "+yV+"년 가입"},{l:"월 수령액 (30일)",v:fmt(monthlyAmount)+"원"},{l:"총 수령액",v:fmt(totalAmount)+"원"}]} nextStep={<NextStep calcId="unemploy" onNav={onNav} isMo={isMo}/>}/></div>);}
...
function CalcCarTax({isMo=false,onNav=()=>{}}){const[carType,sCT]=useState("normal");const[cc,sCC]=useState("");const[year,sYear]=useState("0");const[isElec,sElec]=useState("no");
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"3fr 2fr",gap:isMo?16:28,alignItems:"start",minWidth:0}}><div>
    ...
    <div style={{padding:"12px 16px",background:P.lt,borderRadius:10,fontSize:12,color:"#6b778c",lineHeight:1.6,marginTop:8}}>※ 6월·12월 연 2회 납부 / 1월 연납 시 약 5% 할인</div>
    ...
    </div><RPFull miss={(isElec==="yes"||ccVal>0)?null:MI.cartax} title="자동차세 (연간)"
      ...
      alertType="info"
      total={totalYear} sub={discount>0?"차령 할인 "+Math.round(discount*100)+"%":"할인 없음 (3년 미만)"} items={[{l:"기본 자동차세",v:fW(baseTax),note:(isElec==="yes"?"전기·수소차 정액":ccVal+"cc 기준")+" (지방세법 §127)"},{l:"차령 할인",v:discount>0?"-"+fW(baseTax-discountedTax):"해당없음",note:discount>0?Math.round(discount*100)+"%":""},{l:"할인 후 자동차세",v:fW(discountedTax)},{l:"지방교육세 (30%)",v:fW(localEdu)},{l:"연간 합계",v:fW(totalYear)},{l:"6월 납부",v:fW(halfYear)},{l:"12월 납부",v:fW(totalYear-halfYear)},{l:"1월 연납 시 (5% 할인)",v:fW(Math.round(totalYear*.95)),note:"✓ 추천"}]} nextStep={<NextStep calcId="cartax" onNav={onNav} isMo={isMo}/>}/>
</div>);}
...
function CalcInsurance4({isMo=false,onNav=()=>{}}){const[type,sType]=useState("worker");const[salary,sSal]=useState("");const[bonus,sBonus]=useState("");
  ...
  const npnCap=6370000,npnBase=Math.min(monthlySal,npnCap),npn=Math.round(npnBase*.045),hi=Math.round(monthlySal*.03595),ltc=Math.round(hi*.1314),ei=Math.round(monthlySal*.009),workerTotal=npn+hi+ltc+ei;
  ...
  const selfHi=Math.round(monthlySal*.03595),selfNpn=Math.round(Math.min(monthlySal,npnCap)*.09),selfTotal=selfHi+Math.round(selfHi*.1314)+selfNpn;
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"3fr 2fr",gap:isMo?16:28,alignItems:"start",minWidth:0}}><div>
    ...
    <div style={{background:P.card,borderRadius:16,padding:20,border:"1px solid "+P.bd}}>
      ...
      {(isWorker?[["국민연금 (4.75%)",npn],["건강보험 (3.595%)",hi],["장기요양 (13.14%)",ltc],["고용보험 (0.9%)",ei]]:[["국민연금 (9.5%)",selfNpn],["건강보험 (3.595%)",selfHi],["장기요양 (13.14%)",Math.round(selfHi*.1314)]]).map(([l,v],i)=>(<div key={i} style={{display:"flex",justifyContent:"space-between",padding:"8px 0",borderBottom:"1px solid "+P.lt,fontSize:13}}><span style={{color:P.mt}}>{l}</span><span style={{fontWeight:600,color:"#DE350B"}}>-{fW(v)}</span></div>))}
...
function CalcMinWage({isMo=false,onNav=()=>{}}){
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"3fr 2fr",gap:isMo?16:28,alignItems:"start",minWidth:0}}>
    ...
    <div><RPFull miss={parseFloat(weeklyH)>0?null:MI.minwage} title="예상 급여"
      ...
      total={monthly} sub={"시급 "+hourly.toLocaleString()+"원 기준"} items={[{l:"시급",v:hourly.toLocaleString()+"원",note:"2026년 10,030원"},{l:"일급 ("+h+"시간)",v:daily.toLocaleString()+"원"},{l:"주 근무시간",v:weeklyH+"시간"},{l:"주휴수당",v:hasPay?payH.toFixed(1)+"시간/주":"미적용"},{l:"주급 (주휴"+(hasPay?"포함":"미포함")+")",v:Math.round(hourly*totalWH).toLocaleString()+"원"},{l:"월급 (월 "+w+"주)",v:fW(monthly)},{l:"연봉 (월급×12)",v:fW(yearly)},{l:"월급 (주휴 미포함)",v:fW(Math.round(hourly*weeklyH*w)),note:"비교용"}]} nextStep={<NextStep calcId="minwage" onNav={onNav} isMo={isMo}/>}/>
    
    
    </div>
  </div>);
}
const CM={auction2:CalcAuction2,auctiondiv:CalcAuctionDiv,auctionloan:CalcAuctionLoan,bldvat:CalcBldVat,bond2:CalcBond2,datediff:CalcDateDiff,estincome:CalcEstIncome,goodlord:CalcGoodLandlord,imputedrent:CalcImputedRent,jeonseins:CalcJeonseInsurance,legalinherit:CalcLegalInherit,luckyday:CalcLuckyDay,progressive:CalcProgressive,reconyear:CalcReconYear,refinance:CalcRefinance,remodel2:CalcRemodel2,rentincrease:CalcRentIncrease,stamp2:CalcStampNew,realprice:CalcRealPrice,subscription:CalcSubscription,netsale:CalcNetSale,terms:CalcTerms,investTiming:CalcInvestTiming,acquisition:CalcAcq,transfer:CalcTrans,compre:CalcCompre,property:CalcProp,gift:CalcGift,inherit:CalcInherit,mortgage:CalcMort,dsr:CalcDSR,dti:CalcDTI,ltv:CalcLTV,rti:CalcRti,commission:CalcComm,registration:CalcReg,legal:CalcLegal,yield:CalcYield,area:CalcArea,convert:CalcConvert,joint:CalcJoint,totalcost:CalcTotalCost,compare:CalcCompare,invest:CalcInvest,loanmax:CalcLoanMax,holdtax:CalcHoldTax,stamp:CalcStamp,bond:CalcBond,deposit:CalcDeposit,far:CalcFAR,rental:CalcRental,inctax:CalcIncTax,yearend:CalcYearEnd,netsalary:CalcNetSalary,cartax:CalcCarTax,insurance4:CalcInsurance4,pension:CalcPension,retire:CalcRetire,unemploy:CalcUnemploy,minwage:CalcMinWage,appraisal:CalcAppraisal,auction:CalcAuction,remodel:CalcRemodel,bldvalue:CalcBldValue};
...
const RELATED={
  ...
  investTiming:["acquisition","mortgage","transfer","yield"],
};
...
const REGS={
  ...
  insurance4:[{y:"2025",t:"건강보험료율 7.19%, 장기요양 13.14%"},{y:"2025",t:"국민연금 기준소득월액 상한 637만원"}],
...
function CalcGrid({navigateCalc,isMo}){
  ...
  const CALC_ICONS={
    ...
    investTiming:<svg {..._IS}><ellipse cx="12" cy="12" rx="7" ry="9"/><line x1="5" y1="12" x2="19" y2="12"/><line x1="12" y1="3" x2="12" y2="21"/></svg>
  };
  const DATA=[
...
function NotFoundPage({isMo,navigateHome}){
  useEffect(()=>{document.querySelectorAll('meta[name="robots"]').forEach(el=>el.remove());const m=document.createElement('meta');m.name='robots';m.content='noindex, nofollow';document.head.appendChild(m);document.title='페이지를 찾을 수 없습니다 | 생활계산기.com';return()=>{document.querySelectorAll('meta[name="robots"]').forEach(el=>el.remove());};},[]);
  return(<div style={{minHeight:'60vh',display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',padding:'40px 20px',textAlign:'center'}}>
    <h1 style={{fontSize:72,fontWeight:800,color:'#E4E7EB',margin:0,lineHeight:1}}>404</h1>
    <h2 style={{fontSize:24,fontWeight:700,margin:'16px 0 8px',color:'#191F28'}}>페이지를 찾을 수 없습니다</h2>
    <p style={{color:'#6B7684',lineHeight:1.6,maxWidth:480}}>요청하신 페이지가 존재하지 않거나, 주소가 변경되었을 수 있습니다.</p>
    <button onClick={navigateHome} style={{marginTop:24,padding:'12px 32px',background:'#0747A6',color:'#fff',border:'none',borderRadius:8,fontSize:16,fontWeight:600,cursor:'pointer',fontFamily:'inherit'}}>홈으로 이동</button>
  </div>);
}
...
const CALC_NAV_CONTENT={
  ...
  netsalary:{items:[{title:"실수령액이란?",open:true,body:"연봉에서 4대보험료와 소득세·지방소득세를 공제한 후 실제 수령하는 금액."},{title:"4대보험 공제",body:"국민연금 4.5%, 건강보험 3.595%(장기요양 13.14%), 고용보험 0.9%."},{title:"소득세 계산",body:"근로소득간이세액표 기준 원천징수. 부양가족 수에 따라 차등."},{title:"비과세 항목",body:"식대 20만원, 차량유지비 20만원 등 비과세 항목은 공제 전 차감."},{title:"연봉협상 팁",body:"실수령액 기준으로 비교해야 정확. 퇴직금 별도/포함 여부 확인 필수."}],related:["insurance4","yearend","inctax","retire"]},
  insurance4:{items:[{title:"4대보험이란?",open:true,body:"국민연금·건강보험·고용보험·산재보험. 근로자와 사업주가 분담."},{title:"2026년 요율",body:"국민연금 9%(근로자4.5%), 건강보험 7.19%(근로자3.595%), 장기요양 13.14%, 고용보험 1.8%(근로자0.9%)."},{title:"산재보험",body:"전액 사업주 부담. 업종별 0.6~18.6% 차등."},{title:"정산",body:"건강보험은 다음해 4월 정산. 국민연금은 매년 7월 기준소득월액 변경."},{title:"프리랜서",body:"지역가입자로 전환. 국민연금·건강보험 전액 본인 부담."}],related:["netsalary","yearend","pension"]},
...
export default function App(){
  ...
  useEffect(()=>{
    ...
    if(hash==="경제상황판"){setPage("economic");return;}
  ...
  useEffect(()=>{
    const h=(e)=>{
      ...
      const spaPaths=["/news","/community","/policy","/market","/info","/about","/contact","/guide","/pricing","/verification","/terms","/reports","/경제상황판"];
  ...
  useEffect(()=>{if(page==="economic")return;if(page==="calc"&&calc&&PAGE_META[calc]){const m=PAGE_META[calc];document.title=m.title;document.querySelector('meta[name="description"]')?.setAttribute('content',m.desc);document.querySelector('meta[property="og:title"]')?.setAttribute('content',m.title);document.querySelector('meta[property="og:description"]')?.setAttribute('content',m.desc);if(CALC_KEYWORDS[calc]){let kw=document.querySelector('meta[name="keywords"]');if(!kw){kw=document.createElement('meta');kw.name='keywords';document.head.appendChild(kw);}kw.setAttribute('content',CALC_KEYWORDS[calc]);}}else{document.title="생활계산기 - 세금 연말정산 연봉 부동산 종합계산기";document.querySelector('meta[name="description"]')?.setAttribute('content',"취득세 양도세 종합소득세 연말정산 연봉실수령액 DSR 중개보수 4대보험 국민연금 자동차세 등 62가지 무료 계산기. 2026 최신 세법 반영.");}let ld=document.getElementById('dynamic-jsonld');if(!ld){ld=document.createElement('script');ld.id='dynamic-jsonld';ld.type='application/ld+json';document.head.appendChild(ld);}if(page==="calc"&&calc&&PAGE_META[calc]){ld.textContent=JSON.stringify({"@context":"https://schema.org","@graph":[{"@type":"WebApplication","name":PAGE_META[calc].title.split(' | ')[0],"description":PAGE_META[calc].desc,"url":"https://xn--989a00a691bdfa717h.com/"+encodeURIComponent(SLUGS[calc]),"applicationCategory":"FinanceApplication","operatingSystem":"Web","offers":{"@type":"Offer","price":"0","priceCurrency":"KRW"}},{"@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"홈","item":"https://xn--989a00a691bdfa717h.com/"},{"@type":"ListItem","position":2,"name":CATS.find(c=>c.id===cat)?.l||"","item":"https://xn--989a00a691bdfa717h.com/"},{"@type":"ListItem","position":3,"name":CL.find(c=>c.id===calc)?.l||"","item":"https://xn--989a00a691bdfa717h.com/"+encodeURIComponent(SLUGS[calc])}]}]});}else{ld.textContent='';};let cn=document.querySelector('link[rel="canonical"]');if(!cn){cn=document.createElement('link');cn.rel='canonical';document.head.appendChild(cn);}cn.href='https://xn--989a00a691bdfa717h.com'+window.location.pathname;},[page,calc]);

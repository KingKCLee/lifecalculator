...
rti:{title:"RTI 계산기 - 임대수익 대비 이자상환 | 생활계산기",desc:"부동산 임대업 RTI(Rent To Interest) 계산. 연간 임대수입 대비 대출이자 비율. 은행 1.5배·비은행 1.25배 기준."},
...
// SEO_CONTENT → src/data/seoContent.js 로 분리됨 (import 상단 참조)
// 아래 주석은 기존 인라인 SEO_CONTENT를 대체함
const _SEO_CONTENT_MOVED = true; // eslint-disable-line
void(_SEO_CONTENT_MOVED);
/*
acquisition:`<h2>2026년 취득세 완벽 가이드</h2><h3>이런 분들께 필요해요</h3><p>아파트·주택을 매매 계약한 분, 부모님으로부터 부동산을 증여받을 예정인 분, 상속으로 부동산을 취득하게 된 분, 신축 건물을 완공한 건축주. 취득세는 부동산 거래 시 가장 먼저 내는 세금이라 잔금 전에 반드시 확인해야 합니다.</p><h3>이 계산기로 해결되는 것</h3><p>매매·증여·상속·원시취득별 취득세율을 자동 적용하고, 지방교육세·농어촌특별세·인지세까지 한 번에 계산합니다. 조정대상지역 여부, 주택 수, 전용면적에 따른 중과세율과 생애최초 감면까지 모두 반영합니다. 시가표준액(공시가격)이 취득가보다 높을 경우 자동으로 과세표준을 전환합니다.</p><h3>계산 방법과 세율</h3><p>2026년 기준 1주택자는 6억 이하 1%, 6~9억 구간 1~3% 비례세율, 9억 초과 3%가 적용됩니다. 조정대상지역 2주택 8%, 3주택 이상·법인 12% 중과됩니다. 여기에 지방교육세(취득세의 10%), 농어촌특별세(전용 85㎡ 초과 시 0.2%), 인지세(거래금액별 1~35만원)가 추가됩니다. 과세표준은 실거래가와 시가표준액 중 높은 금액입니다.</p><h3>이 계산기 200% 활용법</h3><p>주소 검색 버튼으로 실거래가와 공시가격을 자동으로 불러오세요. 두 금액 중 높은 쪽이 과세표준으로 자동 설정됩니다. 특수조건 칩(조정대상, 생애최초, 일시적 2주택 등)을 마우스 오버하면 각 조건의 세율 변화를 즉시 확인할 수 있습니다. 시나리오를 바꿔가며 비교해보세요.</p><h3>놓치면 손해보는 것들</h3><p>신고기한은 잔금일 또는 등기일 중 빠른 날로부터 60일(상속은 6개월, 증여는 3개월)입니다. 기한 내 미신고 시 20% 무신고가산세가 부과됩니다. 생애최초 감면(최대 200만원, 2028년까지)은 신청하지 않으면 자동 적용되지 않습니다. 일시적 2주택자는 3년 내 종전주택 처분 조건을 꼭 확인하세요.</p>`,
transfer:`<h2>양도소득세 완벽 가이드</h2><h3>이런 분들께 필요해요</h3><p>아파트·주택 매도를 앞둔 분, 다주택자로 중과 유예 기간 내 매도를 검토 중인 분, 1주택 비과세 요건을 확인하고 싶은 분, 상가·토지 매도 시 세후 실수령액이 궁금한 분. 양도세는 매도 결정 전 반드시 시뮬레이션해야 할 세금입니다.</p><h3>이 계산기로 해결되는 것</h3><p>양도차익(양도가-취득가-필요경비)을 산출하고 장기보유특별공제, 기본공제 250만원을 적용한 과세표준에 6~45% 누진세율을 자동 계산합니다. 1주택 비과세 판정, 12억 초과분 과세, 다주택 중과(유예 여부 포함), 지방소득세 10%까지 한 번에 보여줍니다.</p><h3>계산 방법과 세율</h3><p>과세표준 1,400만원 이하 6%부터 10억 초과 45%까지 8단계 누진세율이 적용됩니다. 1주택 2년 이상 보유(조정지역은 2년 거주 포함) 시 12억원까지 비과세입니다. 장기보유특별공제는 1주택 보유 연 4%+거주 연 4% 최대 80%, 다주택은 연 2% 최대 30%입니다. 다주택 중과(+20~30%p)는 2026.5.9까지 유예 중입니다.</p><h3>이 계산기 200% 활용법</h3><p>취득가·양도가를 입력하고 보유기간을 조절하면서 장기보유공제 효과를 비교해보세요. 다주택자는 중과 유예 기간 내 매도 시뮬레이션과 유예 후 시뮬레이션을 나란히 비교할 수 있습니다. 필요경비(취득세, 중개보수, 인테리어비)를 빠짐없이 입력하면 과세표준이 낮아집니다.</p><h3>놓치면 손해보는 것들</h3><p>예정신고 기한은 양도일이 속하는 달의 말일부터 2개월입니다. 무신고 시 20% 가산세에 납부지연가산세까지 추가됩니다. 필요경비 영수증을 분실하면 공제를 받을 수 없으므로 취득 시점부터 보관하세요. 1주택 비과세는 전입신고 기준 거주 요건을 충족해야 합니다.</p>`,
inctax:`<h2>종합소득세 완벽 가이드</h2><h3>이런 분들께 필요해요</h3><p>프리랜서·개인사업자로 5월 신고를 앞둔 분, 3.3% 원천징수 후 실제 세금과 환급액이 궁금한 분, 근로소득 외 부업·임대·금융소득이 있어 합산 과세가 걱정되는 분.</p><h3>이 계산기로 해결되는 것</h3><p>근로·사업·이자·배당·연금·기타소득을 합산하고, 단순경비율/기준경비율 자동 적용 후 인적공제·세액공제를 반영한 산출세액을 계산합니다. 기납부세액(원천징수분 3.3% 등)을 차감하여 추가 납부 또는 환급 예상액을 보여줍니다.</p><h3>계산 방법과 세율</h3><p>8단계 누진세율: 1,400만 이하 6%, 5천만 이하 15%, 8,800만 이하 24%, 1.5억 이하 35%, 3억 이하 38%, 5억 이하 40%, 10억 이하 42%, 10억 초과 45%. 지방소득세 10% 별도입니다. 프리랜서는 업종별 단순경비율(60~90%)을 적용하면 과세소득이 크게 줄어듭니다.</p><h3>이 계산기 200% 활용법</h3><p>소득 유형(근로/사업/기타)을 선택하고 연간 수입을 입력하세요. 단순경비율과 기준경비율을 전환하면서 유리한 쪽을 비교할 수 있습니다. 금융소득이 2천만원을 넘는 경우 합산 과세 시뮬레이션도 가능합니다.</p><h3>놓치면 손해보는 것들</h3><p>신고기한은 매년 5월 1~31일(성실신고확인 대상자는 6월 30일)입니다. 프리랜서 3.3% 원천징수는 대부분 환급 대상이므로 반드시 신고하세요. 단순경비율 적용 대상인데 기준경비율로 신고하면 세금이 더 나올 수 있습니다. 국민연금·건강보험료도 소득공제되므로 누락하지 마세요.</p>`,
yearend:`<h2>연말정산 완벽 가이드</h2><h3>이런 분들께 필요해요</h3><p>직장인으로 13월의 월급(환급)을 극대화하고 싶은 분, 올해 공제 항목을 어떻게 채울지 전략을 세우려는 분, 맞벌이 부부 중 누가 어떤 공제를 받는 게 유리한지 비교하려는 분.</p><h3>이 계산기로 해결되는 것</h3><p>총급여를 입력하면 근로소득공제를 자동 적용하고, 신용카드·의료비·교육비·연금저축·보험료·기부금 등 주요 공제 항목별 한도와 세액공제율을 반영하여 예상 환급액(또는 추가 납부액)을 산출합니다.</p><h3>계산 방법과 세율</h3><p>신용카드 소득공제는 총급여 25% 초과 사용분의 15%(신용카드)~30%(체크카드·현금영수증), 한도 300만원입니다. 의료비 세액공제는 총급여 3% 초과분의 15%(난임시술 20%), 교육비 15%, 연금저축·IRP 12~15%(합산 700만 한도), 보장성보험 12%(100만 한도)입니다. 기부금은 1천만원 이하 15%, 초과분 30%입니다.</p><h3>이 계산기 200% 활용법</h3><p>12월 말까지 연금저축 400만원 납입을 최우선으로 챙기세요(최대 60만원 환급). 홈택스 연말정산 미리보기(1월 중순 오픈)로 예상 환급액을 확인하고 부족한 공제를 채울 수 있습니다. 맞벌이 부부는 의료비를 총급여 낮은 쪽이, 카드는 25% 이미 초과한 쪽이 받는 게 유리합니다.</p><h3>놓치면 손해보는 것들</h3><p>현금영수증 미등록 지출은 공제 대상에서 빠집니다. 월세 세액공제(총급여 8천만 이하, 15~17%)는 임대차계약서+이체 내역이 필요합니다. 중소기업 청년 소득세 감면(90%, 5년)은 입사 시 신청해야 합니다. 부양가족 기본공제는 연 소득 100만원(근로소득만 있으면 총급여 500만원) 이하 요건을 확인하세요.</p>`,
...
dsr:`<h2>DSR 완벽 가이드</h2><h3>이런 분들께 필요해요</h3><p>주택담보대출을 신청하기 전 대출 가능 금액을 확인하려는 분, 기존 신용대출·카드론이 있어 추가 대출 여력이 궁금한 분, 변동금리와 고정금리 중 어떤 것이 DSR에 유리한지 비교하려는 분.</p><h3>이 계산기로 해결되는 것</h3><p>연소득, 신규 대출금액·금리·기간, 기존 대출 월상환액을 입력하면 DSR 비율을 즉시 산출합니다. 스트레스 DSR(변동 +1.5%p, 혼합 +0.75%p)을 자동 반영하고, 은행권(40%) 및 비은행권(50%) 기준 최대 대출 가능액을 역산하여 보여줍니다.</p><h3>계산 방법과 기준</h3><p>DSR = (모든 대출의 연간 원리금 상환액) / 연소득 x 100. 은행권 40%, 비은행 50% 이내여야 대출이 승인됩니다. 2025년부터 스트레스 DSR 3단계가 시행되어 변동금리는 +1.5%p, 혼합형은 +0.75%p 가산금리를 반영합니다. 고정금리는 가산 없습니다.</p><h3>이 계산기 200% 활용법</h3><p>대출 유형(고정/혼합/변동)을 전환하면서 스트레스 가산 차이를 직접 비교하세요. 대출 기간을 30년에서 40년으로 늘리면 월 상환액이 줄어 DSR이 낮아지고 한도가 올라갑니다. 기존 신용대출·카드론을 먼저 상환하면 DSR이 크게 개선되므로, 상환 전후 시뮬레이션을 해보세요.</p><h3>놓치면 손해보는 것들</h3><p>신용대출, 학자금대출, 자동차할부, 카드론 모두 DSR에 포함됩니다. 대출 신청 전 기존 소액 대출을 정리하면 한도가 크게 올라갑니다. 고정금리를 선택하면 스트레스 가산이 없어 같은 소득으로 더 많은 대출이 가능합니다. 연소득 증빙 시 성과급·상여금을 포함하면 소득을 높일 수 있습니다.</p>`,
...
gift:`<h2>증여세 완벽 가이드</h2><h3>이런 분들께 필요해요</h3><p>자녀에게 부동산·현금을 물려주려는 부모님, 배우자 간 자산 이전을 계획하는 부부, 결혼·출산을 앞두고 부모님으로부터 자금을 지원받을 자녀. 증여세는 사전에 계획하면 수천만원을 아낄 수 있습니다.</p><h3>이 계산기로 해결되는 것</h3><p>증여재산 가액에서 증여공제를 차감한 과세표준에 10~50% 누진세율을 자동 적용합니다. 배우자·성년자녀·미성년자녀별 공제한도와 혼인·출산 추가공제(1억)를 반영하고, 신고기한 내 3% 세액공제까지 계산합니다. 10년 내 기증여 합산 기능도 포함됩니다.</p><h3>계산 방법과 세율</h3><p>증여세율은 1억 이하 10%, 5억 이하 20%, 10억 이하 30%, 30억 이하 40%, 30억 초과 50%입니다. 증여공제는 10년 합산 기준으로 배우자 6억, 성년자녀 5천만, 미성년자녀 2천만원입니다. 2024년부터 혼인·출산 시 직계존속 증여 1억원 추가공제가 신설되었습니다.</p><h3>이 계산기 200% 활용법</h3><p>10년 단위 분할 증여 시나리오를 입력하여 총 세부담을 비교하세요. 부동산 증여 시 취득세 3.5%(조정지역 다주택 12%)가 별도 부과되므로 양도와 비교 계산이 필요합니다. 세금비교분석 계산기와 함께 사용하면 매매·증여·상속 중 가장 유리한 방법을 찾을 수 있습니다.</p><h3>놓치면 손해보는 것들</h3><p>신고기한은 증여일이 속하는 달의 말일부터 3개월입니다. 기한 내 자진신고 시 산출세액의 3%를 추가 공제받습니다. 10년 내 동일인 증여는 합산 과세되므로 시기 분산이 중요합니다. 부담부증여(채무 승계)는 양도세와 증여세가 동시에 발생할 수 있으니 반드시 사전에 시뮬레이션하세요.</p>`,
...
compre:`<h2>2026년 종합부동산세 완벽 가이드</h2><h3>이런 분들께 필요해요</h3><p>공시가격 합산 9억원(다주택) 또는 12억원(1주택)을 초과하는 부동산을 보유한 분, 부부 공동명의 1주택 특례(18억 공제)를 검토하는 분, 다주택 보유 중 6월 1일 전 매도 타이밍을 고민하는 분.</p><h3>이 계산기로 해결되는 것</h3><p>보유 주택의 공시가격을 입력하면 공제액 차감, 공정시장가액비율(60%) 적용, 0.5~2.7% 누진세율 산출, 농어촌특별세(20%) 추가까지 한 번에 계산합니다. 1주택자의 고령자·장기보유 세액공제(합산 최대 80%)도 자동 반영됩니다.</p><h3>계산 방법과 세율</h3><p>과세표준 = (공시가격 합계 - 공제액) x 60%. 세율은 3억 이하 0.5%, 6억 이하 0.7%, 12억 이하 1.0%, 25억 이하 1.3%, 50억 이하 1.5%, 94억 이하 2.0%, 94억 초과 2.7%입니다. 전년 대비 세부담 상한은 150%입니다. 농어촌특별세 20%가 별도 부과됩니다.</p><h3>이 계산기 200% 활용법</h3><p>부부 공동명의 1주택 특례(18억 공제)와 단독명의(12억+고령자·장기보유 공제)를 각각 시뮬레이션하여 유리한 쪽을 확인하세요. 공시가격은 부동산공시가격알리미(realtyprice.kr)에서 조회할 수 있습니다. 다주택자는 매도 1건으로 공제액 이하로 떨어지는지 확인해보세요.</p><h3>놓치면 손해보는 것들</h3><p>과세 기준일은 매년 6월 1일입니다. 5월 31일까지 잔금을 치르면 해당 연도 종부세 부담이 매수자에게 이전됩니다. 납부기한은 12월 1~15일이며 250만원 초과 시 6개월 분납(이자 없음)이 가능합니다. 부부 공동명의 특례는 매년 9~10월 홈택스에서 신청해야 합니다.</p>`,
property:`<h2>재산세 완벽 가이드</h2><h3>이런 분들께 필요해요</h3><p>아파트·주택·상가·토지를 보유한 모든 분, 올해 재산세가 얼마나 나올지 미리 확인하고 싶은 분, 공시가격 상승으로 세금 부담이 걱정되는 분. 재산세는 부동산을 보유하기만 해도 매년 부과됩니다.</p><h3>이 계산기로 해결되는 것</h3><p>공시가격과 공정시장가액비율(60~70%)을 적용한 과세표준을 산출하고, 주택은 4단계 누진세율(0.1~0.4%), 상가·건축물은 0.25% 단일세율을 자동 적용합니다. 도시지역분(0.14%), 지방교육세(20%) 등 부가세도 함께 계산합니다.</p><h3>계산 방법과 세율</h3><p>주택 재산세는 과세표준 6천만원 이하 0.1%, 1.5억 이하 0.15%, 3억 이하 0.25%, 3억 초과 0.4%입니다. 공정시장가액비율은 주택 60%, 토지·건축물 70%입니다. 세부담 상한은 공시가격별 105~130%로 전년 대비 급격한 인상이 제한됩니다.</p><h3>이 계산기 200% 활용법</h3><p>공시가격은 부동산공시가격알리미에서 확인하세요. 7월분(건물)과 9월분(토지) 합산 연간 세액을 미리 확인하고 자금을 준비하세요. 여러 부동산을 보유한 경우 각각 입력하여 합산 보유세를 파악할 수 있습니다.</p><h3>놓치면 손해보는 것들</h3><p>과세 기준일은 6월 1일로 종부세와 동일합니다. 매도 시 5월 31일 이전 잔금 완료 여부에 따라 해당 연도 재산세 부담자가 달라집니다. 납부기한은 7월(건물분)·9월(토지분) 16~31일입니다. 재산세는 종부세 계산 시 기납부세액으로 차감되므로 이중과세되지 않습니다.</p>`,
...
rental:`<h2>주택임대소득세 완벽 가이드</h2><h3>이런 분들께 필요해요</h3><p>월세를 받는 2주택 이상 보유자, 전세보증금 합계 3억원을 초과하는 3주택 이상 보유자, 기준시가 12억 초과 1주택으로 월세를 받는 분, 임대사업자 등록 여부를 고민하는 분.</p><h3>이 계산기로 해결되는 것</h3><p>연 임대수입(월세+간주임대료)을 산출하고, 2천만원 이하는 분리과세(14%)와 종합과세 중 유리한 쪽을 비교합니다. 등록임대사업자와 미등록의 필요경비율(60% vs 50%)·기본공제(400만 vs 200만) 차이를 반영한 세액을 나란히 보여줍니다.</p><h3>계산 방법과 세율</h3><p>분리과세 세액 = (연 수입 - 필요경비 - 기본공제) x 14%입니다. 등록임대는 경비율 60%+공제 400만, 미등록은 50%+200만입니다. 2천만원 초과 시 다른 소득과 합산하여 6~45% 종합과세됩니다. 3주택 이상은 전세보증금 간주임대료(초과분x60%x정기예금이율)도 과세됩니다.</p><h3>이 계산기 200% 활용법</h3><p>월세 금액과 보증금을 입력하고, 등록/미등록 시나리오를 전환하면서 연간 세액 차이를 비교하세요. 3주택 이상이면 전세보증금 금액에 따른 간주임대료 추가 과세도 자동 계산됩니다. 다른 소득(근로·사업)이 있는 경우 종합과세 예상 세율도 확인하세요.</p><h3>놓치면 손해보는 것들</h3><p>임대소득이 있으면 매년 5월 종합소득세 확정신고 의무가 있습니다. 무신고 시 20% 가산세가 부과됩니다. 등록임대사업자는 10년 의무임대·5% 임대료 상한 등 사후관리를 준수해야 하며, 위반 시 감면세액+가산세가 전액 추징됩니다. 2주택까지는 전세보증금 간주임대료가 비과세입니다.</p>`,
...
inherit:`<h2>상속세 완벽 가이드</h2><h3>이런 분들께 필요해요</h3><p>부모님의 재산 규모를 파악하고 상속세를 미리 계산하고 싶은 분, 배우자공제·일괄공제 등 어떤 공제가 적용되는지 확인하려는 분, 사전증여와 상속 중 어떤 방법이 유리한지 비교하려는 분.</p><h3>이 계산기로 해결되는 것</h3><p>상속재산 총액에서 채무·공과금을 차감하고, 기초공제(2억)+인적공제 또는 일괄공제(5억) 중 큰 금액, 배우자공제(5~30억), 금융재산공제를 자동 적용합니다. 과세표준에 10~50% 누진세율을 적용하고 신고세액공제(3%)까지 반영한 최종 납부세액을 산출합니다.</p><h3>계산 방법과 세율</h3><p>상속세율은 1억 이하 10%, 5억 이하 20%, 10억 이하 30%, 30억 이하 40%, 30억 초과 50%입니다. 배우자공제는 법정상속분 범위 내에서 5~30억원까지 적용됩니다. 기초공제(2억)+인적공제 합산이 5억 미만이면 일괄공제 5억원을 선택할 수 있습니다.</p><h3>이 계산기 200% 활용법</h3><p>배우자 유무에 따른 공제액 차이를 비교해보세요(배우자 있으면 최소 10억원 공제). 상속인 수와 자녀 인적공제(1인당 5천만원)를 정확히 입력하면 과세표준이 크게 달라집니다. 사전증여(10년 내 합산)가 유리한 구간도 확인할 수 있습니다.</p><h3>놓치면 손해보는 것들</h3><p>신고기한은 사망일이 속하는 달의 말일부터 6개월입니다. 기한 내 신고 시 3% 세액공제를 받습니다. 사망 전 10년 내 상속인에게, 5년 내 비상속인에게 증여한 재산은 상속재산에 합산됩니다. 배우자 상속공제를 최대로 받으려면 실제 배우자가 상속받는 금액이 법정상속분 이내여야 합니다.</p>`,
bldvat:`<h2>건물 부가세 완벽 가이드</h2><h3>건물분 부가가치세란?</h3><p>부동산 매매 시 건물 부분에 대해 부과되는 부가가치세(10%)입니다. 매매가를 토지가와 건물가로 안분하여 건물가액에 대해서만 과세합니다. 매도인이 일반과세자인 경우 세금계산서 발급이 필요합니다.</p><h3>면세 대상</h3><p>전용면적 85㎡ 이하 국민주택규모 주택은 부가세가 면제됩니다. 토지 자체도 부가세 면세입니다. 따라서 주택(85㎡ 이하) 거래에서는 건물분 부가세가 발생하지 않습니다.</p><h3>계산 방법</h3><p>건물분 부가세 = (매매가 - 토지가) ÷ 1.1 × 0.1. 토지가 비율은 공시지가 기준으로 산정하며, 감정평가를 통해 정확한 안분이 가능합니다. 상가·오피스텔(업무용) 거래 시 반드시 확인이 필요합니다.</p>`,
estincome:`<h2>임대 추정소득 완벽 가이드</h2><h3>임대소득 추정이란?</h3><p>월세 수입과 보증금(간주임대료)을 합산하여 연간 총 임대수입금액을 산출하고, 필요경비율을 적용하여 종합소득세 과세 대상 소득금액을 추정하는 과정입니다.</p><h3>필요경비율</h3><p>주택임대 단순경비율은 약 42.6%(등록) ~ 56%(미등록)이며, 실제 장부를 작성하는 경우 실제 경비를 공제할 수 있습니다. 2천만원 이하 임대수입은 분리과세(14%) 선택이 가능합니다.</p><h3>간주임대료</h3><p>3주택 이상 보유하고 전세보증금 합계가 3억원을 초과하면, 초과분의 60%에 정기예금이자율(약 3.5%)을 곱한 금액이 간주임대료로 과세됩니다.</p>`,
goodlord:`<h2>착한임대인 세액공제 완벽 가이드</h2><h3>착한임대인 세액공제란?</h3><p>조세특례제한법 제96조의3에 따라 상가건물 임대료를 인하한 임대인에게 인하액의 최대 70%를 소득세(법인세)에서 공제해주는 제도입니다. 소상공인 임차인을 대상으로 합니다.</p><h3>공제율</h3><p>종합소득금액 1억원 이하: 인하액의 70% 공제. 1억원 초과: 50% 공제. 임대료를 10% 이상 인하해야 적용되며, 인하 기간 동안 재임대 제한, 임대료 인상 금지 등의 요건이 있습니다.</p><h3>적용 요건</h3><p>임차인이 소상공인이어야 하고, 임대인과 임차인이 특수관계가 아니어야 합니다. 종합소득세 또는 법인세 확정신고 시 세액공제 신청서와 임대차계약서를 첨부합니다.</p>`,
imputedrent:`<h2>간주임대료 완벽 가이드</h2><h3>간주임대료란?</h3><p>소득세법 제25조에 따라 3주택 이상을 보유한 개인이 전세보증금 합계 3억원을 초과하면, 초과분에 대해 임대수입이 있는 것으로 간주하여 과세하는 제도입니다.</p><h3>계산 공식</h3><p>간주임대료 = (보증금 합계 - 3억원) × 60% × 정기예금이자율(국세청 고시, 2026년 약 3.5%). 금융소득(보증금 운용으로 발생한 이자·배당)은 차감합니다.</p><h3>과세 제외</h3><p>2주택 이하 보유자, 보증금 합계 3억원 이하인 경우, 주택 수 산정 시 소형주택(전용 40㎡ 이하 + 기준시가 2억 이하)은 제외됩니다. 종합소득세 신고 시 부동산임대소득으로 합산 과세됩니다.</p>`,
legalinherit:`<h2>법정상속분 완벽 가이드</h2><h3>법정상속분이란?</h3><p>민법 제1009조에 따라 유언이 없는 경우 상속재산을 법정 비율로 배분하는 기준입니다. 같은 순위의 상속인이 여러 명이면 균분하되, 배우자는 직계비속 또는 직계존속의 상속분에 5할을 가산합니다.</p><h3>상속 순위</h3><p>1순위: 직계비속(자녀) + 배우자. 2순위: 직계존속(부모) + 배우자. 3순위: 형제자매. 4순위: 4촌 이내 방계혈족. 배우자는 1·2순위 상속인과 공동상속하며, 없으면 단독 상속합니다.</p><h3>유류분</h3><p>배우자·직계비속: 법정상속분의 1/2. 직계존속·형제자매: 법정상속분의 1/3. 유류분을 침해하는 유증·증여는 반환청구가 가능합니다(민법 제1112~1118조).</p>`,
progressive:`<h2>누진세 범용 계산기 가이드</h2><h3>누진세란?</h3><p>과세표준이 커질수록 높은 세율이 적용되는 세금 구조입니다. 한국의 종합소득세(6~45%), 양도소득세(6~45%), 증여세·상속세(10~50%) 등이 누진세 구조를 사용합니다.</p><h3>한계세율과 실효세율</h3><p>한계세율은 마지막 구간에 적용되는 세율이고, 실효세율은 전체 세액을 과세표준으로 나눈 실제 부담률입니다. 예: 과세표준 1억원의 종합소득세 한계세율 35%, 실효세율 약 19.4%.</p><h3>활용 방법</h3><p>세목을 선택하고 과세표준을 입력하면 구간별 세액, 한계세율, 실효세율을 즉시 확인할 수 있습니다. 종합소득세, 양도소득세, 증여세, 상속세 4가지 세목을 지원합니다.</p>`,
subscription:`<h2>청약가점 완벽 가이드</h2><h3>청약가점제란?</h3><p>아파트 분양 시 무주택기간(32점) + 부양가족 수(35점) + 청약통장 가입기간(17점) = 총 84점 만점으로 당첨자를 선정하는 제도입니다. 투기과열지구·조정대상지역 85㎡ 이하 100% 가점제 적용.</p><h3>점수 산정 기준</h3><p>무주택기간: 30세 이상부터 산정, 15년 이상 32점 만점. 부양가족: 배우자·직계존속·직계비속 합산, 6인 이상 35점 만점. 청약통장: 15년 이상 17점 만점.</p><h3>당첨 전략</h3><p>서울 주요 단지 평균 가점 60점 이상. 무주택기간 극대화, 부양가족 등록(직계존속 3년 이상 동거), 통장 유지가 핵심입니다.</p>`,
auctionloan:`<h2>경락잔금대출 완벽 가이드</h2><h3>경락잔금대출이란?</h3><p>법원 경매에서 낙찰받은 부동산의 잔금을 금융기관에서 대출받는 것입니다. 일반 주담대보다 LTV가 높게 적용되며(비규제 80%), 낙찰가 기준으로 대출한도가 산정됩니다.</p><h3>대출 한도</h3><p>비규제지역 낙찰가의 80%, 조정대상지역 70%, 투기과열지구 60%까지 가능합니다. 선순위 근저당(방공제)이 있으면 차감됩니다. DSR 규제도 동일하게 적용됩니다.</p><h3>주의사항</h3><p>잔금 납부기한(보통 1개월)까지 대출 실행이 완료되어야 합니다. 명도 비용, 미납관리비, 인테리어 비용 등 추가 자금도 고려해야 합니다.</p>`,
refinance:`<h2>대환대출 비교 완벽 가이드</h2><h3>대환대출이란?</h3><p>기존 대출을 상환하고 새로운 조건(금리·기간)으로 대출을 갈아타는 것입니다. 금리가 하락했거나 더 유리한 상품이 나왔을 때 이자 절감 효과를 얻을 수 있습니다.</p><h3>중도상환수수료</h3><p>대부분 대출 실행 후 3년 이내 상환 시 중도상환수수료(잔액의 1~1.5%)가 발생합니다. 대환으로 절감되는 이자가 수수료보다 커야 실익이 있습니다.</p><h3>손익분기점 계산</h3><p>대환 수수료 ÷ 월 이자 절감액 = 손익분기 개월수. 남은 대출기간이 손익분기보다 길면 대환이 유리합니다. 금리 차이 0.5%p 이상일 때 검토를 권장합니다.</p>`,
rti:`<h2>RTI 완벽 가이드</h2><h3>RTI란?</h3><p>Rent To Interest ratio, 연간 임대수입을 연간 대출이자로 나눈 비율입니다. 임대업 대출 심사 시 상환 능력을 판단하는 핵심 지표로, 은행은 1.5배 이상, 비은행은 1.25배 이상을 요구합니다.</p><h3>계산 방법</h3><p>RTI = 연간 임대료 ÷ 연간 대출이자. 예: 월세 200만원(연 2,400만원), 대출이자 연 1,200만원이면 RTI = 2.0. 1.5배 이상이면 은행 대출 가능.</p><h3>활용</h3><p>RTI가 높을수록 임대수익 대비 이자 부담이 낮아 안정적입니다. 상가·오피스텔 투자 시 대출 가능 여부를 사전에 확인할 수 있습니다.</p>`,
auction2:`<h2>경매 적정입찰가 가이드</h2><h3>적정입찰가란?</h3><p>경매 물건의 감정가, 지역별 평균 낙찰가율, 용도별 통계를 반영하여 과열 경쟁 없이 합리적인 수준의 입찰가를 산출하는 것입니다. 일반적으로 감정가의 70~90% 수준에서 결정됩니다.</p><h3>낙찰가율</h3><p>서울 아파트 평균 낙찰가율 약 87~92%, 지방 단독주택 60~75%, 상가 50~70%. 유찰 횟수에 따라 최저가가 20~30%씩 하락합니다.</p><h3>전략</h3><p>권리분석(말소기준권리, 임차인 현황) → 현장조사 → 시세 파악 → 수익률 역산 → 입찰가 결정 순서로 진행합니다.</p>`,
auctiondiv:`<h2>경매 배당분석 가이드</h2><h3>배당이란?</h3><p>경매 낙찰대금에서 집행비용을 공제한 후 채권자들에게 우선순위에 따라 배분하는 절차입니다. 배당 순서에 따라 실제 수령 금액이 달라지므로 사전 분석이 필수입니다.</p><h3>배당 순서</h3><p>1순위: 경매 집행비용. 2순위: 최우선변제 소액임차인. 3순위: 확정일자부 임차인·근저당권자(설정일 순). 4순위: 임금채권. 5순위: 조세채권. 후순위 채권자는 남은 금액에서만 배당받습니다.</p><h3>임차인 보호</h3><p>소액임차인 최우선변제금은 서울 5,500만원, 수도권 4,800만원(2026년 기준). 대항력+확정일자를 갖춘 임차인은 배당요구 종기까지 신청해야 합니다.</p>`,
reconyear:`<h2>재건축 연한 가이드</h2><h3>재건축 가능연한이란?</h3><p>도시정비법상 공동주택 재건축사업은 준공 후 일정 연한이 경과해야 안전진단 신청이 가능합니다. 서울 30년, 광역시 25~30년, 기타 지역 20~30년이 기준입니다.</p><h3>안전진단</h3><p>연한 충족 후 안전진단 D등급 이하를 받아야 재건축 추진이 가능합니다. 예비안전진단(지자체) → 정밀안전진단(한국시설안전공단) 2단계로 진행됩니다.</p><h3>투자 시 고려사항</h3><p>연한 도래 시점, 안전등급 예상, 조합설립 가능성, 사업성(용적률 상향 여부)을 종합적으로 판단해야 합니다.</p>`,
remodel2:`<h2>리모델링 ROI 가이드</h2><h3>ROI 분석이란?</h3><p>리모델링 투자수익률(ROI) = (예상매도가 - 현재시세 - 총비용) ÷ 총비용 × 100. 공사비뿐 아니라 공사기간 중 대출이자, 임시거주비, 양도세 추정까지 포함한 종합 수익 분석입니다.</p><h3>비용 항목</h3><p>분담금(공사비), 공사기간 대출이자, 임시거주비(이주비), 이사비용, 완공 후 양도세 추정. 일반적으로 분담금의 110~130%가 총비용입니다.</p><h3>의사결정</h3><p>ROI 20% 이상이면 투자 가치 있음, 10~20%는 보수적 검토, 10% 미만이면 매도 후 신축 매수 대안 비교를 권장합니다.</p>`,
rentincrease:`<h2>임대료 5% 상한 가이드</h2><h3>임대료 인상 상한제란?</h3><p>주택임대차보호법 제7조에 따라 계약갱신청구권을 행사하는 경우 임대료(월세+보증금 환산) 인상폭을 직전 계약의 5%로 제한하는 제도입니다.</p><h3>전월세 전환 시</h3><p>보증금을 올리고 월세를 내리거나 그 반대의 경우에도 5% 상한이 적용됩니다. 전환 시 법정 전환율(기준금리+2%)을 초과할 수 없습니다.</p><h3>적용 범위</h3><p>계약갱신청구권은 1회에 한하여 행사 가능하며, 갱신된 계약의 존속기간은 2년입니다. 임대인의 실거주 목적 등 법정 사유가 있으면 갱신을 거절할 수 있습니다.</p>`,
realprice:`<h2>실거래가 조회 가이드</h2><h3>실거래가 공개시스템</h3><p>국토교통부가 운영하는 부동산 실거래가 공개 시스템에서 전국 아파트, 단독주택, 오피스텔 등의 매매·전세·월세 실거래 내역을 조회할 수 있습니다.</p><h3>조회 방법</h3><p>주소(법정동) + 거래유형(매매/전세/월세) + 기간을 입력하면 최근 거래 내역이 표시됩니다. 계약일, 거래금액, 면적, 층, 건축년도 등의 상세 정보를 확인할 수 있습니다.</p><h3>활용</h3><p>취득세·양도세 계산 시 실거래가 기준으로 정확한 세액을 산출할 수 있습니다. 시세 파악, 투자 분석, 감정평가 참고 자료로도 활용됩니다.</p>`,
netsale:`<h2>매도 실수령액 가이드</h2><h3>실수령액이란?</h3><p>부동산 매도 후 양도소득세, 중개수수료, 기타 비용을 차감한 후 실제로 수령하는 금액입니다. 매도가만으로는 실수령액을 정확히 알 수 없으므로 사전 계산이 중요합니다.</p><h3>차감 항목</h3><p>양도소득세(6~45%), 지방소득세(양도세의 10%), 중개수수료(매도 시 0.4~0.9%), 말소등기비용, 기존 대출 잔액 상환. 1세대1주택 비과세 요건 충족 시 양도세 면제.</p><h3>계산 순서</h3><p>매도가 → 양도차익 산출 → 장기보유특별공제 → 기본공제 250만원 → 세율 적용 → 세액 확정 → 매도가 - 세금 - 비용 = 실수령액.</p>`,
bond2:`<h2>국민주택채권 매입 가이드</h2><h3>국민주택채권이란?</h3><p>주택도시기금법에 따라 부동산 등기 시 의무적으로 매입해야 하는 채권입니다. 매입 후 즉시 시장에서 매도하며, 이때 발생하는 할인 손실이 실제 비용입니다.</p><h3>매입률</h3><p>공시가격 구간별로 1~5% 차등 적용. 서울: 6억 초과 5%, 1.6~6억 4%, 1.6억 이하 3%. 광역시·기타 지역은 낮은 요율 적용.</p><h3>할인율</h3><p>증권사·은행에서 당일 매도 시 약 4~5% 할인율 적용. 실제 부담 비용 = 공시가격 × 매입률 × 할인율.</p>`,
jeonseins:`<h2>전세보증금 보험료 가이드</h2><h3>전세보증보험이란?</h3><p>임대인이 전세보증금을 반환하지 못할 때 보증기관(HUG, HF)이 대신 반환해주는 보험입니다. 임차인이 가입하며, 보증료를 납부합니다.</p><h3>보증료율</h3><p>HUG: 연 0.115~0.154%. HF(한국주택금융공사): 연 0.02~0.04%. 아파트는 HF가 저렴하고, 다세대·오피스텔은 HUG가 주로 취급합니다.</p><h3>가입 요건</h3><p>전세가율(보증금/시세) 일정 비율 이하, 전세계약서 확정일자 보유, 전입신고 완료가 기본 요건입니다.</p>`,
stamp2:`<h2>인지세 (전자계약) 가이드</h2><h3>전자계약 인지세란?</h3><p>부동산 전자계약시스템(IRTS)을 통해 체결된 계약은 종이 인지세의 50%를 감면받습니다. 1억 이하 비과세, 1~10억 7.5만원, 10~30억 17.5만원, 30억 초과 25만원.</p><h3>전자계약 장점</h3><p>인지세 50% 감면, 확정일자 자동 부여, 계약서 위변조 방지, 실거래 신고 자동 처리. 공인중개사 사무소에서 전자계약 시스템을 이용할 수 있습니다.</p><h3>납부 방법</h3><p>전자수입인지 사이트(e-revenuestamp.or.kr)에서 온라인 구매·출력. 매도인·매수인 각 50%씩 부담합니다.</p>`,
datediff:`<h2>날짜 계산기 가이드</h2><h3>날짜 계산 활용</h3><p>부동산 거래에서 보유기간, 거주기간, 신고기한 등을 정확히 계산하는 것이 중요합니다. 취득일~양도일 간 일수로 보유기간을 산정하고, 2년 이상 보유/거주 요건 충족 여부를 확인합니다.</p><h3>주요 기한</h3><p>취득세 신고: 취득일로부터 60일(상속 6개월). 양도세 예정신고: 양도일이 속한 달 말일부터 2개월. 종부세 납부: 매년 12월 1~15일. 재산세: 7월·9월.</p><h3>기간 계산법</h3><p>민법상 기간 계산은 초일 불산입 원칙. 다만 세법에서는 취득일·양도일 기준으로 별도 규정이 있으므로 주의가 필요합니다.</p>`,
*/
...
function CalcCompre({isMo=false,onNav=()=>{}}){
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"3fr 2fr",gap:isMo?16:28,alignItems:"start",minWidth:0}}><div>
    ...
    <RateTable title="종부세율표 (일반·개인)" headers={["과세표준","세율"]} rows={[["3억 이하","0.5%"],["6억 이하","0.7%"],["12억 이하","1.0%"],["25억 이하","1.3%"],["50억 이하","1.5%"],["94억 이하","2.0%"],["94억 초과","2.7%"]]}/>
      ...
      total={total} sub={rateLabel+" ("+calcYear+"년 기준)"} items={rpItems}/><SavingsGuide tips={_tips}/></div></div>);}
...
function CalcProp({isMo=false,onNav=()=>{}}){
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"3fr 2fr",gap:isMo?16:28,alignItems:"start",minWidth:0}}><div><Tog label="부동산 유형" value={pt} onChange={sPt} options={[{value:"house",label:"주택"},{value:"land",label:"토지"},{value:"com",label:"건축물"}]}/><div style={{fontSize:13,color:"#374151",fontWeight:600,marginBottom:4,display:"flex",alignItems:"center",gap:6}}>공시가격 <TipModal title=""><p>매년 1월 1일 기준 공시가격. realtyprice.kr에서 확인. 공정시장가액비율(60%)을 곱한 금액이 과세표준.</p></TipModal></div>{!isMo&&<div style={{marginBottom:10}}><button type="button" onClick={()=>setShowPropLookup(true)} style={{width:"100%",padding:"12px 16px",background:"linear-gradient(135deg,#eff6ff,#dbeafe)",border:"1.5px solid #bfdbfe",borderRadius:10,fontSize:13,fontWeight:700,color:"#1e40af",cursor:"pointer",fontFamily:"inherit",display:"flex",alignItems:"center",justifyContent:"center",gap:8}}>📍 주소로 공시가격 자동조회</button></div>}{showPropLookup&&<AddressModal calcType="holding" onClose={()=>setShowPropLookup(false)} onApplyStd={v=>{sP(String(Math.round(v/10000)));markModified();setAutoPropFill(true);}} onApplyInfo={info=>setSelectedPropInfo(info)}/>}{selectedPropInfo&&!isMo&&<div style={{background:"#eff6ff",border:"1px solid #bfdbfe",borderRadius:10,padding:"10px 14px",marginBottom:8,display:"flex",alignItems:"center",justifyContent:"space-between",gap:8}}>
      ...
      total={total} sub={"공정시장가액비율 "+(fr*100).toFixed(0)+"% 적용"} items={rpItems}/><RateTable title="재산세율표 (주택)" headers={["과세표준","세율"]} rows={[["6천만 이하","0.1%"],["1.5억 이하","0.15%"],["3억 이하","0.25%"],["3억 초과","0.4%"]]}/></div></div>);}
...
function CalcConvert({isMo=false,onNav=()=>{}}){const[type,sType]=useState("m2j");const[deposit,sDep]=useState("");const[monthly,sMon]=useState("");const[rate,sRate]=useState("");const dep=tW(deposit),mon=tW(monthly),rt=pN(rate)/100;let result=0;if(type==="m2j"){result=rt>0?mon*12/rt+dep:0;}else{result=dep>0&&rt>0?(dep*rt)/12:0;}return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"3fr 2fr",gap:isMo?16:32,alignItems:"start",minWidth:0}}><div><Tog label="전환 방향" value={type} onChange={sType} options={[{value:"m2j",label:"월세 → 전세"},{value:"j2m",label:"전세 → 월세"}]}/>{type==="m2j"?<><Inp label="보증금" value={deposit} onChange={sDep} suffix="만원" placeholder="예: 5000"/><Inp label="월세" value={monthly} onChange={sMon} suffix="만원" placeholder="예: 80"/></>:<Inp label="전세보증금" value={deposit} onChange={sDep} suffix="만원" placeholder="예: 30000"/>}<div style={{fontSize:13,color:"#374151",fontWeight:600,marginBottom:4,display:"flex",alignItems:"center",gap:6}}>전환율 <TipModal title=""><p>법정 상한: 기준금리(3%)+2% = 5.0% (2026년). 임대인이 초과 요구 불가.</p></TipModal></div><Inp label="" value={rate} onChange={sRate} suffix="%" note="2025 법정 전환율 상한: 기준금리+2%"/><RateTable title="전월세 전환율 기준" headers={["항목","기준"]} rows={[["법정 전환율 상한","기준금리+2%"],["현행 기준금리","3.0%"],["법정 상한","5.0%"],["시장 평균","약 4~6%"]]}/>
      ...
      total={result} sub={"전환율 "+rate+"% 적용"} items={type==="m2j"?[{l:"기존 보증금",v:fW(dep)},{l:"월세",v:fW(mon),note:"월세×12÷전환율"},{l:"월세 환산 보증금",v:fW(mon*12/(rt||0.01))},{l:"전세 환산 합계",v:fW(result)},{l:"법정 상한 전환율",v:"5.0%",note:"기준금리+2%"}]:[{l:"전세보증금",v:fW(dep)},{l:"환산 월세",v:fW(result)},{l:"연 환산 임대료",v:fW(result*12)},{l:"법정 상한 전환율",v:"5.0%",note:"기준금리+2%"}]}/></div>);}
...
function CalcNetSale({isMo=false,onNav=()=>{}}){
  ...
  return(<>{showLookup&&<AddressModal onClose={()=>setShowLookup(false)} onApplyPrice={v=>{setSellP(String(Math.round(v/10000)));setShowLookup(false);setAutoSaleFill(true);}}/>}<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"3fr 2fr",gap:isMo?16:32,alignItems:"start",minWidth:0}}><div>
    ...
    <RateTable title="양도소득세 간이세율" headers={["보유기간","세율"]} rows={[["1년 미만","70%"],["1~2년","60%"],["2년↑ (기본)","6~45% 누진"],["1주택 장기보유","최대 80% 공제"]]}/>
  </div></div></>);
}
...
function CalcJoint({isMo=false,onNav=()=>{}}){const[p,sP]=useState("");const[isDefault,setIsDefault]=useState(true);const markModified=()=>setIsDefault(false);const[showLookup,setShowLookup]=useState(false);const[autoJointFill,setAutoJointFill]=useState(false);const[r,sR]=useState("50");const pW=tW(p),rv=pN(r)/100;const sB=Math.max(0,(pW-12e8)*0.6);const j1B=Math.max(0,(pW*rv-9e8*rv)*0.6);const j2B=Math.max(0,(pW*(1-rv)-9e8*(1-rv))*0.6);const C2=[[3e8,.005],[6e8,.007],[12e8,.01],[25e8,.013],[50e8,.015],[94e8,.020],[Infinity,.027]];const sT=pTx(sB,C2),jT=pTx(j1B,C2)+pTx(j2B,C2),sv=sT-jT;return(<>{showLookup&&<AddressModal onClose={()=>setShowLookup(false)} onApplyStd={v=>{sP(String(Math.round(v/10000)));setShowLookup(false);setAutoJointFill(true);}}/>}<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"3fr 2fr",gap:isMo?16:32,alignItems:"start",minWidth:0}}><div><div style={{fontSize:12,color:"#6b778c",marginBottom:-8,marginLeft:2,display:"flex",alignItems:"center",gap:4,flexWrap:"nowrap"}}>공동명의 <TipModal title="공동명의 절세"><p>종부세: 단독 12억 vs 공동 각9억(합18억). 양도세: 각 250만 공제. 고령자·장기보유 공제 불가.</p></TipModal></div>{!isMo&&<button onClick={()=>setShowLookup(true)} style={{fontSize:12,color:"#0141f9",background:"none",border:"none",cursor:"pointer",fontWeight:700,fontFamily:"inherit",marginBottom:4,display:"flex",alignItems:"center",gap:4}}><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/></svg>주소로 공시가격 조회</button>}<Inp label="부동산 공시가격" value={p} onChange={v=>{sP(v);setAutoJointFill(false);}} suffix="만원" placeholder="예: 150000" error={!p||p==="0"}/>{autoJointFill&&p&&<div style={{fontSize:11,color:"#4285F4",marginTop:-8,marginBottom:8,fontWeight:500}}>📍 주소조회로 자동입력됨 · 직접 수정 가능</div>}<div style={{marginBottom:16}}><label style={{display:"block",fontSize:12,fontWeight:600,color:P.mt,marginBottom:6}}>{"지분 비율 — 본인 "+r+"% : 배우자 "+(100-parseInt(r))+"%"}</label><input type="range" min="10" max="90" step="10" value={r} onChange={e=>sR(e.target.value)} style={{width:"100%",accentColor:P.pri}}/><div style={{display:"flex",justifyContent:"space-between",fontSize:11,color:P.mt,marginTop:4}}><span>본인 10%</span><span>본인 90%</span></div></div><div style={{padding:"14px 16px",background:P.lt,borderRadius:10,fontSize:13,color:"#4a5568",lineHeight:1.6}}><b>단독명의:</b> 1주택 공제 12억, 고령자·장기보유 공제 가능<br/><b>공동명의:</b> 각 9억 공제 (합 18억), 고령자·장기보유 공제 불가</div><RateTable title="종합부동산세율 (2026)" headers={["과세표준","세율"]} rows={[["3억 이하","0.5%"],["6억 이하","0.7%"],["12억 이하","1.0%"],["25억 이하","1.3%"],["50억 이하","1.5%"],["94억 이하","2.0%"],["94억 초과","2.7%"]]}/>
      ...
      total={Math.abs(sv)} sub={"절세액 기준 비교"} items={[{l:"단독명의 (1주택 12억 공제)",v:fW(sT),note:sv<=0?"✓ 유리":""},{l:"공동명의 본인 ("+r+"%)",v:fW(pTx(j1B,C2))},{l:"공동명의 배우자 ("+(100-parseInt(r))+"%)",v:fW(pTx(j2B,C2))},{l:"공동명의 종부세 합계",v:fW(jT),note:sv>0?"✓ 유리":""},{l:"차이 (절세액)",v:fW(Math.abs(sv))},{l:"본인 지분 금액",v:fW(pW*rv)},{l:"배우자 지분 금액",v:fW(pW*(1-rv))}]}/></div></>);}
...
function CalcLoanMax({isMo=false,onNav=()=>{}}){
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"1fr 1fr",gap:isMo?16:32,alignItems:"start",minWidth:0}}><div>{!isMo&&<h3 style={{fontSize:isMo?16:18,fontWeight:700,color:P.tx,margin:"0 0 20px"}}>대출가능액 계산기</h3>}<Inp label="연 소득" value={inc} onChange={sInc} suffix="만원" placeholder="예: 5000" error={!inc||inc==="0"}/><Inp label="주택가격 (시가)" value={price} onChange={sPrice} suffix="만원" placeholder="예: 90000" note="입력 시 LTV·주담대 한도 적용"/><Tog label="주택 소재지" value={region} onChange={sRegion} options={[{value:"metro",label:"수도권·규제지역"},{value:"non",label:"비수도권"}]}/><Tog label="DSR 기준" value={dsrLim} onChange={sDsrLim} options={[{value:"40",label:"은행 40%"},{value:"50",label:"비은행 50%"}]}/><Tog label="대출 유형 (스트레스)" value={loanType} onChange={sLT} options={[{value:"fixed",label:"고정"},{value:"mixed",label:"혼합(+0.75p)"},{value:"variable",label:"변동(+1.5p)"}]}/><Inp label="대출 금리" value={rt} onChange={sRt} suffix="%" placeholder="예: 3.5" note={stressRate>0?"스트레스 가산 후 "+fP(adjRate*100)+" 적용":"고정금리 가산 없음"}/>{!isMo&&<BaseRateHint/>}<div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12}}><Sel label="대출 기간" value={yr} onChange={sYr} options={[5,10,15,20,25,30,35,40].map(y=>({value:String(y),label:y+"년"}))}/><Sel label="차주 연령대" value={age} onChange={sAge} options={[{value:"20",label:"20대"},{value:"30",label:"30대"},{value:"40",label:"40대"},{value:"50",label:"50대"},{value:"60",label:"60대"}]}/></div><Inp label="기존 대출 월 상환액" value={ep} onChange={sEp} suffix="만원" placeholder="없으면 0"/>{region==="metro"&&pW>0&&<div style={{padding:"12px 16px",background:"#FFF8E1",border:"1px solid #FFE082",borderRadius:10,fontSize:13,color:"#F57F17",marginTop:12,lineHeight:1.6}}>수도권·규제지역 주담대 한도: 15억↓ 6억 / 25억↓ 4억 / 25억↑ 2억 (2025.6.28~ 시행)</div>}</div><div><RP miss={tW(inc)>0?null:MI.loanmax} expertGuide={CALC_NAV_CONTENT.loanmax?.items} expertGuide={CALC_NAV_CONTENT.loanmax?.items} title="최대 대출가능액"
      ...
      total={Math.max(0,maxLoan)} sub={"제한 요인: "+limitReason} items={[{l:"연 소득",v:fW(ai)},{l:"실제 적용 금리",v:fP(adjRate*100),note:stressRate>0?"스트레스 +"+fP(stressRate*100)+"p":"가산 없음"},{l:"적용 대출 기간",v:adjYear+"년",note:parseInt(yr)>maxTerm?"연령 최대 "+maxTerm+"년":""},{l:"DSR 기준 대출가능액",v:fW(Math.max(0,dsrLoan))}].concat(pW>0?[{l:"LTV 70% 기준",v:fW(ltvLoan)}]:[]).concat(region==="metro"&&pW>0?[{l:"수도권 주담대 한도",v:metroCap===Infinity?"제한없음":fW(metroCap)}]:[]).concat([{l:"최대 대출가능액",v:fW(Math.max(0,maxLoan)),note:limitReason+" 적용"},{l:"적용 DSR",v:fP(actualDsr)}])}/><RateTable title="대출 한도 결정 요인" headers={["요인","영향"]} rows={[["LTV","담보가액의 50~70%"],["DSR","연소득 40~50%"],["DTI","연소득 40~60%"],["최종 한도","LTV·DSR·DTI 중 최솟값"]]}/></div></div>);}
...
function CalcHoldTax({isMo=false,onNav=()=>{}}){const[h,sH]=useState("1");const[p,sP]=useState("");const[isDefault,setIsDefault]=useState(true);const markModified=()=>setIsDefault(false);const[showHoldLookup,setShowHoldLookup]=useState(false);const[selectedHoldInfo,setSelectedHoldInfo]=useState(null);const[autoHoldFill,setAutoHoldFill]=useState(false);const pW=tW(p);const n=parseInt(h);const ptBase=pW*0.6;const PTB=[[6e7,.001],[1.5e8,.0015],[3e8,.0025],[Infinity,.004]];const ptTax=pTx(ptBase,PTB);const ptCity=Math.round(ptBase*0.0014);const ptEdu=Math.round(ptTax*0.2);const ptTotal=ptTax+ptCity+ptEdu;const cDed=n===1?12e8:9e8;const cBase=Math.max(0,(pW-cDed)*0.6);const CTB=[[3e8,.005],[6e8,.007],[12e8,.01],[25e8,.013],[50e8,.015],[94e8,.020],[Infinity,.027]];const cTax=pTx(cBase,CTB);const cFarm=Math.round(cTax*0.2);const cTotal=cTax+cFarm;const grand=ptTotal+cTotal;return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"3fr 2fr",gap:isMo?16:28,alignItems:"start",minWidth:0}}><div><Radio label="주택 수" value={h} onChange={sH} options={[{value:"1",label:"1주택"},{value:"2",label:"2주택"},{value:"3",label:"3주택 이상"}]}/><div style={{fontSize:13,color:"#374151",fontWeight:600,marginBottom:4,display:"flex",alignItems:"center",gap:6}}>공시가격 <TipModal title=""><p>매년 6.1 기준. realtyprice.kr에서 확인. 재산세: 공시가×60%</p></TipModal></div>{!isMo&&<div style={{marginBottom:10}}><button type="button" onClick={()=>setShowHoldLookup(true)} style={{width:"100%",padding:"12px 16px",background:"linear-gradient(135deg,#eff6ff,#dbeafe)",border:"1.5px solid #bfdbfe",borderRadius:10,fontSize:13,fontWeight:700,color:"#1e40af",cursor:"pointer",fontFamily:"inherit",display:"flex",alignItems:"center",justifyContent:"center",gap:8}}>📍 주소로 공시가격 자동조회</button></div>}{showHoldLookup&&<AddressModal calcType="holding" onClose={()=>setShowHoldLookup(false)} onApplyStd={v=>{sP(String(Math.round(v/10000)));markModified();setAutoHoldFill(true);}} onApplyInfo={info=>setSelectedHoldInfo(info)}/>}{selectedHoldInfo&&!isMo&&<div style={{background:"#eff6ff",border:"1px solid #bfdbfe",borderRadius:10,padding:"10px 14px",marginBottom:8,display:"flex",alignItems:"center",justifyContent:"space-between",gap:8}}>
      ...
      total={grand} sub={"공시가 "+fW(pW)+" 기준 / 재산세+종부세"} items={[{l:"▼ 재산세 (7·9월 납부)",v:fW(ptTotal),note:"지방세"},{l:"  과세표준 (공정가 60%)",v:fW(ptBase)},{l:"  재산세 본세",v:fW(ptTax)},{l:"  도시지역분 (0.14%)",v:fW(ptCity)},{l:"  지방교육세 (20%)",v:fW(ptEdu)},{l:"▼ 종합부동산세 (12월 납부)",v:fW(cTotal),note:"국세"},{l:"  공제금액",v:fW(cDed)},{l:"  과세표준 (공정가 60%)",v:fW(cBase)},{l:"  종부세",v:fW(cTax)},{l:"  농어촌특별세 (20%)",v:fW(cFarm)},{l:"연간 보유세 총합",v:fW(grand),note:"재산세+종부세"}]}/><RateTable title="보유세 구성" headers={["세목","기준","세율"]} rows={[["재산세","공시가×60%(공정가)","0.1~0.4%"],["종부세","9억(1주택12억) 초과분","0.5~2.7%"],["농특세","종부세의 20%","-"],["지방교육세","재산세의 20%","-"]]}/></div></div>);}
...
function CalcStamp({isMo=false,onNav=()=>{}}){
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"1fr 1fr",gap:isMo?16:32,alignItems:"start",minWidth:0}}><div>{!isMo&&<h3 style={{fontSize:isMo?16:18,fontWeight:700,color:P.tx,margin:"0 0 20px"}}>인지세 계산기</h3>}<div style={{fontSize:12,color:"#6b778c",marginBottom:-8,marginLeft:2,display:"flex",alignItems:"center",gap:4,flexWrap:"nowrap"}}>인지세 <TipModal title="인지세"><p>매매계약서 작성 시 부과. 매도·매수인 각 50% 부담. 1억↓ 비과세.</p></TipModal></div><Inp label="거래금액" value={p} onChange={sP} suffix="만원" placeholder="예: 90000" error={!p||p==="0"}/><label style={{display:"flex",alignItems:"center",gap:6,fontSize:13,cursor:"pointer",marginTop:8}}><input type="checkbox" checked={electronic} onChange={e=>setElectronic(e.target.checked)}/> 전자문서 인지세 (70% 할인)</label><div style={{padding:"14px 16px",background:P.lt,borderRadius:10,fontSize:13,color:"#4a5568",lineHeight:1.6,marginTop:8}}>• 1억 이하: 비과세<br/>• 1억~10억: 15만원<br/>• 10억~30억: 35만원<br/>• 30억 초과: 50만원<br/>※ 전자계약 시 70% 할인</div></div><RP miss={tW(p)>0?null:MI.stamp} expertGuide={CALC_NAV_CONTENT.stamp?.items} expertGuide={CALC_NAV_CONTENT.stamp?.items} title="인지세"
      ...
      total={stamp} sub={stamp===0?"비과세 구간":"매도·매수인 각 50% 부담"} items={[{l:"거래금액",v:fW(pW)},{l:"기본 인지세액",v:fW(baseStamp)}].concat(electronic?[{l:"전자문서 할인 (70%)",v:"-"+fW(baseStamp-stamp)}]:[]).concat([{l:"납부 인지세",v:fW(stamp)},{l:"매도인 부담",v:fW(half)},{l:"매수인 부담",v:fW(half)}])}/></div>);}
...
function CalcAppraisal({isMo=false,onNav=()=>{}}){
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"1fr 1fr",gap:isMo?16:32,alignItems:"start",minWidth:0}}><div>{!isMo&&<h3 style={{fontSize:isMo?16:18,fontWeight:700,color:P.tx,margin:"0 0 20px"}}>감정평가 수수료</h3>}<Inp label="감정가액" value={p} onChange={sP} suffix="만원" placeholder="예: 90000"/><Tog label="부가세 처리" value={vatType} onChange={setVatType} options={[{value:"include",label:"VAT 포함"},{value:"exclude",label:"VAT 별도"}]}/><div style={{padding:"14px 16px",background:P.lt,borderRadius:10,fontSize:12,color:"#4a5568",lineHeight:1.8,marginTop:8}}>• 5천만 이하: 기본 20만원<br/>• 5천만~2억: 20만 + 초과분×0.09%<br/>• 2~5억: 15.5만 + 초과분×0.08%<br/>• 5~10억: 39.5만 + 초과분×0.06%<br/>• 10~50억: 69.5만 + 초과분×0.04%</div><RateTable title="감정평가 수수료 기준" headers={["감정가액","수수료"]} rows={[["5천만 이하","20만원"],["5천~2억","20만+초과×0.09%"],["2~5억","15.5만+초과×0.08%"],["5~10억","39.5만+초과×0.06%"],["10~50억","69.5만+초과×0.04%"],["50억 초과","229.5만+초과×0.02%"]]}/>
    </div><RP miss={tW(p)>0?null:MI.appraisal} expertGuide={CALC_NAV_CONTENT.appraisal?.items} expertGuide={CALC_NAV_CONTENT.appraisal?.items} title="감정평가 수수료"
...
function CalcBldValue({isMo=false,onNav=()=>{}}){const[np,sNp]=useState("");const[ul,sUl]=useState("40");const[el,sEl]=useState("");const[mt,sMt]=useState("line");const npW=tW(np),ulV=parseInt(ul),elV=parseInt(el||"0");let remaining=0,depreciation=0;if(npW>0&&ulV>0){if(mt==="line"){const ratio=Math.max(0,Math.min(1,1-elV/ulV));remaining=Math.round(npW*ratio);depreciation=npW-remaining;}else{remaining=Math.round(npW*Math.pow(0.9,elV));depreciation=npW-remaining;}}const pct=npW>0?remaining/npW*100:0;return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"3fr 2fr",gap:isMo?16:32,alignItems:"start",minWidth:0}}><div><Inp label="신축 가격 (재조달원가)" value={np} onChange={sNp} suffix="만원" placeholder="예: 50000"/><Sel label="내용연수" value={ul} onChange={sUl} options={[{value:"20",label:"20년 (경량철골)"},{value:"30",label:"30년 (조적·블록)"},{value:"40",label:"40년 (철근콘크리트)"},{value:"50",label:"50년 (SRC)"}]}/><Inp label="경과연수" value={el} onChange={sEl} placeholder="예: 15"/><Tog label="감가 방법" value={mt} onChange={sMt} options={[{value:"line",label:"정액법"},{value:"declining",label:"정률법 (10%)"}]}/></div><RP miss={(npW>0&&el)?null:MI.bldvalue} expertGuide={CALC_NAV_CONTENT.bldvalue?.items} expertGuide={CALC_NAV_CONTENT.bldvalue?.items} title="건물 잔존가치"
      ...
      total={remaining} sub={"잔존률 "+fP(pct)} items={[{l:"신축 가격",v:fW(npW)},{l:"내용연수",v:ulV+"년"},{l:"경과연수",v:elV+"년"},{l:"감가방법",v:mt==="line"?"정액법":"정률법 (10%)"},{l:"정액법 기준 잔존률",v:fP(Math.max(0,Math.min(1,1-elV/ulV))*100)},{l:"정률법 기준 잔존률",v:fP(Math.pow(0.9,elV)*100)},{l:"감가상각 누계",v:fW(depreciation)},{l:"잔존가치",v:fW(remaining)},{l:"잔존률",v:fP(pct)}]}/><RateTable title="건물 내용연수 (세법 기준)" headers={["구조","내용연수","감가율"]} rows={[["철근콘크리트","40년","2.5%/년"],["철골조","30년","3.3%/년"],["벽돌조","30년","3.3%/년"],["목조","20년","5.0%/년"],["경량철골","20년","5.0%/년"]]}/></div>);}
...
function CalcNetSalary({isMo=false,onNav=()=>{}}){const[salary,sSal]=useState("");const[family,sFamily]=useState("1");const[child,sChild]=useState("0");const[nonTax,sNT]=useState("");
  ...
  </div><SavingsGuide tips={_tips}/><RateTable title="4대보험 요율 (2025)" headers={["보험","근로자"]} rows={[["국민연금","4.75%"],["건강보험","3.595%"],["장기요양","건보의 12.95%"],["고용보험","0.9%"],["합계(근로자)","약 9.7%"]]}/></div></div>);}
...
function CalcRetire({isMo=false,onNav=()=>{}}){const[monthly,sM]=useState("");const[years,sY]=useState("");const[months,sMo]=useState("0");
  ...
  <RateTable title="퇴직소득 공제액" headers={["근속연수","공제액"]} rows={[["5년 이하","30만×근속"],["10년 이하","150만+50만×(근속-5)"],["20년 이하","400만+80만×(근속-10)"],["20년 초과","1,200만+120만×(근속-20)"]]}/>
...
function CalcUnemploy({isMo=false,onNav=()=>{}}){const[age,sAge]=useState("30");const[years,sY]=useState("3");const[daily,sD]=useState("");
  ...
  <RateTable title="실업급여 수급기간" headers={["피보험기간","50세 미만","50세↑·장애"]} rows={[["1년 미만","120일","120일"],["1~3년","150일","180일"],["3~5년","180일","210일"],["5~10년","210일","240일"],["10년↑","240일","270일"]]}/>
...
function CalcCarTax({isMo=false,onNav=()=>{}}){const[carType,sCT]=useState("normal");const[cc,sCC]=useState("");const[year,sYear]=useState("0");const[isElec,sElec]=useState("no");
  ...
  <RateTable title="자동차세율표 (2026)" headers={["배기량","cc당 세액"]} rows={[["1,000cc 이하","80원"],["1,000~1,600cc","140원"],["1,600cc 초과","200원"],["전기차","10만원 (정액)"],["3년↑ 경감","매년 5% (최대 50%)"]]}/>
...
const RELATED={
  ...
  cartax:["netsalary","insurance4"],
  insurance4:["netsalary","yearend"],
  pension:["insurance4","netsalary","retire"],
  appraisal:["commission","registration"],
  auction:["ltv","registration","auction2","auctiondiv"],
  remodel:["far","remodel2","reconyear"],
  bldvalue:["far","remodel","reconyear"],
  retire:["netsalary","unemploy","pension"],
  unemploy:["retire","netsalary","minwage"],
  minwage:["netsalary","insurance4"],
  area:["far","acquisition"],
  auction2:["auction","auctiondiv","auctionloan"],
  auctiondiv:["auction","auction2","auctionloan"],
  auctionloan:["auction","dsr","ltv"],
  bldvat:["acquisition","registration","totalcost"],
  bond2:["bond","registration","legal"],
  datediff:["transfer","acquisition"],
  estincome:["rental","imputedrent","inctax"],
  goodlord:["rental","estincome","inctax"],
  imputedrent:["rental","estincome","goodlord"],
  jeonseins:["convert","yield"],
  legalinherit:["inherit","gift"],
  luckyday:["datediff","acquisition"],
  progressive:["inctax","gift","inherit","transfer"],
  reconyear:["remodel","remodel2","far"],
  refinance:["mortgage","dsr","ltv"],
  remodel2:["remodel","reconyear","far"],
  rentincrease:["convert","yield","rental"],
  realprice:["transfer","acquisition","netsale"],
  netsale:["transfer","commission","compare"],
  stamp2:["stamp","registration","legal"],
  subscription:["ltv","loanmax","acquisition"],
  compre:["property","holdtax","joint"],
  property:["compre","holdtax","acquisition"],
};
...
const CALC_NAV_CONTENT={
  ...
  netsalary:{items:[{title:"실수령액이란?",open:true,body:"연봉에서 4대보험료와 소득세·지방소득세를 공제한 후 실제 수령하는 금액."},{title:"4대보험 공제",body:"국민연금 4.5%, 건강보험 3.545%(장기요양 12.95%), 고용보험 0.9%."},{title:"소득세 계산",body:"근로소득간이세액표 기준 원천징수. 부양가족 수에 따라 차등."},{title:"비과세 항목",body:"식대 20만원, 차량유지비 20만원 등 비과세 항목은 공제 전 차감."},{title:"연봉협상 팁",body:"실수령액 기준으로 비교해야 정확. 퇴직금 별도/포함 여부 확인 필수."}],related:["insurance4","yearend","inctax","retire"]},
  insurance4:{items:[{title:"4대보험이란?",open:true,body:"국민연금·건강보험·고용보험·산재보험. 근로자와 사업주가 분담."},{title:"2026년 요율",body:"국민연금 9%(근로자4.5%), 건강보험 7.09%(근로자3.545%), 장기요양 12.95%, 고용보험 1.8%(근로자0.9%)."},{title:"산재보험",body:"전액 사업주 부담. 업종별 0.6~18.6% 차등."},{title:"정산",body:"건강보험은 다음해 4월 정산. 국민연금은 매년 7월 기준소득월액 변경."},{title:"프리랜서",body:"지역가입자로 전환. 국민연금·건강보험 전액 본인 부담."}],related:["netsalary","yearend","pension"]},
  pension:{items:[{title:"국민연금이란?",open:true,body:"18~59세 의무 가입. 최소 10년 납입 시 만 65세부터 평생 수령."},{title:"수령액 산정",body:"평균소득월액×소득대체율(40%)×가입기간 보정. A값(전체가입자평균)과 B값(본인소득) 합산."},{title:"조기수령",body:"60세부터 가능. 연 6%씩 감액. 60세 수령 시 정상 대비 30% 감소."},{title:"연기수령",body:"66~70세로 연기 시 연 7.2%씩 가산. 70세 수령 시 36% 증가."},{title:"추납제도",body:"미납기간에 대해 추후 납부 가능. 수령액 증가에 효과적."}],related:["retire","netsalary","insurance4"]},
  dsr:{items:[{title:"DSR이란?",open:true,body:"총부채원리금상환비율. 연소득 대비 모든 대출 원리금 비율. 40%/50% 규제."},{title:"스트레스DSR",body:"변동 +1.5%p, 혼합 +0.75%p 가산. 2024.9 시행."},{title:"은행vs비은행",body:"은행 40%, 비은행 50%. 초과 시 대출 불가."},{title:"DSR낮추는법",body:"대출기간 연장·소득증빙 강화·기존대출 상환."}],law:{text:"금융위원회 고시 제2023-14호",url:"/law/loan-regulation"},related:["dti","ltv","mortgage","loanmax"]},
  dti:{items:[{title:"DTI란?",open:true,body:"총부채상환비율. 연소득 대비 신규 주담대 원리금+기존 대출 이자 비율."},{title:"지역별 한도",body:"투기과열지구 40%, 조정대상지역 50%, 비규제지역 60%."},{title:"DSR과 차이",body:"DTI는 기존대출 '이자만' 반영. DSR은 원리금 전부 반영. DSR이 더 엄격."},{title:"적용 예외",body:"서민·실수요자 우대, 생애최초 주택 구입 등 예외 존재."}],related:["dsr","ltv","loanmax","mortgage"]},
  rti:{items:[{title:"RTI란?",open:true,body:"Rent To Interest, 연간 임대수입÷연간 대출이자. 임대업 대출 심사 핵심 지표."},{title:"기준 비율",body:"은행 1.5배 이상, 비은행 1.25배 이상 충족해야 대출 가능."},{title:"활용",body:"상가·오피스텔 투자 시 대출 가능 여부를 사전 확인."},{title:"개선 방법",body:"임대료 인상, 공실 해소, 대출 일부 상환으로 RTI 개선."}],related:["yield","mortgage","loanmax","dsr"]},
  area:{items:[{title:"평수 변환",open:true,body:"1평 = 3.305785㎡. 전용면적·공급면적·계약면적 구분 필수."},{title:"주요 평형",body:"전용59㎡≈18평(24평형), 전용84㎡≈25평(34평형), 전용114㎡≈34평(44평형)."},{title:"전용률",body:"아파트 75~85%, 오피스텔 50~65%. 전용면적÷공급면적×100."},{title:"면적 기준",body:"취득세·양도세 감면은 전용면적 85㎡ 기준. 수도권 제외 읍면 100㎡."}],related:["acquisition","far","auction"]},
  far:{items:[{title:"용적률이란?",open:true,body:"대지면적 대비 연면적(지상 전체 층 합계) 비율. 건축 밀도 지표."},{title:"건폐율이란?",body:"대지면적 대비 건축면적(1층 바닥) 비율. 지역·용도별 상한 규제."},{title:"용도지역별 한도",body:"제1종 전용주거 100%, 제2종 일반주거 250%, 일반상업 1300%."},{title:"활용",body:"재건축·신축 시 최대 건축 가능 면적 산출에 필수."},{title:"지하면적",body:"용적률 산정 시 지하층 면적은 제외(건축법 시행령 §119)."}],related:["remodel","reconyear","remodel2"]},
  subscription:{items:[{title:"청약가점제란?",open:true,body:"무주택기간(32점)+부양가족(35점)+청약통장기간(17점)=84점 만점."},{title:"무주택기간",body:"30세 이상부터 산정. 만30세 미만 배우자 무주택기간 인정."},{title:"부양가족",body:"배우자·직계존속(3년동거)·직계비속. 만19세 미만 자녀, 60세 이상 부모."},{title:"청약통장",body:"주택청약종합저축 가입일 기준. 15년 이상 17점 만점."},{title:"당첨전략",body:"서울 주요단지 평균 60점 이상. 배우자 통장 활용, 부양가족 등록 확인."}],related:["acquisition","ltv","loanmax"]},
  auction2:{items:[{title:"적정입찰가란?",open:true,body:"감정가·지역별 낙찰가율·물건 상태를 종합하여 산출한 합리적 입찰가."},{title:"낙찰가율",body:"서울 아파트 87~92%, 지방 단독 60~75%, 상가 50~70%."},{title:"유찰 효과",body:"유찰 시 최저가 20~30% 하락. 2회 유찰 후 입찰이 유리한 경우 다수."},{title:"전략",body:"권리분석 → 현장조사 → 시세파악 → 수익률역산 → 입찰가 결정."},{title:"비용 고려",body:"낙찰가의 110~120% 준비. 취득세·명도비·인테리어비 포함."}],related:["auction","auctiondiv","auctionloan"]},
  auctiondiv:{items:[{title:"배당분석이란?",open:true,body:"경매 낙찰대금을 채권자에게 우선순위별로 배분하는 절차 분석."},{title:"배당 순서",body:"집행비용 → 최우선변제 소액임차인 → 확정일자 임차인·근저당(설정일순) → 임금 → 조세."},{title:"소액임차인",body:"서울 5,500만원, 수도권 4,800만원 최우선변제(2026 기준)."},{title:"배당요구",body:"배당요구 종기까지 신청해야 배당 참여 가능. 미신청 시 권리 소멸."},{title:"말소기준권리",body:"매각 시 소멸되는 권리 판단. 최선순위 근저당·압류·가압류 기준."}],related:["auction","auction2","auctionloan"]},
  auctionloan:{items:[{title:"경락잔금대출이란?",open:true,body:"경매 낙찰 부동산 잔금을 금융기관에서 대출받는 것."},{title:"LTV 기준",body:"비규제 80%, 조정 70%, 투기과열 60%. 선순위 근저당 차감(방공제)."},{title:"대출 기한",body:"잔금 납부기한(보통 1개월) 내 실행 완료 필요."},{title:"추가 비용",body:"취득세, 등기비용, 명도비, 인테리어비, 미납관리비 등 별도 자금 필요."},{title:"심사 기준",body:"DSR 규제 동일 적용. 소득증빙·신용등급 심사."}],related:["auction","auction2","ltv","dsr"]},
  bldvat:{items:[{title:"건물분 부가세란?",open:true,body:"부동산 매매 시 건물 부분에 대한 부가가치세 10%."},{title:"면세 대상",body:"전용 85㎡ 이하 주택 면세. 토지 자체도 면세."},{title:"계산 방법",body:"건물분 VAT = (매매가-토지가)÷1.1×0.1. 토지비율은 공시지가 기준."},{title:"세금계산서",body:"매도인이 일반과세자면 세금계산서 발급. 매입세액공제 가능."},{title:"주의사항",body:"간이과세자 거래 시 세금계산서 발급 불가. 매수인 부담 확인."}],related:["acquisition","registration","totalcost"]},
  bond2:{items:[{title:"국민주택채권이란?",open:true,body:"주택도시기금법에 따라 등기 시 의무 매입하는 채권."},{title:"매입률",body:"서울 6억↑ 5%, 1.6~6억 4%, 1.6억↓ 3%. 지방은 낮음."},{title:"할인비용",body:"즉시 매도 시 4~5% 할인 손실. 실제 비용 = 공시가격×매입률×할인율."},{title:"절약 방법",body:"전자등기 시 매입 면제 가능. 세종·제주 등 특례지역 확인."}],related:["bond","registration","legal"]},
  datediff:{items:[{title:"날짜 계산 활용",open:true,body:"보유기간·거주기간·신고기한 등 일수 계산. 세금 요건 확인 필수."},{title:"보유기간",body:"취득일~양도일. 2년 이상 보유 시 장기보유특별공제 적용."},{title:"주요 기한",body:"취득세 60일, 양도세 2개월, 상속세 6개월, 종부세 12월."},{title:"기간 계산법",body:"민법 초일 불산입 원칙. 세법은 별도 규정 있으므로 주의."}],related:["transfer","acquisition","inherit"]},
  estincome:{items:[{title:"임대 추정소득이란?",open:true,body:"월세 수입+간주임대료를 합산하여 과세 소득금액 추정."},{title:"필요경비율",body:"주택임대 단순경비율 약 42.6~56%. 실제 장부 경비 공제 가능."},{title:"분리과세",body:"2천만원 이하 수입은 분리과세(14%) 선택 가능."},{title:"간주임대료",body:"3주택 이상, 보증금 3억 초과 시 과세. (보증금-3억)×60%×이자율."}],related:["rental","imputedrent","goodlord","inctax"]},
  goodlord:{items:[{title:"착한임대인 공제란?",open:true,body:"상가 임대료 인하액의 최대 70%를 소득세에서 세액공제."},{title:"공제율",body:"소득 1억↓: 70%, 1억↑: 50%. 10% 이상 인하 시 적용."},{title:"적용 요건",body:"임차인이 소상공인, 특수관계 아닌 경우."},{title:"신청 방법",body:"종합소득세 확정신고 시 세액공제 신청서+계약서 첨부."},{title:"기간",body:"2025년 12월 31일까지 한시 적용(연장 가능성 있음)."}],related:["rental","estincome","inctax"]},
  imputedrent:{items:[{title:"간주임대료란?",open:true,body:"3주택 이상 보유 + 보증금 합계 3억 초과 시 과세."},{title:"계산 공식",body:"(보증금-3억)×60%×정기예금이자율(약3.5%). 금융소득 차감."},{title:"과세 제외",body:"2주택↓, 보증금 3억↓, 소형주택(전용40㎡+기준시가2억↓) 제외."},{title:"신고",body:"종합소득세 신고 시 부동산임대소득으로 합산."},{title:"절세",body:"소형주택 활용, 보증금 3억 이내 관리, 분리과세 선택."}],related:["rental","estincome","goodlord"]},
  jeonseins:{items:[{title:"전세보증보험이란?",open:true,body:"임대인 보증금 미반환 시 보증기관(HUG/HF)이 대신 반환."},{title:"보증료율",body:"HUG 연 0.115~0.154%, HF 연 0.02~0.04%. 아파트는 HF가 저렴."},{title:"가입 요건",body:"전세가율 일정 이하, 확정일자, 전입신고 완료."},{title:"보증기관",body:"HUG(주택도시보증공사), HF(한국주택금융공사), SGI(서울보증보험)."},{title:"활용 팁",body:"전세대출 시 보증보험 필수. 갱신 시 보증료 추가 납부."}],related:["convert","yield","datediff"]},
  legalinherit:{items:[{title:"법정상속분이란?",open:true,body:"민법 제1009조. 유언 없는 경우 법정 비율로 상속재산 배분."},{title:"배우자",body:"직계비속/존속과 공동상속 시 1.5배 가산. 단독 상속 가능."},{title:"상속 순위",body:"1순위 자녀+배우자, 2순위 부모+배우자, 3순위 형제자매."},{title:"유류분",body:"배우자·직계비속 1/2, 직계존속·형제자매 1/3. 침해 시 반환청구."},{title:"협의분할",body:"상속인 전원 합의 시 법정상속분과 다르게 분할 가능."}],related:["inherit","gift","compare"]},
  progressive:{items:[{title:"누진세란?",open:true,body:"과세표준이 커질수록 높은 세율 적용. 종소세·양도세·증여세·상속세."},{title:"한계세율",body:"마지막 구간 세율. 종소세 최고 45%, 증여세·상속세 최고 50%."},{title:"실효세율",body:"전체 세액÷과세표준. 한계세율보다 항상 낮음."},{title:"활용",body:"세목 선택+과세표준 입력 → 구간별 세액·한계세율·실효세율 확인."}],related:["inctax","transfer","gift","inherit"]},
  reconyear:{items:[{title:"재건축 연한이란?",open:true,body:"준공 후 일정 연수 경과 시 안전진단 신청 가능. 서울 30년."},{title:"지역별 기준",body:"서울 30년, 광역시 25~30년, 기타 20~30년."},{title:"안전진단",body:"예비안전진단(지자체) → 정밀안전진단(시설안전공단). D등급 이하 시 추진."},{title:"투자 고려",body:"연한 도래 시점, 안전등급, 사업성(용적률 상향), 조합 추진 상황."},{title:"주의사항",body:"안전진단 통과 후에도 사업 착수까지 5~10년 이상 소요."}],related:["remodel","remodel2","far","auction"]},
  refinance:{items:[{title:"대환대출이란?",open:true,body:"기존 대출을 더 유리한 조건으로 갈아타는 것."},{title:"중도상환수수료",body:"3년 이내 상환 시 잔액의 1~1.5%. 대환 절감액과 비교 필수."},{title:"손익분기점",body:"대환 수수료÷월이자절감액=손익분기 개월수. 남은 기간이 길면 유리."},{title:"금리 비교",body:"0.5%p 이상 차이 시 검토 권장. 고정→변동 전환 시 리스크 주의."},{title:"절차",body:"신규 대출 실행 → 기존 대출 상환. 동시 진행 가능한 은행 활용."}],related:["mortgage","dsr","ltv"]},
  remodel2:{items:[{title:"리모델링 ROI란?",open:true,body:"예상매도가-현시세-총비용 기준 투자수익률."},{title:"비용 항목",body:"분담금, 공사기간 대출이자, 임시거주비, 이사비, 양도세 추정."},{title:"의사결정",body:"ROI 20%↑ 투자가치, 10~20% 보수적, 10%↓ 대안 비교."},{title:"기회비용",body:"공사기간(2~3년) 임대수입 손실, 대출이자 부담 고려."},{title:"비교 분석",body:"리모델링 vs 매도후 신축매수 vs 현상유지 비교."}],related:["remodel","far","reconyear"]},
  rentincrease:{items:[{title:"5% 상한제란?",open:true,body:"계약갱신청구권 행사 시 임대료 인상폭 5% 제한."},{title:"전월세 전환",body:"보증금↔월세 전환 시에도 5% 상한+법정전환율(기준금리+2%) 제한."},{title:"적용 범위",body:"갱신청구권 1회 한정. 갱신 계약 존속기간 2년."},{title:"거절 사유",body:"임대인 실거주, 재건축, 2기 연속 차임 연체 등 법정 사유."},{title:"분쟁 해결",body:"주택임대차분쟁조정위원회 신청. 확정일자 증빙 필수."}],related:["convert","yield","jeonseins"]},
  realprice:{items:[{title:"실거래가 조회란?",open:true,body:"국토부 실거래가 공개시스템에서 전국 매매·전세·월세 내역 조회."},{title:"조회 방법",body:"주소(법정동)+거래유형+기간 입력. 계약일·금액·면적·층 확인."},{title:"활용",body:"취득세·양도세 계산 시 실거래가 기준 정확한 세액 산출."},{title:"출처",body:"국토교통부 실거래가 공개시스템, 네이버 부동산, 호갱노노 등."},{title:"주의사항",body:"실거래 신고 후 30일 이내 공개. 최신 거래는 미반영 가능."}],related:["transfer","acquisition","netsale"]},
  netsale:{items:[{title:"매도 실수령액이란?",open:true,body:"매도가에서 양도세·중개수수료·기타비용 차감 후 실수령액."},{title:"차감 항목",body:"양도소득세, 지방소득세(양도세10%), 중개수수료(0.4~0.9%), 말소등기."},{title:"비과세 요건",body:"1세대1주택 2년보유(조정지역 2년거주)+12억이하 → 양도세 면제."},{title:"계산 순서",body:"매도가→양도차익→장특공제→기본공제250만→세율→세액→실수령액."},{title:"절세",body:"장기보유특별공제 극대화. 필요경비(인테리어비 등) 영수증 보관."}],related:["transfer","compare","commission","totalcost"]},
  stamp2:{items:[{title:"전자계약 인지세란?",open:true,body:"전자계약시스템(IRTS) 체결 시 인지세 50% 감면."},{title:"감면 세율",body:"1억↓ 비과세, 1~10억 7.5만원, 10~30억 17.5만원, 30억↑ 25만원."},{title:"전자계약 장점",body:"인지세감면, 확정일자자동부여, 위변조방지, 실거래신고 자동."},{title:"이용 방법",body:"공인중개사 사무소 전자계약시스템. 부동산거래전자계약시스템."},{title:"납부",body:"e-revenuestamp.or.kr에서 온라인 구매·출력. 매도·매수 각 50%."}],related:["stamp","registration","legal"]},
  luckyday:{items:[{title:"손없는날이란?",open:true,body:"음력 9·10·19·20·29·30일. 손(귀신)이 없어 이사·개업에 좋은 날."},{title:"음양력 변환",body:"음력 기준이므로 양력 확인 필요. 본 계산기에서 자동 표시."},{title:"이사 날짜",body:"손없는날에 이사업체 예약 집중. 비용 절감 시 다른 날 선택."},{title:"참고",body:"과학적 근거는 없으나 전통적으로 참고하는 풍습."}],related:["datediff","acquisition"]},
  compare:{items:[{title:"세금비교란?",open:true,body:"매매·증여·상속 시 세금 총액을 비교하여 최적 이전 방법 결정."},{title:"비교 항목",body:"매매: 양도세+취득세. 증여: 증여세+취득세. 상속: 상속세+취득세."},{title:"10년 합산",body:"증여는 10년 내 합산 과세. 장기 분할 증여가 절세 핵심."},{title:"배우자 활용",body:"배우자 6억 증여공제 → 매도 시 취득가액 높여 양도세 절감."},{title:"전문가 상담",body:"가액·보유기간·세대구성에 따라 결과 상이. 세무사 상담 권장."}],related:["transfer","gift","inherit","totalcost"]},
  invest:{items:[{title:"투자수익분석이란?",open:true,body:"매수→보유→매도 전체 현금흐름의 연평균 수익률(IRR) 분석."},{title:"포함 비용",body:"취득세·보유세·대출이자·관리비·매도중개보수·양도세 전부 반영."},{title:"레버리지",body:"대출 비중↑ → 자기자본 수익률↑ + 위험↑. 적정 LTV 유지."},{title:"세후 수익",body:"세전 수익률이 아닌 세후 실질 수익률로 판단해야 정확."},{title:"비교 분석",body:"부동산 vs 주식 vs 예금 수익률 비교. 인플레이션 감안."}],related:["yield","transfer","totalcost","compare"]},
  totalcost:{items:[{title:"총비용이란?",open:true,body:"매수가 외에 발생하는 모든 부대비용 합산 시뮬레이션."},{title:"포함 항목",body:"취득세+등기비용+법무사수수료+중개보수+인지세+채권할인료."},{title:"비율 참고",body:"일반적으로 매수가의 3~5% 추가 발생. 9억 기준 약 3,700~4,500만원."},{title:"대출 포함",body:"자기자본+대출금 계획 수립 시 부대비용 반드시 포함."},{title:"활용",body:"매수 전 총 필요자금 확인. 예산 초과 방지."}],related:["acquisition","registration","commission","bond","legal"]},
...
export default function App(){
  ...
  useEffect(()=>{
    ...
    // admin/callback 제거 — 홈 소셜 로그인으로 통합됨

...
function CalcCompre({isMo=false,onNav=()=>{}}){const[taxpayer,sTP]=useState("indi");const[h,sH]=useState("1");const[p,sP]=useState("");const[age,sAge]=useState("0");const[hold,sHold]=useState("0");const[prevTax,sPrev]=useState("");
...
function CalcMort({isMo=false,onNav=()=>{}}){const[pr,sPr]=useState("");const[rt,sRt]=useState("");const[yr,sYr]=useState("30");const[gr,sGr]=useState("0");const[mt,sMt]=useState("equal");const[ppFee,sPP]=useState("");const[ppYear,sPY]=useState("0");

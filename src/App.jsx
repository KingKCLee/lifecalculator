...
/* ── 2026.04.15 상단 탭·서브탭·정보센터 SVG 아이콘 맵 ── */
const IC=(ch)=>(<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={{flexShrink:0}}>{ch}</svg>);
const TAB_ICONS={
  tax:IC(<><rect x="5" y="3" width="14" height="18" rx="1"/><path d="M9 8h6M9 12h6"/><circle cx="12" cy="16" r="2"/><path d="M12 14.5v3M11 16h2"/></>),
  loan:IC(<><path d="M3 10l9-6 9 6"/><path d="M4 10h16v11H4z"/><path d="M7 14v4M12 14v4M17 14v4"/></>),
  cost:IC(<><rect x="5" y="3" width="14" height="18" rx="2"/><rect x="8" y="6" width="8" height="3"/><path d="M8 13h.01M12 13h.01M16 13h.01M8 17h.01M12 17h.01M16 17h.01"/></>),
  life:IC(<><circle cx="12" cy="8" r="4"/><path d="M4 21c0-4 4-7 8-7s8 3 8 7"/></>),
  realestate:IC(<><path d="M3 11l9-8 9 8"/><path d="M5 10v10h14V10"/><path d="M10 20v-5h4v5"/></>),
  pro:IC(<><path d="M3 20h18"/><path d="M6 16V8"/><path d="M12 16V4"/><path d="M18 16v-6"/></>),
  info:IC(<><rect x="3" y="5" width="18" height="14" rx="1"/><path d="M3 9h18"/><path d="M7 13h6M7 16h4"/></>),
};
const CALC_ICONS={
...
return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"1fr 1fr",gap:isMo?16:32,alignItems:"start",minWidth:0}}><div>{!isMo&&<h3 style={{fontSize:isMo?16:18,fontWeight:700,color:P.tx,margin:"0 0 20px"}}>증여세 계산기</h3>}
    ...
    <div style={{fontSize:12,color:"#6b778c",marginBottom:-8,marginLeft:2,display:"flex",alignItems:"center",gap:4,flexWrap:"nowrap"}}>세대생략 <TipModal title="세대생략 증여"><p>조부모→손자녀 증여 시 산출세액의 30% 할증(미성년 40%). 세대를 건너뛰는 증여에 적용됩니다.</p></TipModal></div>
    <Sel label="세대생략 증여 (조부모→손자녀)" value={skip} onChange={sSkip} options={[{value:"no",label:"해당 없음"},{value:"adult",label:"성년 손자녀 30% 할증"},{value:"minor",label:"미성년 손자녀 40% 할증"}]}/>

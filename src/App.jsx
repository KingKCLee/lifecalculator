...
const CL=[
  ...
  {id:"bldvat",l:"건물 부가세",c:"tax"},{id:"estincome",l:"임대 추정소득",c:"tax"},{id:"goodlord",l:"착한임대인 공제",c:"tax"},{id:"imputedrent",l:"간주임대료",c:"tax"},{id:"legalinherit",l:"법정상속분",c:"tax"},{id:"progressive",l:"누진세 범용",c:"tax"},
  ...
  {id:"auction2",l:"경매 적정입찰가",c:"realestate"},{id:"auctiondiv",l:"경매 배당 분석",c:"realestate"},{id:"reconyear",l:"재건축 연한",c:"realestate"},{id:"remodel2",l:"리모델링 ROI",c:"realestate"},{id:"rentincrease",l:"임대료 5% 상한",c:"realestate"},{id:"realprice",l:"실거래가 조회",c:"realestate"},
...
const CM={auction2:CalcAuction2,auctiondiv:CalcAuctionDiv,auctionloan:CalcAuctionLoan,bldvat:CalcBldVat,bond2:CalcBond2,datediff:CalcDateDiff,estincome:CalcEstIncome,goodlord:CalcGoodLandlord,imputedrent:CalcImputedRent,jeonseins:CalcJeonseInsurance,legalinherit:CalcLegalInherit,luckyday:CalcLuckyDay,progressive:CalcProgressive,reconyear:CalcReconYear,refinance:CalcRefinance,remodel2:CalcRemodel2,rentincrease:CalcRentIncrease,stamp2:CalcStampNew,realprice:CalcRealPrice,acquisition:CalcAcq,transfer:CalcTrans,compre:CalcCompre,property:CalcProp,gift:CalcGift,inherit:CalcInherit,mortgage:CalcMort,dsr:CalcDSR,dti:CalcDTI,ltv:CalcLTV,rti:CalcRti,commission:CalcComm,registration:CalcReg,legal:CalcLegal,yield:CalcYield,area:CalcArea,convert:CalcConvert,joint:CalcJoint,totalcost:CalcTotalCost,compare:CalcCompare,invest:CalcInvest,loanmax:CalcLoanMax,holdtax:CalcHoldTax,stamp:CalcStamp,bond:CalcBond,deposit:CalcDeposit,far:CalcFAR,rental:CalcRental,inctax:CalcIncTax,yearend:CalcYearEnd,netsalary:CalcNetSalary,cartax:CalcCarTax,insurance4:CalcInsurance4,pension:CalcPension,retire:CalcRetire,unemploy:CalcUnemploy,minwage:CalcMinWage,appraisal:CalcAppraisal,auction:CalcAuction,remodel:CalcRemodel,bldvalue:CalcBldValue};

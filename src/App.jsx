...
function AcqGuide({isMo}){
  ...
  return(
    <div style={{width:"100%",marginTop:32,background:"#fff",border:"1px solid #e5e7eb",borderRadius:16,overflow:"hidden",padding:isMo?16:24,display:"flex",flexDirection:"column",gap:16}}>

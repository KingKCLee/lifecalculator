...
const SEO_CONTENT={
acquisition:`<h2>2026년 취득세 완벽 가이드</h2><h3>취득세란?</h3><p>취득세는 부동산을 매매·증여·상속 등의 방법으로 취득할 때 납부하는 지방세입니다. 주택의 경우 취득가액과 보유 주택 수, 규제지역 여부에 따라 1%에서 최대 12%까지 차등 적용됩니다.</p><h3>2026년 주택 취득세율</h3><p>1주택자 및 비규제지역 2주택자는 취득가 6억 이하 1%, 6~9억 구간 1~3%(비례세율), 9억 초과 3%의 일반세율이 적용됩니다. 조정대상지역 2주택자는 8%, 3주택 이상은 12%의 중과세율이 적용됩니다. 비규제지역 3주택 이상은 8%입니다.</p><h3>생애최초 주택구입 감면</h3><p>무주택 세대가 12억원 이하 주택을 생애 최초로 구입하면 취득세 최대 200만원을 감면받을 수 있습니다. 이 혜택은 2028년 말까지 연장되었으며, 부부합산 소득 제한 없이 적용됩니다.</p><h3>일시적 2주택 특례</h3><p>이사 목적으로 일시적 2주택이 된 경우, 3년 이내에 종전 주택을 처분하면 1주택 세율이 적용됩니다. 투기과열지구에서는 처분 기한이 2년으로 단축됩니다.</p><h3>납부기한 및 가산세</h3><p>취득일(잔금 지급일 또는 등기일 중 빠른 날)로부터 60일 이내에 관할 시·군·구에 신고·납부해야 합니다. 기한 내 미신고 시 20%의 무신고 가산세가 부과됩니다.</p>`,
...
const UPDATE_LOG=[
  ...
  {date:"2026.04.04",items:[
    ...
    {cat:"전체",title:"카테고리 6개 재구성 (62가지 계산기)",desc:"세금·대출·비용·생활·부동산·PRO 6개 카테고리로 재편성. 인기 계산기 8개로 확대."}
  ]},
...
/* ── 2026.04.15 상단 탭·서브탭·정보센터 SVG 아이콘 맵 (sample 디자인 기준) ── */
const IC=(ch)=>(<svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{flexShrink:0}}>{ch}</svg>);
const TAB_ICONS={
  tax:IC(<><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></>),
  loan:IC(<><rect x="3" y="10" width="18" height="11" rx="2"/><path d="M3 10l9-7 9 7"/><line x1="12" y1="10" x2="12" y2="21"/><line x1="3" y1="15" x2="21" y2="15"/></>),
  cost:IC(<><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></>),
  life:IC(<><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></>),
  realestate:IC(<><rect x="4" y="2" width="16" height="20" rx="2"/><path d="M9 22v-4h6v4"/><path d="M8 6h.01M16 6h.01M8 10h.01M16 10h.01M8 14h.01M16 14h.01"/></>),
  pro:IC(<><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></>),
  info:IC(<><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/></>),
};
const CALC_ICONS={
  acquisition:IC(<><path d="M3 11l9-8 9 8"/><path d="M5 10v10h14V10"/></>),
  transfer:IC(<><rect x="5" y="3" width="14" height="18" rx="1"/><path d="M9 13l3 3 3-3"/><path d="M12 10v6"/></>),
  inctax:IC(<><circle cx="12" cy="12" r="9"/><path d="M12 3v9l6 3"/></>),
  yearend:IC(<><rect x="3" y="5" width="18" height="16" rx="1"/><path d="M3 9h18M8 3v4M16 3v4"/></>),
  compre:IC(<><rect x="4" y="8" width="16" height="13"/><path d="M4 8l8-5 8 5"/><path d="M10 13h1M13 13h1M10 16h1M13 16h1"/></>),
  property:IC(<><rect x="5" y="3" width="14" height="18" rx="1"/><path d="M9 8h6M9 12h6M9 16h4"/></>),
  gift:IC(<><rect x="3" y="8" width="18" height="12" rx="1"/><path d="M3 12h18M12 8v12"/><path d="M12 8c-2-3-6-3-6 0s3 3 6 0 6 3 6 0-4 0-6 0z"/></>),
  inherit:IC(<><path d="M12 3v18"/><path d="M6 7h12"/><path d="M6 7l-3 7h6z"/><path d="M18 7l3 7h-6z"/></>),
  holdtax:IC(<><rect x="5" y="3" width="14" height="18" rx="2"/><rect x="8" y="6" width="8" height="3"/><path d="M8 13h.01M12 13h.01M16 13h.01"/></>),
  rental:IC(<><circle cx="9" cy="14" r="4"/><path d="M12 11l8-8M17 3h3v3"/></>),
  bldvat:IC(<><path d="M3 21h18"/><rect x="5" y="10" width="4" height="11"/><rect x="10" y="6" width="4" height="15"/><rect x="15" y="13" width="4" height="8"/></>),
  estincome:IC(<><circle cx="12" cy="12" r="9"/><path d="M8 12h8M12 8v8"/></>),
  goodlord:IC(<><path d="M12 20s-7-4-7-10a4 4 0 0 1 7-2 4 4 0 0 1 7 2c0 6-7 10-7 10z"/></>),
  imputedrent:IC(<><circle cx="8" cy="8" r="4"/><circle cx="16" cy="16" r="4"/><circle cx="12" cy="12" r="4"/></>),
  legalinherit:IC(<><circle cx="12" cy="8" r="3"/><path d="M6 21c0-3 3-5 6-5s6 2 6 5"/><circle cx="5" cy="10" r="2"/><circle cx="19" cy="10" r="2"/></>),
  progressive:IC(<><path d="M3 20h18"/><rect x="5" y="14" width="3" height="6"/><rect x="10" y="10" width="3" height="10"/><rect x="15" y="6" width="3" height="14"/></>),
  mortgage:IC(<><path d="M3 10l9-6 9 6"/><path d="M4 10h16v11H4z"/><path d="M8 14h8M8 18h8"/></>),
  dsr:IC(<><path d="M12 14l4-4"/><path d="M4 14a8 8 0 1 1 16 0"/><circle cx="12" cy="14" r="1" fill="currentColor"/></>),
  dti:IC(<><path d="M12 3a9 9 0 1 0 9 9"/><path d="M12 3v9h9"/></>),
  ltv:IC(<><path d="M5 19L19 5"/><circle cx="7" cy="7" r="2"/><circle cx="17" cy="17" r="2"/></>),
  loanmax:IC(<><rect x="3" y="7" width="18" height="12" rx="2"/><path d="M3 11h18"/><circle cx="17" cy="15" r="1.5"/></>),
  rti:IC(<><path d="M3 11l9-8 9 8"/><path d="M5 10v10h14V10"/><path d="M10 20v-5h4v5"/><path d="M15 8l3-3"/></>),
  refinance:IC(<><path d="M4 12h14M14 6l4 6-4 6"/><path d="M20 12H6M10 18l-4-6 4-6"/></>),
  commission:IC(<><path d="M4 14l3-3 3 3 4-4 6 6"/><path d="M3 21l5-2 5 2"/><path d="M13 14l3 3"/></>),
  registration:IC(<><circle cx="12" cy="12" r="8"/><path d="M8 12l3 3 5-5"/></>),
  legal:IC(<><path d="M12 3v18"/><path d="M6 7h12"/><path d="M6 7l-3 7h6z"/><path d="M18 7l3 7h-6z"/></>),
  stamp:IC(<><rect x="5" y="3" width="14" height="18" rx="1"/><path d="M9 9l2 2 4-4"/><path d="M8 15h8M8 18h5"/></>),
  bond:IC(<><rect x="3" y="6" width="18" height="12" rx="1"/><circle cx="12" cy="12" r="2"/><path d="M7 9h.01M17 15h.01"/></>),
  appraisal:IC(<><circle cx="11" cy="11" r="7"/><path d="m20 20-3.5-3.5"/></>),
  bond2:IC(<><path d="M3 11l9-8 9 8"/><path d="M5 10v10h14V10"/><rect x="9" y="13" width="6" height="4"/></>),
  jeonseins:IC(<><path d="M12 3l8 3v6c0 5-4 8-8 9-4-1-8-4-8-9V6z"/></>),
  stamp2:IC(<><rect x="5" y="3" width="14" height="18" rx="1"/><path d="M9 11l2 2 4-4"/><path d="M8 17h8"/></>),
  netsalary:IC(<><rect x="3" y="7" width="18" height="12" rx="2"/><path d="M3 11h18"/><circle cx="17" cy="15" r="1.5"/></>),
  insurance4:IC(<><path d="M12 3l8 3v6c0 5-4 8-8 9-4-1-8-4-8-9V6z"/><path d="M9 12l2 2 4-4"/></>),
  pension:IC(<><circle cx="12" cy="7" r="3"/><path d="M6 21v-3a6 6 0 0 1 12 0v3"/><path d="M9 11l-1 3M15 11l1 3"/></>),
  cartax:IC(<><path d="M5 17h14l-2-7H7z"/><circle cx="8" cy="17" r="2"/><circle cx="16" cy="17" r="2"/><path d="M7 10V7h10v3"/></>),
  retire:IC(<><rect x="4" y="8" width="16" height="13" rx="1"/><path d="M9 8V5h6v3"/><path d="M4 13h16"/></>),
  unemploy:IC(<><path d="M12 2a10 10 0 0 0-10 10h20A10 10 0 0 0 12 2z"/><path d="M12 12v10"/></>),
  minwage:IC(<><circle cx="12" cy="8" r="4"/><path d="M4 21c0-4 4-7 8-7s8 3 8 7"/></>),
  deposit:IC(<><rect x="3" y="7" width="18" height="12" rx="2"/><circle cx="17" cy="13" r="1"/><path d="M7 11v4"/></>),
  convert:IC(<><path d="M4 8h14M14 4l4 4-4 4"/><path d="M20 16H6M10 20l-4-4 4-4"/></>),
  datediff:IC(<><rect x="3" y="5" width="18" height="16" rx="1"/><path d="M3 9h18M8 3v4M16 3v4M8 13h3M13 13h3M8 17h3"/></>),
  luckyday:IC(<><path d="M12 3l3 6 6 1-4 5 1 6-6-3-6 3 1-6-4-5 6-1z"/></>),
  subscription:IC(<><rect x="5" y="3" width="14" height="18" rx="1"/><path d="M9 9l1.5 1.5L13 8M9 13l1.5 1.5L13 12M9 17l1.5 1.5L13 16"/></>),
  auctionloan:IC(<><path d="M12 3l8 8-4 4-8-8z"/><path d="M4 21h8"/></>),
  yield:IC(<><path d="M3 17l6-6 4 4 8-8"/><path d="M14 7h7v7"/></>),
  joint:IC(<><circle cx="8" cy="9" r="3"/><circle cx="16" cy="9" r="3"/><path d="M3 20c0-3 2-5 5-5s5 2 5 5"/><path d="M11 20c0-3 2-5 5-5s5 2 5 5"/></>),
  area:IC(<><path d="M4 4h16v16H4z"/><path d="M4 8h16M8 4v16"/></>),
  far:IC(<><rect x="6" y="3" width="12" height="18"/><path d="M6 8h12M6 13h12M6 18h12"/></>),
  auction:IC(<><path d="M12 3l8 8-4 4-8-8z"/><path d="M4 21h16"/></>),
  remodel:IC(<><path d="M3 11l9-8 9 8"/><path d="M5 10v10h14V10"/><path d="M10 20v-5h4v5"/><path d="M14 8l2-2 3 3-2 2"/></>),
  bldvalue:IC(<><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2"/></>),
  auction2:IC(<><circle cx="12" cy="12" r="9"/><circle cx="12" cy="12" r="5"/><circle cx="12" cy="12" r="1" fill="currentColor"/></>),
  auctiondiv:IC(<><circle cx="12" cy="12" r="9"/><path d="M12 3v9l7 4"/></>),
  reconyear:IC(<><path d="M4 21V9h4V3h8l4 4v14"/><path d="M12 14h4"/></>),
  remodel2:IC(<><path d="M3 20h18"/><path d="M6 16l4-4 4 4 5-8"/></>),
  rentincrease:IC(<><rect x="5" y="11" width="14" height="10" rx="1"/><path d="M8 11V7a4 4 0 0 1 8 0v4"/></>),
  realprice:IC(<><circle cx="11" cy="11" r="7"/><path d="m20 20-3.5-3.5"/></>),
  netsale:IC(<><circle cx="12" cy="12" r="9"/><path d="M9 12h6M12 9v6M15 12l2-2M15 12l2 2"/></>),
  totalcost:IC(<><path d="M3 20h18"/><path d="M6 16l3-6 4 4 6-10"/></>),
  compare:IC(<><rect x="3" y="8" width="8" height="12"/><rect x="13" y="4" width="8" height="16"/></>),
  invest:IC(<><path d="M3 17l6-6 4 4 8-8"/><path d="M14 7h7v7"/><circle cx="9" cy="11" r="1.5"/></>),
};
const INFO_ICONS={
  news:IC(<><rect x="3" y="5" width="18" height="14" rx="1"/><path d="M3 9h18"/><path d="M7 13h6M7 16h4"/></>),
  policy:IC(<><path d="M5 21V10l7-5 7 5v11"/><path d="M10 21v-6h4v6"/><path d="M14 7v5h5"/></>),
  history:IC(<><path d="M5 3h10l4 4v14H5z"/><path d="M15 3v4h4"/><path d="M9 11h6M9 15h6"/></>),
  guide:IC(<><path d="M22 10L12 5 2 10l10 5 10-5z"/><path d="M6 12v5c0 1.5 3 3 6 3s6-1.5 6-3v-5"/></>),
  law:IC(<><path d="M12 3v18"/><path d="M6 7h12"/><path d="M6 7l-3 7h6z"/><path d="M18 7l3 7h-6z"/></>),
  saving:IC(<><path d="M9 18h6"/><path d="M10 22h4"/><path d="M12 2a7 7 0 0 0-4 12.7c.5.4 1 1 1 1.8V18h6v-1.5c0-.8.5-1.4 1-1.8A7 7 0 0 0 12 2z"/></>),
  howto:IC(<><rect x="4" y="3" width="16" height="18" rx="2"/><rect x="7" y="6" width="10" height="4"/><path d="M8 13h.01M12 13h.01M16 13h.01M8 17h.01M12 17h.01M16 17h.01"/></>),
  community:IC(<><path d="M4 4h14a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H9l-5 4z"/></>),
  terms:IC(<><path d="M4 3h12a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H4z"/><path d="M4 3v18"/><path d="M8 7h6M8 11h6M8 15h4"/></>),
  market:IC(<><path d="M3 20h18"/><path d="M6 16V8"/><path d="M12 16V4"/><path d="M18 16v-6"/></>),
};
...
function Inp({label,value,onChange,suffix,placeholder,note,error,inputMode}){
  ...
  const bdColor=error?"#3b82f6":"#dfe1e6";
  ...
  return(<div style={{marginBottom:isMo?8:16,width:"100%",maxWidth:"100%"}}>
    ...
    <div style={{position:"relative",width:"100%"}}>
      <input type="text" value={displayVal} onChange={handleChange} placeholder={placeholder}
        ...
        style={{width:"100%",boxSizing:"border-box",padding:isMo?"12px 14px":"10px 14px",paddingRight:suffix?44:14,border:error?"1.5px solid #3b82f6":"1.5px solid #dfe1e6",borderRadius:10,fontSize:isMo?16:15,background:"#fff",color:P.tx,outline:"none",fontFamily:"inherit",height:isMo?48:44,boxShadow:error?"0 0 0 3px rgba(59,130,246,0.1)":"none"}}
        onFocus={e=>{setFocused(true);e.target.style.borderColor=error?"#3b82f6":P.pri;}} onBlur={e=>{setFocused(false);e.target.style.borderColor=error?"#3b82f6":P.bd;}}/>
    ...
    {!error&&suffix==="만원"&&numVal>0&&<p style={{fontSize:11,color:P.pl,marginTop:3,marginBottom:0,fontWeight:500}}>{"= "+fW(numVal*10000)+(numVal>=10000?" ("+Math.floor(numVal/10000)+"억"+(numVal%10000>0?" "+fmt(numVal%10000)+"만":"")+"원)":"")}</p>}
    {!error&&suffix!=="만원"&&note&&<p style={{fontSize:11,color:P.mt,marginTop:3,marginBottom:0,lineHeight:1.6,wordBreak:"keep-all"}}>{note}</p>}
    {!error&&suffix==="만원"&&note&&<p style={{fontSize:11,color:P.mt,marginTop:2,marginBottom:0,lineHeight:1.6,wordBreak:"keep-all"}}>{note}</p>}
  </div>);
}
...
// 2026.04.15 계산기별 필수 입력 항목 안내 목록 (한국어)
const MI={
  acquisition:["취득가액을 입력해주세요"],
  transfer:["취득가액을 입력해주세요","양도가액을 입력해주세요","취득일을 입력해주세요","양도일을 입력해주세요"],
  compre:["공시가격을 입력해주세요"],
  property:["공시가격을 입력해주세요"],
  gift:["증여재산가액을 입력해주세요"],
  inherit:["상속재산가액을 입력해주세요"],
  holdtax:["공시가격을 입력해주세요"],
  rental:["연간임대수입을 입력해주세요"],
  inctax:["소득금액을 입력해주세요"],
  yearend:["연봉을 입력해주세요"],
  mortgage:["대출금액을 입력해주세요","금리를 입력해주세요","대출기간을 입력해주세요"],
  dsr:["연소득을 입력해주세요","대출금액을 입력해주세요","금리를 입력해주세요","대출기간을 입력해주세요"],
  dti:["연소득을 입력해주세요","대출금액을 입력해주세요","금리를 입력해주세요"],
  ltv:["주택가격을 입력해주세요","대출금액을 입력해주세요"],
  loanmax:["연소득을 입력해주세요"],
  refinance:["기존대출금액을 입력해주세요","기존금리를 입력해주세요"],
  auctionloan:["낙찰가를 입력해주세요"],
  commission:["거래금액을 입력해주세요"],
  registration:["취득가액을 입력해주세요"],
  legal:["부동산가액을 입력해주세요"],
  stamp:["계약금액을 입력해주세요"],
  bond:["취득가액을 입력해주세요"],
  appraisal:["감정평가 대상 가액을 입력해주세요"],
  bond2:["취득가액을 입력해주세요"],
  stampnew:["계약금액을 입력해주세요"],
  jeonseins:["전세보증금을 입력해주세요"],
  netsalary:["연봉을 입력해주세요"],
  insurance4:["월급여를 입력해주세요"],
  pension:["가입기간을 입력해주세요","평균소득을 입력해주세요"],
  cartax:["배기량을 입력해주세요"],
  retire:["평균임금을 입력해주세요","근속연수를 입력해주세요"],
  unemploy:["월급여를 입력해주세요","근무기간을 입력해주세요"],
  minwage:["시급 또는 월급을 입력해주세요"],
  deposit:["원금을 입력해주세요","금리를 입력해주세요","기간을 입력해주세요"],
  convert:["전세금 또는 월세를 입력해주세요"],
  yield:["매매가격을 입력해주세요"],
  area:["면적을 입력해주세요"],
  far:["대지면적을 입력해주세요","건축면적을 입력해주세요"],
  joint:["공시가격을 입력해주세요"],
  auction:["낙찰가를 입력해주세요"],
  remodel:["매입가격을 입력해주세요","공사비를 입력해주세요"],
  bldvalue:["건물가액을 입력해주세요","경과연수를 입력해주세요"],
  reconyear:["준공연도를 입력해주세요"],
  rentincrease:["현재임대료를 입력해주세요"],
  auction2:["감정가를 입력해주세요"],
  auctiondiv:["낙찰가를 입력해주세요"],
  netsale:["매도가격을 입력해주세요"],
  totalcost:["매입가격을 입력해주세요"],
  compare:["매입가격을 입력해주세요"],
  invest:["매입가격을 입력해주세요","기간을 입력해주세요"],
  rti:["연간임대수입을 입력해주세요","대출금액을 입력해주세요"],
...
function CalcAcq({isMo=false,onNav=()=>{}}){
  ...
  const _tips = [];
  if (tW(price) > 0 && total > 0) {
    if (acqType === "sale" && isHouse && n === 1 && !firstOfLife && pW <= 12e8 && isFirstHomeBenefit) {
      _tips.push("📌 생애최초 주택구입자는 12억 이하 주택에 대해 최대 200만원(인구감소지역 300만원) 취득세 감면을 받을 수 있습니다 (2028.12.31까지).");
    }
    if (acqType === "sale" && isHouse && areaType === "big") {
      _tips.push("📌 전용면적 85㎡ 이하 서민주택은 농어촌특별세가 비과세됩니다. 현재 85㎡ 초과로 농특세 " + fW(fm) + "이 추가되었습니다.");
    }
    if (acqType === "sale" && isHouse && n === 2 && isAdj && !tempTwo && !heavyTaxExclude) {
      _tips.push("📌 일시적 2주택(종전주택 3년 내 처분 예정)이라면 중과 제외로 1~3% 일반세율 적용 가능합니다. '일시적 2주택' 옵션을 확인하세요.");
    }
    if (acqType === "gift" && isHouse && isAdj && stdW >= 3e8 && !spouseChildGive) {
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"1fr 1fr",gap:isMo?12:32,alignItems:"start",minWidth:0,width:"100%",maxWidth:"100%"}}><div style={{minWidth:0,width:"100%",maxWidth:"100%"}}>
      ...
      <div style={{marginBottom:isMo?8:12}}>
        ...
        {autoPriceFlag&&<div style={{fontSize:11,color:"#60a5fa",fontWeight:600,marginTop:4,lineHeight:1.5}}>📍 주소조회로 자동입력. 공시가격보다 낮으면 공시가격이 과세표준이 됩니다.</div>}
      </div>
      {isMo&&<hr style={{border:"none",borderTop:"1px solid #E5E7EB",margin:"8px 0"}}/>}
      ...
      <div style={{marginBottom:isMo?8:12}}>
        ...
        {autoStdFlag&&<div style={{fontSize:11,color:"#60a5fa",fontWeight:600,marginTop:4,marginBottom:2,lineHeight:1.5}}>📍 주소조회로 자동입력. 실거래가보다 높으면 이 금액이 과세표준이 됩니다.</div>}
...
function CalcTrans({isMo=false,onNav=()=>{}}){
  ...
  if (result && result.totalTax > 0) {
    if (own === "one" && assetType === "house" && !is1HouseExempt && tW(sellAmt) <= 12e4) {
      _tips.push("📌 1주택자이고 양도가 12억 이하인 경우 '1세대1주택 비과세' 특수조건을 체크하면 전액 비과세됩니다. 2년 이상 보유(조정지역은 2년 거주) 필수.");
    }
    if (own === "one" && conArea && !realLive) {
      _tips.push("📌 조정대상지역 1주택은 '2년 거주' 요건을 충족해야 1세대1주택 비과세가 적용됩니다. 현재 거주 요건 미충족 상태입니다.");
    }
    if (assetType === "house" && buyDate.length >= 8 && sellDate.length >= 8) {
      const bd = new Date(buyDate.slice(0,4)+"-"+buyDate.slice(4,6)+"-"+buyDate.slice(6,8));
      const sd = new Date(sellDate.slice(0,4)+"-"+sellDate.slice(4,6)+"-"+sellDate.slice(6,8));
      const hy = (sd - bd) / (86400000 * 365.25);
      if (hy >= 1 && hy < 2) _tips.push("📌 보유 2년 미만으로 60% 단기세율이 적용 중입니다. 2년 경과 후 양도 시 누진세율로 전환되어 수백~수천만원 절감 가능합니다.");
      else if (hy < 1) _tips.push("📌 보유 1년 미만 70% 단기세율 적용 중입니다. 1년 경과 시 60%, 2년 경과 시 기본세율로 전환됩니다.");
    }
    if ((own === "two" || own === "more") && conArea) {
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"3fr 2fr",gap:isMo?16:28,alignItems:"start",minWidth:0}}><div>
    ...
    <div>
      {result?<div>
        <RP
          expertGuide={CALC_NAV_CONTENT.transfer?.items}
          title="양도소득세"
      ...
      </div>:<div><RP miss={MI.transfer} expertGuide={CALC_NAV_CONTENT.transfer?.items} expertGuide={CALC_NAV_CONTENT.transfer?.items} title="양도소득세" total={0} isExample={true} items={[]}/></div>}
...
function CalcCompre({isMo=false,onNav=()=>{}}){
  ...
  const[items,setItems]=useState([{id:1,price:"",joint:false,jointRate:"50",exclude:false,aptInfo:null,autoFill:false}]);const[showCompreLookup,setShowCompreLookup]=useState(null);
  ...
  const addItem=()=>{setItems([...items,{id:Date.now(),price:"",joint:false,jointRate:"50",exclude:false,aptInfo:null,autoFill:false}]);markModified();};
  ...
  const _tips = [];
  if (!isDefault && total > 0) {
    if (!isCorp && n === 1 && ageV < 60 && holdV < 5) {
      _tips.push("📌 1주택자는 고령자(60세+20%, 65세+30%, 70세+40%)·장기보유(5년+20%, 10년+40%, 15년+50%) 합산 최대 80% 세액공제 가능합니다.");
    }
    if (!isCorp && nRaw >= 2 && items.some(i => !i.exclude)) {
      _tips.push("📌 임대사업자 등록 후 장기일반민간임대주택으로 등록하면 합산배제되어 종부세 부담이 크게 줄어듭니다. 각 물건별 '합산배제' 체크 확인.");
    }
    if (!isCorp && nRaw >= 3) {
      _tips.push("📌 3주택 이상은 중과세율(최대 5.0%)이 적용됩니다. 일부 주택 매각·증여·임대등록 합산배제로 2주택 이하 전환 시 일반세율 전환됩니다.");
    }
    if (!isCorp && prev === 0 && total > 5e6) {
      _tips.push("📌 전년도 종부세액을 입력하면 세부담 상한(1·2주택 150%, 3주택+ 300%)이 적용되어 실제 납부액이 줄어들 수 있습니다.");
    }
  }
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"3fr 2fr",gap:isMo?16:28,alignItems:"start",minWidth:0}}><div>
    {showCompreLookup!==null&&<AddressModal calcType="holding" onClose={()=>setShowCompreLookup(null)} onApplyStd={v=>{const tid=showCompreLookup;setItems(prev=>prev.map(i=>i.id===tid?{...i,price:String(Math.round(v/10000)),autoFill:true}:i));markModified();setShowCompreLookup(null);}} onApplyInfo={info=>{const tid=showCompreLookup;setItems(prev=>prev.map(i=>i.id===tid?{...i,aptInfo:info}:i));}}/>}<Tog label="납세자 유형" value={taxpayer} onChange={sTP} options={[{value:"indi",label:"개인"},{value:"corp",label:"법인"}]}/>
    <hr style={{border:"none",borderTop:"1px solid #E5E7EB",margin:"16px 0"}}/>
    <div style={{marginBottom:12}}>
      ...
      {items.map((it,idx)=>(<div key={it.id} style={{padding:12,border:"1px solid #dfe1e6",borderRadius:10,marginBottom:8,background:it.exclude?"#f8f9fc":"#fff"}}>
        ...
        {it.aptInfo&&<div style={{background:"#eff6ff",border:"1px solid #bfdbfe",borderRadius:8,padding:"8px 12px",marginBottom:6,fontSize:12,color:"#1e40af",fontWeight:600}}>{it.aptInfo.aptName}{it.aptInfo.dongNm?" "+it.aptInfo.dongNm+"동":""}{it.aptInfo.hoNm?" "+it.aptInfo.hoNm+"호":""}</div>}
        <Inp label="공시가격" value={it.price} onChange={v=>{updateItem(it.id,{price:v,autoFill:false});markModified();}} suffix="만원" placeholder="예: 100000" error={idx===0&&(!it.price||it.price==="0")}/>
        {it.autoFill&&it.price&&<div style={{fontSize:11,color:"#4285F4",marginTop:-8,marginBottom:8,fontWeight:500}}>📍 주소조회로 자동입력됨 · 직접 수정 가능</div>}
    ...
    <hr style={{border:"none",borderTop:"1px solid #E5E7EB",margin:"16px 0"}}/>
    <RateTable title="종부세율표 (일반·개인)" headers={["과세표준","세율"]} rows={[["3억 이하","0.5%"],["6억 이하","0.7%"],["12억 이하","1.0%"],["25억 이하","1.3%"],["50억 이하","1.5%"],["94억 이하","2.0%"],["94억 초과","2.7%"]]}/>
  </div><div><RP miss={isDefault?MI.compre:null} expertGuide={CALC_NAV_CONTENT.compre?.items} expertGuide={CALC_NAV_CONTENT.compre?.items} isExample={isDefault} title="종합부동산세"
      ...
      total={total} sub={rateLabel+" ("+calcYear+"년 기준)"} items={rpItems}/><SavingsGuide tips={_tips}/><NextStep calcId="compre" onNav={onNav} isMo={isMo}/></div></div>);}

function CalcProp({isMo=false,onNav=()=>{}}){
  const[pt,sPt]=useState("house");const[p,sP]=useState("");const[isDefault,setIsDefault]=useState(true);const markModified=()=>setIsDefault(false);const[one,sOne]=useState("no");const[prevTax,sPT]=useState("");const[showPropLookup,setShowPropLookup]=useState(false);const[selectedPropInfo,setSelectedPropInfo]=useState(null);const[autoPropFill,setAutoPropFill]=useState(false);
  const pp=tW(p);
  let fr=0.70;
  if(pt==="house"){
    if(one==="yes"){
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"3fr 2fr",gap:isMo?16:28,alignItems:"start",minWidth:0}}><div><Tog label="부동산 유형" value={pt} onChange={sPt} options={[{value:"house",label:"주택"},{value:"land",label:"토지"},{value:"com",label:"건축물"}]}/><div style={{fontSize:13,color:"#374151",fontWeight:600,marginBottom:4,display:"flex",alignItems:"center",gap:6}}>공시가격 <TipModal title=""><p>매년 1월 1일 기준 공시가격. realtyprice.kr에서 확인. 공정시장가액비율(60%)을 곱한 금액이 과세표준.</p></TipModal></div>{!isMo&&<div style={{marginBottom:10}}><button type="button" onClick={()=>setShowPropLookup(true)} style={{width:"100%",padding:"12px 16px",background:"linear-gradient(135deg,#eff6ff,#dbeafe)",border:"1.5px solid #bfdbfe",borderRadius:10,fontSize:13,fontWeight:700,color:"#1e40af",cursor:"pointer",fontFamily:"inherit",display:"flex",alignItems:"center",justifyContent:"center",gap:8}}>📍 주소로 공시가격 자동조회</button></div>}{showPropLookup&&<AddressModal calcType="holding" onClose={()=>setShowPropLookup(false)} onApplyStd={v=>{sP(String(Math.round(v/10000)));markModified();setAutoPropFill(true);}} onApplyInfo={info=>setSelectedPropInfo(info)}/>}{selectedPropInfo&&!isMo&&<div style={{background:"#eff6ff",border:"1px solid #bfdbfe",borderRadius:10,padding:"10px 14px",marginBottom:8,display:"flex",alignItems:"center",justifyContent:"space-between",gap:8}}>
        <div style={{minWidth:0}}><div style={{fontSize:13,fontWeight:700,color:"#1e40af"}}>{selectedPropInfo.aptName}{selectedPropInfo.dongNm?" "+selectedPropInfo.dongNm+"동":""}{selectedPropInfo.hoNm?" "+selectedPropInfo.hoNm+"호":""}</div><div style={{fontSize:11,color:"#3b82f6",marginTop:2}}>{selectedPropInfo.priceYear?"공시가격 "+selectedPropInfo.priceYear+"년 기준 자동입력":""}</div></div>
        <button onClick={()=>{setSelectedPropInfo(null);setShowPropLookup(true);}} style={{fontSize:12,color:"#0141f9",background:"none",border:"none",cursor:"pointer",fontWeight:700,fontFamily:"inherit",whiteSpace:"nowrap"}}>다시검색</button>
      </div>}<Inp label="" value={p} onChange={v=>{sP(v);setAutoPropFill(false);}} suffix="만원" placeholder="예: 50000" error={!p||p==="0"}/>{autoPropFill&&p&&<div style={{fontSize:11,color:"#4285F4",marginTop:-8,marginBottom:8,fontWeight:500}}>📍 주소조회로 자동입력됨 · 직접 수정 가능</div>}{pt==="house"&&<Tog label="1세대 1주택 특례" value={one} onChange={sOne} options={[{value:"no",label:"일반 (60%)"},{value:"yes",label:"1세대1주택 (43~45%)"}]}/>}{pt==="house"&&one==="yes"&&pp>9e8&&<div style={{padding:"10px 14px",background:"#FFF8E1",border:"1px solid #FFE082",borderRadius:10,fontSize:12,color:"#F57F17",marginTop:8,lineHeight:1.6}}>공시가격 9억 초과 1주택자는 특례 공정시장가액비율 대상이 아니며 일반 60%가 적용됩니다.</div>}{pt==="house"&&<Inp label="전년도 재산세액 (선택)" value={prevTax} onChange={sPT} suffix="만원" placeholder="세부담상한 계산용" note="공시가 3억↓105% / 6억↓110% / 6억↑130%"/>}</div><div><RP miss={isDefault?MI.property:null} expertGuide={CALC_NAV_CONTENT.property?.items} expertGuide={CALC_NAV_CONTENT.property?.items} isExample={isDefault} title="재산세 총액"
...
function CalcGift({isMo=false,onNav=()=>{}}){const[rl,sRl]=useState("adult");const[p,sP]=useState("");const[isMarriage,sM]=useState("no");const[priorGift,sPG]=useState("");const[skip,sSkip]=useState("no");const[burden,sBurden]=useState("no");const[showGiftLookup,setShowGiftLookup]=useState(false);const[debt,sDebt]=useState("");const[autoGiftFill,setAutoGiftFill]=useState(false);const g=tW(p),priorW=tW(priorGift),debtW=tW(debt);const ds={spouse:6e8,adult:5e7,minor:2e7,asc:5e7,relative:1e7,other:0};let d=ds[rl];const hasMarriageBonus=isMarriage==="yes"&&(rl==="adult"||rl==="minor"||rl==="asc");if(hasMarriageBonus)d+=1e8;const giftPortion=burden==="yes"?Math.max(0,g-debtW):g;const totalGift=giftPortion+priorW;const tb=Math.max(0,totalGift-d);const priorTax=priorW>0?pTx(Math.max(0,priorW-d),GB):0;const fullTax=pTx(tb,GB);const skipRate=skip==="minor"?0.4:skip==="adult"?0.3:0;const surcharge=Math.round(fullTax*skipRate);const thisTax=Math.max(0,fullTax+surcharge-priorTax);const finalTax=Math.round(thisTax*.97);
const _tips=[];
if(g>0&&finalTax>0){
  if((rl==="adult"||rl==="minor"||rl==="asc")&&!hasMarriageBonus){
    _tips.push("📌 혼인·출산 시 직계존비속으로부터 추가 1억 공제(2024.1.1~)를 받을 수 있습니다. 혼인신고 전후 2년 내 증여라면 '혼인·출산 증여'를 체크하세요.");
  }
  if(rl==="spouse"&&g<=6e8){
    _tips.push("📌 배우자 증여 공제는 6억원입니다. 현재 공제 한도 이내이므로 납부세액이 발생하지 않습니다.");
  }
  if(rl==="adult"&&g>5e7&&g<=1.5e8&&!hasMarriageBonus){
    _tips.push("📌 10년 단위로 증여하면 공제 한도(성년 5천만) 초과분을 분할하여 세율 구간을 낮출 수 있습니다. 장기 증여 계획 수립 권장.");
  }
  if(skip!=="no"){
    _tips.push("📌 세대생략 증여는 30~40% 할증 과세됩니다. 부모를 거쳐 손자녀로 증여하는 것이 장기적으로 세액 부담이 더 적을 수 있습니다.");
  }
}
return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"3fr 2fr",gap:isMo?16:28,alignItems:"start",minWidth:0}}><div>
    <div style={{marginBottom:14}}><div style={{fontSize:12,color:"#6b778c",marginBottom:8}}>수증자와의 관계</div><div style={{display:"flex",flexWrap:"wrap",gap:6}}>{[{v:"spouse",l:"배우자",d:"6억"},{v:"adult",l:"성년 자녀",d:"5천만"},{v:"minor",l:"미성년 자녀",d:"2천만"},{v:"asc",l:"직계존속",d:"5천만"},{v:"relative",l:"기타 친족",d:"1천만"},{v:"other",l:"타인",d:"공제없음"}].map(opt=>(<button key={opt.v} onClick={()=>sRl(opt.v)} title={"공제한도 "+opt.d} style={{padding:"6px 12px",borderRadius:20,fontSize:12,fontWeight:rl===opt.v?700:500,cursor:"pointer",fontFamily:"inherit",transition:"all .15s",border:rl===opt.v?"none":"1.5px solid #dfe1e6",background:rl===opt.v?"#DEEBFF":"#fff",color:rl===opt.v?"#0C447C":"#505f79"}}>{rl===opt.v&&"✓ "}{opt.l}<span style={{opacity:.6,marginLeft:4,fontSize:10}}>({opt.d})</span></button>))}</div></div>
    <hr style={{border:"none",borderTop:"1px solid #E5E7EB",margin:"16px 0"}}/>
    {!isMo&&<div style={{marginBottom:10}}><button type="button" onClick={()=>setShowGiftLookup(true)} style={{width:"100%",padding:"12px 16px",background:"linear-gradient(135deg,#eff6ff,#dbeafe)",border:"1.5px solid #bfdbfe",borderRadius:10,fontSize:13,fontWeight:700,color:"#1e40af",cursor:"pointer",fontFamily:"inherit",display:"flex",alignItems:"center",justifyContent:"center",gap:8}}>📍 주소로 시가·공시가격 자동조회</button></div>}{showGiftLookup&&<AddressModal calcType="gift" onClose={()=>setShowGiftLookup(false)} onApplyPrice={v=>{sP(String(Math.round(v/10000)));setAutoGiftFill(true);}} onApplyStd={v=>{if(!tW(p))sP(String(Math.round(v/10000)));setAutoGiftFill(true);}}/>}<Inp label="증여 재산가액" value={p} onChange={v=>{sP(v);setAutoGiftFill(false);}} suffix="만원" placeholder="예: 100000" error={!p||p==="0"}/>{autoGiftFill&&p&&<div style={{fontSize:11,color:"#4285F4",marginTop:-8,marginBottom:8,fontWeight:500}}>📍 실거래가(시가) 자동입력. 시가 없으면 공시가격으로 수정하세요.</div>}
    <Tog label="부담부증여" value={burden} onChange={sBurden} options={[{value:"no",label:"일반 증여"},{value:"yes",label:"부담부 (채무인수)"}]}/>
    {burden==="yes"&&<Inp label="인수 채무액" value={debt} onChange={sDebt} suffix="만원" placeholder="예: 30000" note="채무인수분은 양도세 별도 과세"/>}
    <hr style={{border:"none",borderTop:"1px solid #E5E7EB",margin:"16px 0"}}/>
    <Inp label="10년 내 기증여 금액" value={priorGift} onChange={sPG} suffix="만원" placeholder="없으면 0" note="동일인으로부터 10년 이내 증여받은 금액"/>
    <hr style={{border:"none",borderTop:"1px solid #E5E7EB",margin:"16px 0"}}/>
    <Tog label="혼인·출산 증여 (2024~)" value={isMarriage} onChange={sM} options={[{value:"no",label:"아니오"},{value:"yes",label:"예 (직계+1억)"}]}/>
    <div style={{fontSize:13,color:"#374151",fontWeight:600,marginBottom:4,display:"flex",alignItems:"center",gap:6}}>세대생략 증여 (조부모→손자녀) <TipModal title=""><p>조부모→손자녀 증여 시 산출세액의 30% 할증(미성년 40%). 세대를 건너뛰는 증여에 적용됩니다.</p></TipModal></div>
    <Sel label="" value={skip} onChange={sSkip} options={[{value:"no",label:"해당 없음"},{value:"adult",label:"성년 손자녀 30% 할증"},{value:"minor",label:"미성년 손자녀 40% 할증"}]}/>
    {hasMarriageBonus&&<div style={{padding:"10px 14px",background:"#E3FCEF",border:"1px solid #57D9A3",borderRadius:10,fontSize:12,color:"#006644",marginTop:8}}>혼인·출산 시 직계존비속으로부터 추가 1억 공제 (2024.1.1~)</div>}
    {skip!=="no"&&<div style={{padding:"10px 14px",background:"#FFF8E1",border:"1px solid #FFE082",borderRadius:10,fontSize:12,color:"#F57F17",marginTop:8,display:"flex",alignItems:"center",gap:6}}><IconWarn c="#F57F17"/> 조부모→손자녀 증여는 할증 {skip==="minor"?40:30}% 추가 과세</div>}
    <hr style={{border:"none",borderTop:"1px solid #E5E7EB",margin:"16px 0"}}/>
    <RateTable title="증여세율표" headers={["과세표준","세율","누진공제"]} rows={[["1억 이하","10%","-"],["5억 이하","20%","1천만"],["10억 이하","30%","6천만"],["30억 이하","40%","1.6억"],["30억 초과","50%","4.6억"]]}/>
    <RateTable title="증여재산 공제한도" headers={["관계","공제한도"]} rows={[["배우자","6억"],["직계존속→성년","5천만"],["직계존속→미성년","2천만"],["직계비속→부모","5천만"],["기타 친족","1천만"]]}/>
    </div>
    <div>{g<=0&&<StepsGuide steps={[{label:"증여 재산가액 입력",filled:g>0},{label:"수증자 관계 선택",filled:true}]}/>}<RP miss={g>0?null:MI.gift} expertGuide={CALC_NAV_CONTENT.gift?.items} expertGuide={CALC_NAV_CONTENT.gift?.items} title="증여세"
      ...
      total={finalTax} sub={"공제 "+fW(d)+" 적용"} items={[{l:"증여재산가액",v:fW(g)}].concat(burden==="yes"&&debtW>0?[{l:"채무 인수분 (양도세 대상)",v:"-"+fW(debtW)},{l:"증여세 과세 증여액",v:fW(giftPortion)}]:[]).concat(priorW>0?[{l:"10년 내 기증여 합산",v:fW(priorW)}]:[]).concat([{l:"증여재산 공제",v:"-"+fW(d)},{l:"합산 과세표준",v:fW(tb)},{l:"합산 산출세액",v:fW(fullTax)}]).concat(skipRate>0?[{l:"세대생략 할증 ("+(skipRate*100)+"%)",v:"+"+fW(surcharge)}]:[]).concat(priorW>0&&priorTax>0?[{l:"기납부 증여세 차감",v:"-"+fW(priorTax)}]:[]).concat([{l:"신고세액공제 (3%)",v:"-"+fW(Math.round(thisTax*0.03)),note:"기한 내 신고 시"},{l:"이번 납부 증여세",v:fW(finalTax)}]).concat(burden==="yes"&&debtW>0?[{l:"채무인수분 추정 양도세",v:"약 "+fW(Math.round(debtW*0.22)),note:"참고용·실제는 세무사 확인"}]:[])}/><div style={{marginTop:12,padding:"14px 16px",background:"#FFF8E1",border:"1px solid #FFE082",borderRadius:10,fontSize:13,color:"#92400E",lineHeight:1.6}}>※ 증여 시 취득세가 별도 부과됩니다. (일반 3.5%, 조정대상지역 다주택자 12%)<div style={{marginTop:8}}><button onClick={()=>onNav("tax","acquisition")} style={{padding:"8px 16px",background:"#fff",border:"1px solid #dfe1e6",borderRadius:8,fontSize:12,fontWeight:700,color:"#0747A6",cursor:"pointer",fontFamily:"inherit"}}>취득세 계산하기 →</button></div></div><SavingsGuide tips={_tips}/><NextStep calcId="gift" onNav={onNav} isMo={isMo}/></div></div>);}

function CalcInherit({isMo=false,onNav=()=>{}}){const[ta,sTa]=useState("");const[finAsset,sFA]=useState("");const[db,sDb]=useState("");const[fn,sFn]=useState("");const[hasSpouse,sHS]=useState("yes");const[children,sCh]=useState("2");const[cohabit,sCohab]=useState("");const[farm,sFarm]=useState("");const[priorGift,sPG]=useState("");const[onTime,sOT]=useState("yes");const[showInheritLookup,setShowInheritLookup]=useState(false);const[autoInheritFill,setAutoInheritFill]=useState(false);const t=tW(ta),finW=tW(finAsset),d=tW(db),f=Math.min(tW(fn),15000000),priorW=tW(priorGift),cohabW=tW(cohabit),farmW=tW(farm);const gross=t+priorW;const netEstate=gross-d-f;const childN=parseInt(children)||0;const basicDed=2e8;const personalDed=childN*5e7;const basicPlusPersonal=basicDed+personalDed;const lumpSum=5e8;const mainDed=Math.max(basicPlusPersonal,lumpSum);let spouseDed=0;if(hasSpouse==="yes"){const spouseShare=netEstate>0?netEstate*1.5/(1.5+childN):0;spouseDed=Math.min(Math.max(spouseShare,5e8),30e8);}let financialDed=0;if(finW>0){if(finW<=2e7)financialDed=finW;else if(finW<=1e8)financialDed=2e7;else financialDed=Math.min(Math.round(finW*0.20),2e8);}const cohabDed=cohabW>0?Math.min(cohabW,6e8):0;const farmDed=farmW>0?Math.min(farmW,15e8):0;const totalDed=mainDed+spouseDed+financialDed+cohabDed+farmDed;const tb=Math.max(0,netEstate-totalDed);const tx=pTx(tb,GB);const rebate=onTime==="yes"?0.03:0;const finalTax=Math.round(tx*(1-rebate));return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"3fr 2fr",gap:isMo?16:28,alignItems:"start",minWidth:0}}><div>
    {!isMo&&<div style={{marginBottom:10}}><button type="button" onClick={()=>setShowInheritLookup(true)} style={{width:"100%",padding:"12px 16px",background:"linear-gradient(135deg,#eff6ff,#dbeafe)",border:"1.5px solid #bfdbfe",borderRadius:10,fontSize:13,fontWeight:700,color:"#1e40af",cursor:"pointer",fontFamily:"inherit",display:"flex",alignItems:"center",justifyContent:"center",gap:8}}>📍 주소로 시가·공시가격 자동조회</button></div>}{showInheritLookup&&<AddressModal calcType="gift" onClose={()=>setShowInheritLookup(false)} onApplyPrice={v=>{sTa(String(Math.round(v/10000)));setAutoInheritFill(true);}} onApplyStd={v=>{if(!tW(ta))sTa(String(Math.round(v/10000)));setAutoInheritFill(true);}}/>}<Inp label="총 상속재산가액" value={ta} onChange={v=>{sTa(v);setAutoInheritFill(false);}} suffix="만원" placeholder="예: 200000" error={!ta||ta==="0"}/>{autoInheritFill&&ta&&<div style={{fontSize:11,color:"#4285F4",marginTop:-8,marginBottom:8,fontWeight:500}}>📍 실거래가(시가) 자동입력. 시가 없으면 공시가격으로 수정하세요.</div>}
    <div style={{fontSize:13,color:"#374151",fontWeight:600,marginBottom:4,display:"flex",alignItems:"center",gap:6}}>금융재산 (별도) <TipModal title=""><p>2천만원 이하: 전액 공제 / 1억 이하: 2천만 / 1억 초과: 20% (최대 2억)</p></TipModal></div>
    <Inp label="" value={finAsset} onChange={sFA} suffix="만원" placeholder="예: 20000" note="총재산 중 금융재산만 별도 기재 (공제 계산용)"/>
    <Inp label="채무 (대출 등)" value={db} onChange={sDb} suffix="만원" placeholder="예: 10000"/>
    <Inp label="장례비용" value={fn} onChange={sFn} suffix="만원" note="최대 1,500만원 공제"/>
    <Inp label="10년 내 사전증여" value={priorGift} onChange={sPG} suffix="만원" placeholder="없으면 0" note="상속재산에 합산 과세"/>
    <hr style={{border:"none",borderTop:"1px solid #E5E7EB",margin:"16px 0"}}/>
    <Tog label="배우자 유무" value={hasSpouse} onChange={sHS} options={[{value:"yes",label:"있음"},{value:"no",label:"없음"}]}/>
    <Sel label="자녀 수" value={children} onChange={sCh} options={[0,1,2,3,4,5].map(n=>({value:String(n),label:n+"명"}))}/>
    <hr style={{border:"none",borderTop:"1px solid #E5E7EB",margin:"16px 0"}}/>
    <Inp label="동거주택 가액 (선택)" value={cohabit} onChange={sCohab} suffix="만원" placeholder="없으면 0" note="10년↑ 동거·무주택 상속인, 최대 6억"/>
    <Inp label="영농상속 재산 (선택)" value={farm} onChange={sFarm} suffix="만원" placeholder="없으면 0" note="최대 15억 공제"/>
    <hr style={{border:"none",borderTop:"1px solid #E5E7EB",margin:"16px 0"}}/>
    <Tog label="6개월 내 신고" value={onTime} onChange={sOT} options={[{value:"yes",label:"예 (3% 공제)"},{value:"no",label:"아니오"}]}/>
    <hr style={{border:"none",borderTop:"1px solid #E5E7EB",margin:"16px 0"}}/>
    <RateTable title="상속세율표" headers={["과세표준","세율","누진공제"]} rows={[["1억 이하","10%","-"],["5억 이하","20%","1천만"],["10억 이하","30%","6천만"],["30억 이하","40%","1.6억"],["30억 초과","50%","4.6억"]]}/>
    <RateTable title="상속공제 한도" headers={["구분","공제금액"]} rows={[["일괄공제","5억"],["기초+인적","2억+자녀5천/인"],["배우자공제","최소5억~최대30억"],["금융재산공제","최대2억"]]}/>
    </div>
    <div>{t<=0&&<StepsGuide steps={[{label:"총 상속재산가액 입력",filled:t>0},{label:"가족 구성 확인",filled:true}]}/>}<RP miss={t>0?null:MI.inherit} expertGuide={CALC_NAV_CONTENT.inherit?.items} expertGuide={CALC_NAV_CONTENT.inherit?.items} title="상속세"
...
function CalcMort({isMo=false,onNav=()=>{}}){const[pr,sPr]=useState("");const[rt,sRt]=useState("");const[isDefault,setIsDefault]=useState(true);const markModified=()=>setIsDefault(false);const[yr,sYr]=useState("30");const[gr,sGr]=useState("0");const[mt,sMt]=useState("equal");const[ppFee,sPP]=useState("");const[ppYear,sPY]=useState("0");const[showSchedule,setShowSchedule]=useState(false);
  ...
  const _tips=[];
  if(PP>0&&r>0){
    const savings=Math.max(eq.ti,pr2.ti,bl.ti)-Math.min(eq.ti,pr2.ti,bl.ti);
    if(mt!=="principal"&&pr2.ti<sel.ti){
      _tips.push("📌 원금균등 상환이 원리금균등 대비 총 이자를 "+fW(sel.ti-pr2.ti)+" 절감합니다. 초기 부담이 크지만 장기적으로 유리합니다.");
    }
    if(mt==="bullet"){
      _tips.push("📌 만기일시 상환은 총 이자가 가장 많습니다. 원금 분할상환 방식 전환 시 수백~수천만원 이자 절약 가능.");
    }
    if(pN(rt)>=4.5){
      _tips.push("📌 금리 4.5% 이상은 고금리 구간입니다. 보금자리론(연 3.8~4.3%)·디딤돌(2.45~3.55%) 정책자금 대환 검토 권장.");
    }
    if(parseInt(gr)>0){
      _tips.push("📌 거치기간 중에는 이자만 납부되어 원금이 줄지 않습니다. 거치 없이 즉시 원금 상환 시 총 이자 부담이 크게 줄어듭니다.");
    }
  }
...
function CalcComm({isMo=false,onNav=()=>{}}){const[ty,sTy]=useState("res");const[tx,sTx]=useState("sale");const[p,sP]=useState("0");const[isDefault,setIsDefault]=useState(true);const markModified=()=>setIsDefault(false);const[dep,sDep]=useState("");const[mon,sMon]=useState("");const[mult,sMult]=useState("100");const[showRateTable,setShowRateTable]=useState(false);
  ...
  let r=0,mf=Infinity;
  if(effectiveTy==="res"){
    if(effectiveTx==="sale"){if(pW<5e7){r=.006;mf=250000;}else if(pW<2e8){r=.005;mf=800000;}else if(pW<9e8)r=.004;else if(pW<12e8)r=.005;else if(pW<15e8)r=.006;else r=.007;}
    else{if(pW<5e7){r=.005;mf=200000;}else if(pW<1e8){r=.004;mf=300000;}else if(pW<6e8)r=.003;else if(pW<12e8)r=.004;else if(pW<15e8)r=.005;else r=.006;}
  }
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"1fr 1fr",gap:isMo?16:32,alignItems:"start",minWidth:0}}><div>{!isMo&&<h3 style={{fontSize:isMo?16:18,fontWeight:700,color:P.tx,margin:"0 0 20px"}}>중개수수료 계산기</h3>}<div style={{fontSize:13,color:"#374151",fontWeight:600,marginBottom:4,display:"flex",alignItems:"center",gap:6}}>유형 <TipModal title=""><p>주택: 0.4~0.7% / 오피스텔: 0.5% / 상가: 0.9% 이내 협의</p></TipModal></div><Sel label="" value={ty} onChange={sTy} options={[{value:"res",label:"주택·아파트·빌라"},{value:"offi",label:"오피스텔"},{value:"com",label:"상가·토지·건물"},{value:"right",label:"분양권 전매"}]}/>{ty==="offi"&&<Tog label="오피스텔 용도" value={offiSub} onChange={setOffiSub} options={[{value:"res",label:"주거용 (주택요율)"},{value:"biz",label:"업무용 (0.5%)"}]}/>}<Tog label="거래 유형" value={tx} onChange={sTx} options={ty==="right"?[{value:"sale",label:"전매 (매매요율)"}]:[{value:"sale",label:"매매"},{value:"lease",label:"전세"},{value:"rent",label:"월세"}]}/>{tx==="rent"?(<><Inp label="보증금" value={dep} onChange={sDep} suffix="만원" placeholder="예: 5000"/><Inp label="월세" value={mon} onChange={sMon} suffix="만원" placeholder="예: 50"/><div style={{fontSize:13,color:"#374151",fontWeight:600,marginBottom:4,display:"flex",alignItems:"center",gap:6}}>환산배수 <TipModal title=""><p>보증금+월세×배수로 거래금액 환산. 일반: ×100 / 서울 등: ×70</p></TipModal></div><Tog label="" value={mult} onChange={sMult} options={[{value:"100",label:"×100 (일반)"},{value:"70",label:"×70 (서울 등 특정지역)"}]}/><div style={{padding:"10px 14px",background:P.lt,borderRadius:8,fontSize:12,color:"#6b778c",lineHeight:1.6,marginBottom:16}}>환산보증금 = 보증금 + 월세 × {multiplier} = {fW(pW)}</div></>):(<Slider label="거래금액" value={p} onChange={v=>{sP(v);markModified();}} min={1000} max={500000} step={500}/>)}{ty!=="res"&&<div style={{padding:"10px 14px",background:"#FFF8E1",border:"1px solid #FFE082",borderRadius:10,fontSize:12,color:"#F57F17",marginTop:8,lineHeight:1.6}}>{ty==="offi"?"오피스텔 요율: 매매 0.5%, 전세·월세 0.4% (협의)":"상가·토지·건물: 0.9% 이내 협의 (부가세 별도)"}</div>}{rentBelowDeposit&&<div style={{padding:"10px 14px",background:"#eff6ff",border:"1px solid #93c5fd",borderRadius:10,fontSize:12,color:"#1e40af",marginTop:8,lineHeight:1.6}}>환산보증금({fW(convertedAmt)})이 보증금({fW(tW(dep))})보다 작아 보증금 기준 요율을 적용합니다.</div>}</div><div><RP miss={isDefault?MI.commission:null} expertGuide={CALC_NAV_CONTENT.commission?.items} expertGuide={CALC_NAV_CONTENT.commission?.items} isExample={isDefault} title="중개보수 (수수료)"
...
function CalcConvert({isMo=false,onNav=()=>{}}){const[type,sType]=useState("m2j");const[deposit,sDep]=useState("");const[monthly,sMon]=useState("");const[rate,sRate]=useState("");const dep=tW(deposit),mon=tW(monthly),rt=pN(rate)/100;let result=0;if(type==="m2j"){result=rt>0?mon*12/rt+dep:0;}else{result=dep>0&&rt>0?(dep*rt)/12:0;}return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"3fr 2fr",gap:isMo?16:32,alignItems:"start",minWidth:0}}><div><Tog label="전환 방향" value={type} onChange={sType} options={[{value:"m2j",label:"월세 → 전세"},{value:"j2m",label:"전세 → 월세"}]}/>{type==="m2j"?<><Inp label="보증금" value={deposit} onChange={sDep} suffix="만원" placeholder="예: 5000"/><Inp label="월세" value={monthly} onChange={sMon} suffix="만원" placeholder="예: 80"/></>:<Inp label="전세보증금" value={deposit} onChange={sDep} suffix="만원" placeholder="예: 30000"/>}<div style={{fontSize:13,color:"#374151",fontWeight:600,marginBottom:4,display:"flex",alignItems:"center",gap:6}}>전환율 <TipModal title=""><p>법정 상한: 기준금리(3%)+2% = 5.0% (2026년). 임대인이 초과 요구 불가.</p></TipModal></div><Inp label="" value={rate} onChange={sRate} suffix="%" note="2025 법정 전환율 상한: 기준금리+2%"/></div><RP miss={(dep>0||mon>0)?null:MI.convert} expertGuide={CALC_NAV_CONTENT.convert?.items} expertGuide={CALC_NAV_CONTENT.convert?.items} title={type==="m2j"?"전세 환산금액":"월세 환산금액"}
      ...
      total={result} sub={"전환율 "+rate+"% 적용"} items={type==="m2j"?[{l:"기존 보증금",v:fW(dep)},{l:"월세",v:fW(mon),note:"월세×12÷전환율"},{l:"월세 환산 보증금",v:fW(mon*12/(rt||0.01))},{l:"전세 환산 합계",v:fW(result)},{l:"법정 상한 전환율",v:"5.0%",note:"기준금리+2%"}]:[{l:"전세보증금",v:fW(dep)},{l:"환산 월세",v:fW(result)},{l:"연 환산 임대료",v:fW(result*12)},{l:"법정 상한 전환율",v:"5.0%",note:"기준금리+2%"}]}/><NextStep calcId="convert" onNav={onNav} isMo={isMo}/><RateTable title="전월세 전환율 기준" headers={["항목","기준"]} rows={[["법정 전환율 상한","기준금리+2%"],["현행 기준금리","3.0%"],["법정 상한","5.0%"],["시장 평균","약 4~6%"]]}/></div>);}

function CalcTotalCost({isMo=false,onNav=()=>{}}){const[p,sP]=useState("0");const[isDefault,setIsDefault]=useState(true);const markModified=()=>setIsDefault(false);const[showLookup,setShowLookup]=useState(false);const[autoTcFill,setAutoTcFill]=useState(false);const[h,sH]=useState("1");const[a,sA]=useState("non");const pW=tW(p);const n=parseInt(h),isR=a!=="non";let acqR;if(n===1||(n===2&&!isR)){acqR=pW<=6e8?.01:pW<=9e8?.02:.03;}else if(n===2&&isR){acqR=.08;}else{acqR=isR?.12:.08;}const ac=pW*acqR,ed=ac*.1,fm=acqR>=.08?pW*.002:pW*.002,tAcq=ac+ed+fm;const rT=pW*.02,rE=rT*.2;let st=pW>1e9?350000:pW>5e8?150000:70000;const tReg=rT+rE+st+15000;let bf=pW<=1e8?160000:pW<=3e8?220000:pW<=5e8?310000:pW<=1e9?420000:600000;const tLeg=bf*1.1+80000;let cr=pW<2e8?.005:pW<9e8?.004:.005;const tComm=pW*cr*1.1;const grand=tAcq+tReg+tLeg+tComm;return(<>{showLookup&&<AddressModal onClose={()=>setShowLookup(false)} onApplyPrice={v=>{sP(String(Math.round(v/10000)));markModified();setShowLookup(false);setAutoTcFill(true);}}/>}<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"3fr 2fr",gap:isMo?16:32,alignItems:"start",minWidth:0}}><div>{!isMo&&<button onClick={()=>setShowLookup(true)} style={{fontSize:12,color:"#0141f9",background:"none",border:"none",cursor:"pointer",fontWeight:700,fontFamily:"inherit",marginBottom:4,display:"flex",alignItems:"center",gap:4}}><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/></svg>주소로 실거래가 조회</button>}<Slider label="매수 가격" value={p} onChange={v=>{sP(v);markModified();setAutoTcFill(false);}} min={1000} max={500000} step={500}/>{autoTcFill&&p&&p!=="0"&&<div style={{fontSize:11,color:"#4285F4",marginTop:-8,marginBottom:8,fontWeight:500}}>📍 주소조회로 자동입력됨 · 직접 수정 가능</div>}<Radio label="주택 수 (취득 후)" value={h} onChange={sH} options={[{value:"1",label:"1주택"},{value:"2",label:"2주택"},{value:"3",label:"3주택 이상"}]}/><Tog label="지역 구분" value={a} onChange={sA} options={[{value:"non",label:"비규제"},{value:"adj",label:"조정대상"},{value:"spec",label:"투기과열"}]}/></div><RP miss={isDefault?MI.totalcost:null} expertGuide={CALC_NAV_CONTENT.totalcost?.items} expertGuide={CALC_NAV_CONTENT.totalcost?.items} isExample={isDefault} title="매수 총비용"
...
function CalcRti({isMo=false,onNav=()=>{}}){
  ...
  const[rentAnnual,setRA]=useState("");
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"1fr 1fr",gap:isMo?16:32,alignItems:"start",minWidth:0}}><div>
    ...
    <div style={{fontSize:13,color:"#374151",fontWeight:600,marginBottom:4,display:"flex",alignItems:"center",gap:6}}>건물 유형 <TipModal title=""><p>임대사업자 주택담보대출 심사 비율.</p><p><b>RTI = 연간 임대소득 / 연간 이자비용</b></p><ul style={{paddingLeft:20}}><li>주거용 (주택): 1.25배 이상</li><li>비주거용 (상가·오피스텔·공장): 1.5배 이상</li></ul><p>2018.3.26 여신심사 가이드라인 도입. 임대사업자 등록 대출 시 필수.</p></TipModal></div>
    <Tog label="" value={propType} onChange={setPT} options={[{value:"res",label:"주거용 (1.25배)"},{value:"biz",label:"비주거용 (1.5배)"}]}/>
    <Inp label="연간 임대소득" value={rentAnnual} onChange={setRA} suffix="만원" placeholder="예: 2400 (월 200만)" note="월 임대료 × 12 + 보증금 운용수익" error={!rentAnnual||rentAnnual==="0"}/>
    <Inp label="대출금액" value={loanAmt} onChange={setLA} suffix="만원" placeholder="예: 50000" error={!loanAmt||loanAmt==="0"}/>
...
function CalcSubscription({isMo=false,onNav=()=>{}}){
  ...
  const bankScore=by===0?1:Math.min(17,by+1);
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"3fr 2fr",gap:isMo?16:32,alignItems:"start",minWidth:0}}><div>
    <div style={{fontSize:13,color:"#374151",fontWeight:600,marginBottom:4,display:"flex",alignItems:"center",gap:6}}>무주택기간 <TipModal title=""><p>만 30세부터 기산. 기혼자는 혼인신고일이 빠르면 혼인신고일부터. 주택 처분 후 재취득 시 초기화.</p><p>최대 32점 (1년 미만 2점, 1~2년 4점, ..., 15년 이상 32점).</p></TipModal></div>
    <Sel label="" value={noHouseY} onChange={setNoHouseY} options={ySel}/>
    <div style={{fontSize:13,color:"#374151",fontWeight:600,marginBottom:4,display:"flex",alignItems:"center",gap:6}}>부양가족 수 <TipModal title=""><p>본인 제외, 배우자·직계존속·직계비속 중 세대를 같이하는 사람. 최대 35점 (0명 5점, 1명 10점, ..., 6명 이상 35점).</p></TipModal></div>
    <Sel label="" value={family} onChange={setFamily} options={[{value:"0",label:"0명"},{value:"1",label:"1명"},{value:"2",label:"2명"},{value:"3",label:"3명"},{value:"4",label:"4명"},{value:"5",label:"5명"},{value:"6",label:"6명 이상"}]}/>
    <div style={{fontSize:13,color:"#374151",fontWeight:600,marginBottom:4,display:"flex",alignItems:"center",gap:6}}>청약통장 <TipModal title=""><p>청약저축·청약예금·청약부금·주택청약종합저축. 최대 17점 (6개월 미만 1점, 6~12개월 2점, 1~2년 3점, 이후 매년 +1점).</p></TipModal></div>
    <Sel label="" value={bankY} onChange={setBankY} options={bSel}/>
  </div><div>
    <div style={{background:"linear-gradient(315deg, #0747A6 0%, #0052CC 50%, #0065FF 100%)",borderRadius:20,padding:"28px 24px",color:"#fff",textAlign:"center",boxShadow:"0 8px 28px rgba(7,71,166,.28)"}}>
...
function CalcNetSale({isMo=false,onNav=()=>{}}){
  ...
  const[buyP,setBuyP]=useState("");const[autoSaleFill,setAutoSaleFill]=useState(false);
  ...
  return(<>{showLookup&&<AddressModal onClose={()=>setShowLookup(false)} onApplyPrice={v=>{setSellP(String(Math.round(v/10000)));setShowLookup(false);setAutoSaleFill(true);}}/>}<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"3fr 2fr",gap:isMo?16:32,alignItems:"start",minWidth:0}}><div>
    {!isMo&&<button onClick={()=>setShowLookup(true)} style={{fontSize:12,color:"#0141f9",background:"none",border:"none",cursor:"pointer",fontWeight:700,fontFamily:"inherit",marginBottom:4,display:"flex",alignItems:"center",gap:4}}><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/></svg>주소로 실거래가 조회</button>}
    <Inp label="매도가격" value={sellP} onChange={v=>{setSellP(v);setAutoSaleFill(false);}} suffix="만원" placeholder="예: 100000" error={!sellP||sellP==="0"}/>{autoSaleFill&&sellP&&<div style={{fontSize:11,color:"#4285F4",marginTop:-8,marginBottom:8,fontWeight:500}}>📍 주소조회로 자동입력됨 · 직접 수정 가능</div>}
    <Inp label="취득가격" value={buyP} onChange={setBuyP} suffix="만원" placeholder="예: 70000" error={!buyP||buyP==="0"}/>
    ...
    <RP miss={sellW>0?null:MI.netsale} expertGuide={CALC_NAV_CONTENT.netsale?.items} expertGuide={CALC_NAV_CONTENT.netsale?.items} title="매도 실수령액" total={Math.max(0,net)} sub={"매도가 "+fW(sellW)+" 기준"}
    ...
    <NextStep calcId="netsale" onNav={onNav} isMo={isMo}/><RateTable title="양도소득세 간이세율" headers={["보유기간","세율"]} rows={[["1년 미만","70%"],["1~2년","60%"],["2년↑ (기본)","6~45% 누진"],["1주택 장기보유","최대 80% 공제"]]}/>
  </div></div></>);
}
...
/* 등기비용 */
function CalcReg({isMo=false,onNav=()=>{}}){const[tx,sTx]=useState("sale");const[propType,sPT]=useState("house");const[p,sP]=useState("");const[loan,sLoan]=useState("");const pW=tW(p),loanW=tW(loan);const _regErr=!p||p==="0";
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"1fr 1fr",gap:isMo?16:32,alignItems:"start",minWidth:0}}><div>{!isMo&&<h3 style={{fontSize:isMo?16:18,fontWeight:700,color:P.tx,margin:"0 0 20px"}}>등기비용 통합 계산</h3>}<Tog label="거래 유형" value={tx} onChange={sTx} options={[{value:"sale",label:"매매"},{value:"gift",label:"증여"},{value:"inherit",label:"상속"}]}/><Tog label="부동산 유형" value={propType} onChange={sPT} options={[{value:"house",label:"주택"},{value:"land",label:"토지·상가·건물"}]}/><Inp label="부동산 가액" value={p} onChange={sP} suffix="만원" placeholder="예: 90000" error={_regErr}/><Inp label="대출금액 (설정등기용)" value={loan} onChange={sLoan} suffix="만원" placeholder="없으면 0" note="채권최고액 = 대출액 × 120%"/></div><div><RP miss={pW>0?null:MI.registration} expertGuide={CALC_NAV_CONTENT.registration?.items} expertGuide={CALC_NAV_CONTENT.registration?.items} title="등기비용 통합"
...
function CalcLegal({isMo=false,onNav=()=>{}}){const[tx,sTx]=useState("sale");const[p,sP]=useState("");const pW=tW(p);
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"1fr 1fr",gap:isMo?16:32,alignItems:"start",minWidth:0}}><div>{!isMo&&<h3 style={{fontSize:isMo?16:18,fontWeight:700,color:P.tx,margin:"0 0 20px"}}>법무사 수수료</h3>}<Sel label="업무 유형" value={tx} onChange={sTx} options={[{value:"sale",label:"소유권이전 (매매)"},{value:"gift",label:"소유권이전 (증여)"},{value:"inherit",label:"소유권이전 (상속)"},{value:"mortgage",label:"근저당 설정등기"},{value:"release",label:"말소등기"}]}/><Inp label="시가표준액 (과세표준)" value={p} onChange={sP} suffix="만원" placeholder="예: 90000" note="대한법무사협회 보수표 기준 (참고용)" error={!p||p==="0"}/><div style={{padding:"10px 14px",background:P.lt,borderRadius:8,fontSize:11,color:"#6b778c",lineHeight:1.5,marginTop:8}}>※ 증여/상속은 매매 대비 약 80% 수준. 실제 비용은 법무사와 협의에 따라 달라질 수 있습니다.</div></div><div><RP miss={pW>0?null:MI.legal} expertGuide={CALC_NAV_CONTENT.legal?.items} expertGuide={CALC_NAV_CONTENT.legal?.items} title="법무사 비용 총합계"
      deadline="등기 신청: 잔금일로부터 60일 이내 (미이행 시 과태료)"
      deadlineLink="https://iros.go.kr" deadlineLinkLabel="인터넷등기소 →"
...
/* 임대수익률 */
function CalcYield({isMo=false,onNav=()=>{}}){const[pp,sPP]=useState("");const[dp,sDp]=useState("");const[rn,sRn]=useState("");const[ex,sEx]=useState("");const[ln,sLn]=useState("");const[lr,sLr]=useState("");const[isDefault,setIsDefault]=useState(true);const markModified=()=>setIsDefault(false);const[showLookup,setShowLookup]=useState(false);const[autoYieldFill,setAutoYieldFill]=useState(false);const ppW=tW(pp),dpW=tW(dp),rnW=tW(rn),exW=tW(ex),lnW=tW(ln),lrV=pN(lr)/100;const aR=rnW*12,aI=lnW*lrV,aE=exW*12,ni=aR-aE-aI,inv=ppW-dpW-lnW;const gr=ppW>0?aR/ppW*100:0,nt=inv>0?ni/inv*100:0;
const _tips=[];
if(ppW>0&&rnW>0){
  if(lnW>0&&pN(lr)>=4.5){_tips.push("📌 대출 금리 "+fP(pN(lr))+"는 고금리입니다. 대환대출·임대사업자 등록 후 정책자금 전환 시 이자 부담이 줄어 수익률이 개선됩니다.");}
  if(nt<3&&inv>0){_tips.push("📌 순수익률 "+fP(nt)+"는 저조합니다. 임대료 인상(5% 상한)·관리비 절감·리모델링으로 수익률 개선 전략 검토.");}
...
return(<>{showLookup&&<AddressModal onClose={()=>setShowLookup(false)} onApplyPrice={v=>{sPP(String(Math.round(v/10000)));setShowLookup(false);setAutoYieldFill(true);}}/>}<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"3fr 2fr",gap:isMo?16:32,alignItems:"start",minWidth:0}}><div><div style={{fontSize:12,color:"#6b778c",marginBottom:-8,marginLeft:2,display:"flex",alignItems:"center",gap:4,flexWrap:"nowrap"}}>수익률 <TipModal title="임대수익률 계산법"><p><b>Gross:</b> 연임대료÷매입가 / <b>Net:</b> 순수익÷자기자본</p></TipModal></div>{!isMo&&<button onClick={()=>setShowLookup(true)} style={{fontSize:12,color:"#0141f9",background:"none",border:"none",cursor:"pointer",fontWeight:700,fontFamily:"inherit",marginBottom:4,display:"flex",alignItems:"center",gap:4}}><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/></svg>주소로 실거래가 조회</button>}<Inp label="매입가" value={pp} onChange={v=>{sPP(v);setAutoYieldFill(false);}} suffix="만원" placeholder="예: 50000" error={!pp||pp==="0"}/>{autoYieldFill&&pp&&<div style={{fontSize:11,color:"#4285F4",marginTop:-8,marginBottom:8,fontWeight:500}}>📍 주소조회로 자동입력됨 · 직접 수정 가능</div>}{!pp&&<div style={{padding:"12px 14px",background:"#FFF4E6",border:"2px solid #FF8B00",borderRadius:10,fontSize:13,color:"#B8550A",marginTop:-4,marginBottom:12,fontWeight:700,boxShadow:"0 2px 8px rgba(255,139,0,0.15)",display:"flex",alignItems:"center",gap:8}}>💡 매매가격 입력 시 수익률이 계산됩니다</div>}<Inp label="보증금 (전세금)" value={dp} onChange={sDp} suffix="만원" placeholder="예: 10000"/><Inp label="월세" value={rn} onChange={sRn} suffix="만원" placeholder="예: 100"/><Inp label="월 관리비·경비" value={ex} onChange={sEx} suffix="만원" placeholder="예: 20"/><Inp label="대출금액" value={ln} onChange={sLn} suffix="만원" placeholder="예: 20000"/><Inp label="대출 금리" value={lr} onChange={sLr} suffix="%" placeholder="예: 4.0"/></div><RP miss={(!pp&&!dp&&!rn&&!ex&&!ln&&!lr)?MI.yield:null} expertGuide={CALC_NAV_CONTENT.yield?.items} expertGuide={CALC_NAV_CONTENT.yield?.items} isExample={(!pp&&!dp&&!rn&&!ex&&!ln&&!lr)} title="임대수익률"
...
function CalcJoint({isMo=false,onNav=()=>{}}){const[p,sP]=useState("");const[isDefault,setIsDefault]=useState(true);const markModified=()=>setIsDefault(false);const[showLookup,setShowLookup]=useState(false);const[autoJointFill,setAutoJointFill]=useState(false);const[r,sR]=useState("50");const pW=tW(p),rv=pN(r)/100;const sB=Math.max(0,(pW-12e8)*0.6);const j1B=Math.max(0,(pW*rv-9e8*rv)*0.6);const j2B=Math.max(0,(pW*(1-rv)-9e8*(1-rv))*0.6);const C2=[[3e8,.005],[6e8,.007],[12e8,.01],[25e8,.013],[50e8,.015],[94e8,.020],[Infinity,.027]];const sT=pTx(sB,C2),jT=pTx(j1B,C2)+pTx(j2B,C2),sv=sT-jT;return(<>{showLookup&&<AddressModal onClose={()=>setShowLookup(false)} onApplyStd={v=>{sP(String(Math.round(v/10000)));setShowLookup(false);setAutoJointFill(true);}}/>}<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"3fr 2fr",gap:isMo?16:32,alignItems:"start",minWidth:0}}><div><div style={{fontSize:12,color:"#6b778c",marginBottom:-8,marginLeft:2,display:"flex",alignItems:"center",gap:4,flexWrap:"nowrap"}}>공동명의 <TipModal title="공동명의 절세"><p>종부세: 단독 12억 vs 공동 각9억(합18억). 양도세: 각 250만 공제. 고령자·장기보유 공제 불가.</p></TipModal></div>{!isMo&&<button onClick={()=>setShowLookup(true)} style={{fontSize:12,color:"#0141f9",background:"none",border:"none",cursor:"pointer",fontWeight:700,fontFamily:"inherit",marginBottom:4,display:"flex",alignItems:"center",gap:4}}><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/></svg>주소로 공시가격 조회</button>}<Inp label="부동산 공시가격" value={p} onChange={v=>{sP(v);setAutoJointFill(false);}} suffix="만원" placeholder="예: 150000" error={!p||p==="0"}/>{autoJointFill&&p&&<div style={{fontSize:11,color:"#4285F4",marginTop:-8,marginBottom:8,fontWeight:500}}>📍 주소조회로 자동입력됨 · 직접 수정 가능</div>}<div style={{marginBottom:16}}><label style={{display:"block",fontSize:12,fontWeight:600,color:P.mt,marginBottom:6}}>{"지분 비율 — 본인 "+r+"% : 배우자 "+(100-parseInt(r))+"%"}</label><input type="range" min="10" max="90" step="10" value={r} onChange={e=>sR(e.target.value)} style={{width:"100%",accentColor:P.pri}}/><div style={{display:"flex",justifyContent:"space-between",fontSize:11,color:P.mt,marginTop:4}}><span>본인 10%</span><span>본인 90%</span></div></div><div style={{padding:"14px 16px",background:P.lt,borderRadius:10,fontSize:13,color:"#4a5568",lineHeight:1.6}}><b>단독명의:</b> 1주택 공제 12억, 고령자·장기보유 공제 가능<br/><b>공동명의:</b> 각 9억 공제 (합 18억), 고령자·장기보유 공제 불가</div></div><RP miss={isDefault?MI.joint:null} expertGuide={CALC_NAV_CONTENT.joint?.items} expertGuide={CALC_NAV_CONTENT.joint?.items} isExample={isDefault} title={sv>0?"공동명의가 유리":"단독명의가 유리"}
      ...
      total={Math.abs(sv)} sub={"절세액 기준 비교"} items={[{l:"단독명의 (1주택 12억 공제)",v:fW(sT),note:sv<=0?"✓ 유리":""},{l:"공동명의 본인 ("+r+"%)",v:fW(pTx(j1B,C2))},{l:"공동명의 배우자 ("+(100-parseInt(r))+"%)",v:fW(pTx(j2B,C2))},{l:"공동명의 종부세 합계",v:fW(jT),note:sv>0?"✓ 유리":""},{l:"차이 (절세액)",v:fW(Math.abs(sv))},{l:"본인 지분 금액",v:fW(pW*rv)},{l:"배우자 지분 금액",v:fW(pW*(1-rv))}]}/><NextStep calcId="joint" onNav={onNav} isMo={isMo}/><RateTable title="종합부동산세율 (2026)" headers={["과세표준","세율"]} rows={[["3억 이하","0.5%"],["6억 이하","0.7%"],["12억 이하","1.0%"],["25억 이하","1.3%"],["50억 이하","1.5%"],["94억 이하","2.0%"],["94억 초과","2.7%"]]}/></div></>);}
...
function CalcLoanMax({isMo=false,onNav=()=>{}}){
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"1fr 1fr",gap:isMo?16:32,alignItems:"start",minWidth:0}}><div>{!isMo&&<h3 style={{fontSize:isMo?16:18,fontWeight:700,color:P.tx,margin:"0 0 20px"}}>대출가능액 계산기</h3>}<Inp label="연 소득" value={inc} onChange={sInc} suffix="만원" placeholder="예: 5000" error={!inc||inc==="0"}/><Inp label="주택가격 (시가)" value={price} onChange={sPrice} suffix="만원" placeholder="예: 90000" note="입력 시 LTV·주담대 한도 적용"/><Tog label="주택 소재지" value={region} onChange={sRegion} options={[{value:"metro",label:"수도권·규제지역"},{value:"non",label:"비수도권"}]}/><Tog label="DSR 기준" value={dsrLim} onChange={sDsrLim} options={[{value:"40",label:"은행 40%"},{value:"50",label:"비은행 50%"}]}/><Tog label="대출 유형 (스트레스)" value={loanType} onChange={sLT} options={[{value:"fixed",label:"고정"},{value:"mixed",label:"혼합(+0.75p)"},{value:"variable",label:"변동(+1.5p)"}]}/><Inp label="대출 금리" value={rt} onChange={sRt} suffix="%" placeholder="예: 3.5" note={stressRate>0?"스트레스 가산 후 "+fP(adjRate*100)+" 적용":"고정금리 가산 없음"}/>{!isMo&&<BaseRateHint/>}<div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12}}><Sel label="대출 기간" value={yr} onChange={sYr} options={[5,10,15,20,25,30,35,40].map(y=>({value:String(y),label:y+"년"}))}/><Sel label="차주 연령대" value={age} onChange={sAge} options={[{value:"20",label:"20대"},{value:"30",label:"30대"},{value:"40",label:"40대"},{value:"50",label:"50대"},{value:"60",label:"60대"}]}/></div><Inp label="기존 대출 월 상환액" value={ep} onChange={sEp} suffix="만원" placeholder="없으면 0"/>{region==="metro"&&pW>0&&<div style={{padding:"12px 16px",background:"#FFF8E1",border:"1px solid #FFE082",borderRadius:10,fontSize:13,color:"#F57F17",marginTop:12,lineHeight:1.6}}>수도권·규제지역 주담대 한도: 15억↓ 6억 / 25억↓ 4억 / 25억↑ 2억 (2025.6.28~ 시행)</div>}</div><div><RP miss={tW(inc)>0?null:MI.loanmax} expertGuide={CALC_NAV_CONTENT.loanmax?.items} expertGuide={CALC_NAV_CONTENT.loanmax?.items} title="최대 대출가능액"
...
/* 보유세 통합 */
function CalcHoldTax({isMo=false,onNav=()=>{}}){const[h,sH]=useState("1");const[p,sP]=useState("");const[isDefault,setIsDefault]=useState(true);const markModified=()=>setIsDefault(false);const[showHoldLookup,setShowHoldLookup]=useState(false);const[selectedHoldInfo,setSelectedHoldInfo]=useState(null);const[autoHoldFill,setAutoHoldFill]=useState(false);const pW=tW(p);const n=parseInt(h);const ptBase=pW*0.6;const PTB=[[6e7,.001],[1.5e8,.0015],[3e8,.0025],[Infinity,.004]];const ptTax=pTx(ptBase,PTB);const ptCity=Math.round(ptBase*0.0014);const ptEdu=Math.round(ptTax*0.2);const ptTotal=ptTax+ptCity+ptEdu;const cDed=n===1?12e8:9e8;const cBase=Math.max(0,(pW-cDed)*0.6);const CTB=[[3e8,.005],[6e8,.007],[12e8,.01],[25e8,.013],[50e8,.015],[94e8,.020],[Infinity,.027]];const cTax=pTx(cBase,CTB);const cFarm=Math.round(cTax*0.2);const cTotal=cTax+cFarm;const grand=ptTotal+cTotal;return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"3fr 2fr",gap:isMo?16:28,alignItems:"start",minWidth:0}}><div><Radio label="주택 수" value={h} onChange={sH} options={[{value:"1",label:"1주택"},{value:"2",label:"2주택"},{value:"3",label:"3주택 이상"}]}/><div style={{fontSize:13,color:"#374151",fontWeight:600,marginBottom:4,display:"flex",alignItems:"center",gap:6}}>공시가격 <TipModal title=""><p>매년 6.1 기준. realtyprice.kr에서 확인. 재산세: 공시가×60%</p></TipModal></div>{!isMo&&<div style={{marginBottom:10}}><button type="button" onClick={()=>setShowHoldLookup(true)} style={{width:"100%",padding:"12px 16px",background:"linear-gradient(135deg,#eff6ff,#dbeafe)",border:"1.5px solid #bfdbfe",borderRadius:10,fontSize:13,fontWeight:700,color:"#1e40af",cursor:"pointer",fontFamily:"inherit",display:"flex",alignItems:"center",justifyContent:"center",gap:8}}>📍 주소로 공시가격 자동조회</button></div>}{showHoldLookup&&<AddressModal calcType="holding" onClose={()=>setShowHoldLookup(false)} onApplyStd={v=>{sP(String(Math.round(v/10000)));markModified();setAutoHoldFill(true);}} onApplyInfo={info=>setSelectedHoldInfo(info)}/>}{selectedHoldInfo&&!isMo&&<div style={{background:"#eff6ff",border:"1px solid #bfdbfe",borderRadius:10,padding:"10px 14px",marginBottom:8,display:"flex",alignItems:"center",justifyContent:"space-between",gap:8}}>
        <div style={{minWidth:0}}><div style={{fontSize:13,fontWeight:700,color:"#1e40af"}}>{selectedHoldInfo.aptName}{selectedHoldInfo.dongNm?" "+selectedHoldInfo.dongNm+"동":""}{selectedHoldInfo.hoNm?" "+selectedHoldInfo.hoNm+"호":""}</div><div style={{fontSize:11,color:"#3b82f6",marginTop:2}}>{selectedHoldInfo.priceYear?"공시가격 "+selectedHoldInfo.priceYear+"년 기준 자동입력":""}</div></div>
        <button onClick={()=>{setSelectedHoldInfo(null);setShowHoldLookup(true);}} style={{fontSize:12,color:"#0141f9",background:"none",border:"none",cursor:"pointer",fontWeight:700,fontFamily:"inherit",whiteSpace:"nowrap"}}>다시검색</button>
      </div>}<Inp label="" value={p} onChange={v=>{sP(v);setAutoHoldFill(false);}} suffix="만원" placeholder="예: 150000" error={!p||p==="0"}/>{autoHoldFill&&p&&<div style={{fontSize:11,color:"#4285F4",marginTop:-8,marginBottom:8,fontWeight:500}}>📍 주소조회로 자동입력됨 · 직접 수정 가능</div>}</div><div><RP miss={isDefault?MI.holdtax:null} expertGuide={CALC_NAV_CONTENT.holdtax?.items} expertGuide={CALC_NAV_CONTENT.holdtax?.items} isExample={isDefault} title="연간 보유세 합계"
...
function CalcStamp({isMo=false,onNav=()=>{}}){
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"1fr 1fr",gap:isMo?16:32,alignItems:"start",minWidth:0}}><div>{!isMo&&<h3 style={{fontSize:isMo?16:18,fontWeight:700,color:P.tx,margin:"0 0 20px"}}>인지세 계산기</h3>}<div style={{fontSize:12,color:"#6b778c",marginBottom:-8,marginLeft:2,display:"flex",alignItems:"center",gap:4,flexWrap:"nowrap"}}>인지세 <TipModal title="인지세"><p>매매계약서 작성 시 부과. 매도·매수인 각 50% 부담. 1억↓ 비과세.</p></TipModal></div><Inp label="거래금액" value={p} onChange={sP} suffix="만원" placeholder="예: 90000" error={!p||p==="0"}/><label style={{display:"flex",alignItems:"center",gap:6,fontSize:13,cursor:"pointer",marginTop:8}}><input type="checkbox" checked={electronic} onChange={e=>setElectronic(e.target.checked)}/> 전자문서 인지세 (70% 할인)</label><div style={{padding:"14px 16px",background:P.lt,borderRadius:10,fontSize:13,color:"#4a5568",lineHeight:1.6,marginTop:8}}>• 1억 이하: 비과세<br/>• 1억~10억: 15만원<br/>• 10억~30억: 35만원<br/>• 30억 초과: 50만원<br/>※ 전자계약 시 70% 할인</div></div><RP miss={tW(p)>0?null:MI.stamp} expertGuide={CALC_NAV_CONTENT.stamp?.items} expertGuide={CALC_NAV_CONTENT.stamp?.items} title="인지세"
...
function CalcBond({isMo=false,onNav=()=>{}}){
  const[p,sP]=useState("");const[area,sArea]=useState("seoul");const[use,sUse]=useState("house");const[customRate,setCustomRate]=useState("");
  const pW=tW(p);
  let bondRate=0;
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"1fr 1fr",gap:isMo?16:32,alignItems:"start",minWidth:0}}><div>{!isMo&&<h3 style={{fontSize:isMo?16:18,fontWeight:700,color:P.tx,margin:"0 0 20px"}}>국민주택채권 할인비용</h3>}<Inp label="매매 가격" value={p} onChange={sP} suffix="만원" placeholder="예: 90000"/><Tog label="지역" value={area} onChange={sArea} options={[{value:"seoul",label:"서울"},{value:"metro",label:"광역시"},{value:"etc",label:"기타 지역"}]}/><Tog label="용도" value={use} onChange={sUse} options={[{value:"house",label:"주택"},{value:"commercial",label:"상가·오피스텔"}]}/><Inp label="할인율 (실시세)" value={customRate} onChange={setCustomRate} suffix="%" note="증권사 당일 매도가. 일반 4~5%"/></div><RP miss={tW(p)>0?null:MI.bond} expertGuide={CALC_NAV_CONTENT.bond?.items} expertGuide={CALC_NAV_CONTENT.bond?.items} title="채권 할인비용"
      deadline="등기 시 채권 매입 의무 / 증권사·은행에서 당일 매도 가능"
      alertMsg={discountRate>0.05?"할인율 5% 초과: 이례적, 시세 확인 필요":bondRate>=0.05?"최고 매입률 5% 구간":null}
      alertType="info"
      total={discountCost} sub={"매입률 "+fP(bondRate*100)+" · 할인율 "+fP(discountRate*100)} items={[{l:"매매가격",v:fW(pW)},{l:"적용 지역·용도",v:(area==="seoul"?"서울":area==="metro"?"광역시":"기타")+" / "+(use==="house"?"주택":"상가")},{l:"채권매입률",v:fP(bondRate*100)},{l:"채권매입액",v:fW(bondAmt),note:"매매가×매입률"},{l:"할인율 (시세)",v:fP(discountRate*100)},{l:"실제 부담 할인비용",v:fW(discountCost),note:"매입액×할인율"}]}/><NextStep calcId="bond" onNav={onNav} isMo={isMo}/><RateTable title="국민주택채권 매입률" headers={["지역/용도","매입률"]} rows={[["서울 주택","3~5%"],["광역시 주택","2~4%"],["기타 주택","1~3%"],["서울 상가","5~7%"],["광역시 상가","3~5%"],["기타 상가","2~4%"]]}/></div>);}
...
function CalcAppraisal({isMo=false,onNav=()=>{}}){
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"1fr 1fr",gap:isMo?16:32,alignItems:"start",minWidth:0}}><div>{!isMo&&<h3 style={{fontSize:isMo?16:18,fontWeight:700,color:P.tx,margin:"0 0 20px"}}>감정평가 수수료</h3>}<Inp label="감정가액" value={p} onChange={sP} suffix="만원" placeholder="예: 90000"/><Tog label="부가세 처리" value={vatType} onChange={setVatType} options={[{value:"include",label:"VAT 포함"},{value:"exclude",label:"VAT 별도"}]}/><div style={{padding:"14px 16px",background:P.lt,borderRadius:10,fontSize:12,color:"#4a5568",lineHeight:1.8,marginTop:8}}>• 5천만 이하: 기본 20만원<br/>• 5천만~2억: 20만 + 초과분×0.09%<br/>• 2~5억: 15.5만 + 초과분×0.08%<br/>• 5~10억: 39.5만 + 초과분×0.06%<br/>• 10~50억: 69.5만 + 초과분×0.04%</div></div><RP miss={tW(p)>0?null:MI.appraisal} expertGuide={CALC_NAV_CONTENT.appraisal?.items} expertGuide={CALC_NAV_CONTENT.appraisal?.items} title="감정평가 수수료"
...
/* 건물잔존가치 */
function CalcBldValue({isMo=false,onNav=()=>{}}){const[np,sNp]=useState("");const[ul,sUl]=useState("40");const[el,sEl]=useState("");const[mt,sMt]=useState("line");const npW=tW(np),ulV=parseInt(ul),elV=parseInt(el||"0");let remaining=0,depreciation=0;if(npW>0&&ulV>0){if(mt==="line"){const ratio=Math.max(0,Math.min(1,1-elV/ulV));remaining=Math.round(npW*ratio);depreciation=npW-remaining;}else{remaining=Math.round(npW*Math.pow(0.9,elV));depreciation=npW-remaining;}}const pct=npW>0?remaining/npW*100:0;return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"3fr 2fr",gap:isMo?16:32,alignItems:"start",minWidth:0}}><div><Inp label="신축 가격 (재조달원가)" value={np} onChange={sNp} suffix="만원" placeholder="예: 50000"/><Sel label="내용연수" value={ul} onChange={sUl} options={[{value:"20",label:"20년 (경량철골)"},{value:"30",label:"30년 (조적·블록)"},{value:"40",label:"40년 (철근콘크리트)"},{value:"50",label:"50년 (SRC)"}]}/><Inp label="경과연수" value={el} onChange={sEl} placeholder="예: 15"/><Tog label="감가 방법" value={mt} onChange={sMt} options={[{value:"line",label:"정액법"},{value:"declining",label:"정률법 (10%)"}]}/></div><RP miss={(npW>0&&el)?null:MI.bldvalue} expertGuide={CALC_NAV_CONTENT.bldvalue?.items} expertGuide={CALC_NAV_CONTENT.bldvalue?.items} title="건물 잔존가치"
...
function CalcIncTax({isMo=false,onNav=()=>{}}){const[incType,sIT]=useState("salary");const[gross,sGross]=useState("");const[deductions,sDed]=useState("");const[bizType,sBT]=useState("simple");const[bizRate,sBR]=useState("");
  ...
  </div><div><RP miss={tW(gross)>0?null:MI.inctax} expertGuide={CALC_NAV_CONTENT.inctax?.items} expertGuide={CALC_NAV_CONTENT.inctax?.items} title="종합소득세"
...
function CalcYearEnd({isMo=false,onNav=()=>{}}){const[salary,sSal]=useState("");const[card,sCard]=useState("");const[medical,sMed]=useState("");const[edu,sEdu]=useState("");const[donate,sDon]=useState("");const[insurance,sIns]=useState("");const[pension,sPen]=useState("");const[monthlyRent,sMR]=useState("");
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"3fr 2fr",gap:isMo?16:28,alignItems:"start",minWidth:0}}><div>
    <Inp label="총급여 (연봉)" value={salary} onChange={sSal} suffix="만원" placeholder="예: 5000" error={!salary||salary==="0"}/>
    <div style={{background:P.lt,borderRadius:12,padding:16,marginBottom:16}}>
      <div style={{fontSize:14,fontWeight:700,color:P.tx,marginBottom:12,display:"flex",alignItems:"center",gap:6}}><IconUser/> 인적공제 대상</div>
      <div style={{display:"grid",gridTemplateColumns:"1fr",gap:10}}>
        <Inp label="배우자" value={spouse} onChange={sSpouse} suffix="명" placeholder="0 또는 1" note="연소득 100만원 이하"/>
    ...
    <div style={{fontSize:13,color:"#374151",fontWeight:600,marginBottom:4,display:"flex",alignItems:"center",gap:6}}>신용카드·체크카드·현금영수증 <TipModal title=""><p>총급여의 25%를 초과 사용한 금액부터 공제가 시작됩니다.</p><ul style={{paddingLeft:20}}><li><b>신용카드:</b> 15%</li><li><b>체크카드·현금영수증:</b> 30%</li><li><b>전통시장:</b> 40%</li><li><b>대중교통:</b> 80%</li></ul><p>공제 한도: 총급여 7천만원 이하 300만, 1.2억 이하 250만, 1.2억 초과 200만</p></TipModal></div>
    <Inp label="" value={card} onChange={sCard} suffix="만원" placeholder="예: 2000"/>
  ...
  </div><div>{salW<=0&&<RequiredGuide items={[{label:"연봉 (세전)",filled:salW>0}]}/>}<RP miss={salW>0?null:MI.yearend} expertGuide={CALC_NAV_CONTENT.yearend?.items} expertGuide={CALC_NAV_CONTENT.yearend?.items} title={refund>=0?"예상 환급액":"추가 납부 예상"}
...
function CalcNetSalary({isMo=false,onNav=()=>{}}){const[salary,sSal]=useState("");const[family,sFamily]=useState("1");const[child,sChild]=useState("0");const[nonTax,sNT]=useState("");
  ...
  const _tips=[];
  if(salW>0){
    if(nonTaxW===0){_tips.push("📌 식대 월 20만원은 비과세 항목입니다. 회사가 식대를 별도 지급한다면 비과세액 입력 시 실수령액이 늘어납니다.");}
    if(childN===0&&familyN>1){_tips.push("📌 20세 이하 자녀가 있다면 자녀 수를 입력하세요. 자녀세액공제(첫째 15만, 둘째 20만, 셋째↑ 30만)가 추가됩니다.");}
    if(salW>=5e3){_tips.push("📌 연 600만원 연금저축(세액공제 13.2~16.5%) + IRP 300만원 추가 납입 시 연말정산 환급액이 최대 99만원 늘어납니다.");}
    if(salW>=7e3){_tips.push("📌 고소득자는 신용카드보다 체크카드·현금영수증(공제율 30%)이 소득공제에 유리합니다. 총급여 25% 초과분부터 공제.");}
  }
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"1fr 1fr",gap:isMo?16:32,alignItems:"start",minWidth:0}}><div>{!isMo&&<h3 style={{fontSize:isMo?16:18,fontWeight:700,color:P.tx,margin:"0 0 20px"}}>연봉 실수령액</h3>}
    <Inp label="연봉 (세전)" value={salary} onChange={sSal} suffix="만원" placeholder="예: 5000" error={!salary||salary==="0"}/>
    ...
    <div style={{fontSize:13,color:"#374151",fontWeight:600,marginBottom:4,display:"flex",alignItems:"center",gap:6}}>비과세 <TipModal title=""><p>식대 월 20만원 등 비과세 항목. 비과세 금액은 세금 계산에서 제외됩니다.</p><p>근로계약서/급여명세서에서 확인하세요.</p></TipModal></div>
    <Inp label="" value={nonTax} onChange={sNT} suffix="만원" note="식대 20만+자가운전보조 20만 등"/>
  </div><div><div>
    <div style={{background:"linear-gradient(315deg, #0747A6 0%, #0052CC 50%, #0065FF 100%)",borderRadius:20,padding:"28px 24px",color:"#fff",textAlign:"center",marginBottom:16,boxShadow:"0 8px 28px rgba(7,71,166,.28)"}}>
    ...
    <div style={{background:P.card,borderRadius:16,padding:16,border:"1px solid "+P.bd,marginTop:12}}>
      ...
      {[3000,4000,5000,6000,7000,8000,10000].map(salManwon=>{const sy=salManwon*10000;const taxS=Math.max(0,sy-240*10000);const mS=taxS/12;const iP=Math.min(mS,6370000)*.045+mS*.03545+mS*.03545*.1295+mS*.009;let wD=0;if(taxS<=5e6)wD=taxS*.7;else if(taxS<=15e6)wD=3500000+(taxS-5e6)*.4;else if(taxS<=45e6)wD=7500000+(taxS-15e6)*.15;else if(taxS<=1e8)wD=12000000+(taxS-45e6)*.05;else wD=14750000+(taxS-1e8)*.02;const pD=1500000*familyN+1500000*childN;const tI=Math.max(0,taxS-wD-pD-iP*12);const t=pTx(tI,IB);const mT=(t+t*.1)/12;const mN=sy/12-iP-mT;return(<div key={salManwon} style={{display:"flex",justifyContent:"space-between",padding:"6px 0",borderBottom:"1px solid "+P.lt,fontSize:13}}><span style={{color:P.mt}}>{salManwon<10000?salManwon+"만":(salManwon/10000)+"억"}</span><span style={{fontWeight:600}}>{fW(Math.round(mN))}/월</span></div>);})}
    </div>
  </div><SavingsGuide tips={_tips}/><NextStep calcId="netsalary" onNav={onNav} isMo={isMo}/><RateTable title="4대보험 요율 (2025)" headers={["보험","근로자"]} rows={[["국민연금","4.75%"],["건강보험","3.595%"],["장기요양","건보의 12.95%"],["고용보험","0.9%"],["합계(근로자)","약 9.7%"]]}/></div></div>);}

/* 국민연금 수령액 */
function CalcPension({isMo=false,onNav=()=>{}}){const[age,sAge]=useState("35");const[salary,sSal]=useState("");const[paidYears,sPY]=useState("0");const[retireAge,sRA]=useState("65");
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"1fr 1fr",gap:isMo?16:32,alignItems:"start",minWidth:0}}><div>{!isMo&&<h3 style={{fontSize:isMo?16:18,fontWeight:700,color:P.tx,margin:"0 0 20px"}}>국민연금 예상수령액</h3>}
    ...
    <Inp label="현재 월 급여 (세전)" value={salary} onChange={sSal} suffix="만원" placeholder="예: 350" error={!salary||salary==="0"}/>
...
function CalcRetire({isMo=false,onNav=()=>{}}){const[monthly,sM]=useState("");const[years,sY]=useState("");const[months,sMo]=useState("0");
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"1fr 1fr",gap:isMo?16:32,alignItems:"start",minWidth:0}}><div>{!isMo&&<h3 style={{fontSize:isMo?16:18,fontWeight:700,color:P.tx,margin:"0 0 20px"}}>퇴직금 계산기</h3>}
    <Inp label="최근 3개월 평균 월급 (세전)" value={monthly} onChange={sM} suffix="만원" placeholder="예: 400" error={!monthly||monthly==="0"}/>
    <div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"1fr 1fr",gap:isMo?8:12}}><Inp label="근속 년수" value={years} onChange={sY} suffix="년" placeholder="예: 5" error={!years||years==="0"}/><Sel label="추가 개월수" value={months} onChange={sMo} options={Array.from({length:12},(_,i)=>({value:String(i),label:i+"개월"}))}/></div>
  ...
  </div><RP miss={(monthlyW>0&&y>0)?null:MI.retire} expertGuide={CALC_NAV_CONTENT.retire?.items} expertGuide={CALC_NAV_CONTENT.retire?.items} title="예상 퇴직금"
...
function CalcUnemploy({isMo=false,onNav=()=>{}}){const[age,sAge]=useState("30");const[years,sY]=useState("3");const[daily,sD]=useState("");
  const dailyW=parseInt(String(daily).replace(/,/g,""))||0;const ageV=parseInt(age),yV=parseInt(years);
  const minWage2026=10030,minDaily=Math.round(minWage2026*8*0.8),maxDaily=66000;// 2026년 최저시급 10,030원 (고용노동부 고시)
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"1fr 1fr",gap:isMo?16:32,alignItems:"start",minWidth:0}}><div>{!isMo&&<h3 style={{fontSize:isMo?16:18,fontWeight:700,color:P.tx,margin:"0 0 20px"}}>실업급여 계산기</h3>}
    <Inp label="퇴직 전 1일 평균임금" value={daily} onChange={sD} suffix="원" placeholder="예: 150000" note="최근 3개월 급여총액 ÷ 근무일수" error={!daily||daily==="0"}/>
  ...
  </div>{dailyW<=0&&<RequiredGuide items={[{label:"퇴직 전 평균임금",filled:dailyW>0}]}/>}<RP miss={dailyW>0?null:MI.unemploy} expertGuide={CALC_NAV_CONTENT.unemploy?.items} expertGuide={CALC_NAV_CONTENT.unemploy?.items} title="실업급여 예상"
...
function CalcCarTax({isMo=false,onNav=()=>{}}){const[carType,sCT]=useState("normal");const[cc,sCC]=useState("");const[year,sYear]=useState("0");const[isElec,sElec]=useState("no");
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"1fr 1fr",gap:isMo?16:32,alignItems:"start",minWidth:0}}><div>{!isMo&&<h3 style={{fontSize:isMo?16:18,fontWeight:700,color:P.tx,margin:"0 0 20px"}}>자동차세</h3>}
    ...
    {isElec==="no"&&<><Tog label="차량 용도" value={carType} onChange={sCT} options={[{value:"normal",label:"비영업용 (자가용)"},{value:"biz",label:"영업용"}]}/><Inp label="배기량" value={cc} onChange={sCC} suffix="cc" placeholder="예: 2000" note="차량등록증 확인" error={isElec==="no"&&(!cc||cc==="0")}/></>}
  ...
  </div><RP miss={(isElec==="yes"||ccVal>0)?null:MI.cartax} expertGuide={CALC_NAV_CONTENT.cartax?.items} expertGuide={CALC_NAV_CONTENT.cartax?.items} title="자동차세 (연간)"
...
function CalcInsurance4({isMo=false,onNav=()=>{}}){const[type,sType]=useState("worker");const[salary,sSal]=useState("");const[bonus,sBonus]=useState("");
  ...
  const npnCap=6370000,npnBase=Math.min(monthlySal,npnCap),npn=Math.round(npnBase*.045),hi=Math.round(monthlySal*.03545),ltc=Math.round(hi*.1295),ei=Math.round(monthlySal*.009),workerTotal=npn+hi+ltc+ei;
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"1fr 1fr",gap:isMo?16:32,alignItems:"start",minWidth:0}}><div>{!isMo&&<h3 style={{fontSize:isMo?16:18,fontWeight:700,color:P.tx,margin:"0 0 20px"}}>4대보험료</h3>}
    ...
    <Inp label="월 급여 (세전)" value={salary} onChange={sSal} suffix="만원" placeholder="예: 350" error={!salary||salary==="0"}/>
...
function CalcMinWage({isMo=false,onNav=()=>{}}){
  ...
  return(<div style={{display:"grid",gridTemplateColumns:isMo?"1fr":"1fr 1fr",gap:isMo?16:32,alignItems:"start",minWidth:0}}>
    ...
    <div><RP miss={parseFloat(weeklyH)>0?null:MI.minwage} expertGuide={CALC_NAV_CONTENT.minwage?.items} expertGuide={CALC_NAV_CONTENT.minwage?.items} title="예상 급여"
...
function HomeSections({isMo, effectiveUser, navigateCalc, setAuthMode, setShowAuth, navigateInfo}){
  ...
  // 2026.04.15 정책/Q&A fallback (fetch 실패 또는 빈값 시)
  const POLICY_FALLBACK=[
    {title:"이재명 정부 주택공급 확대방안 (2025.09.07)",source:"국토부",link:"https://www.molit.go.kr"},
    {title:"가계부채 관리 강화 방안 (2025.06.27)",source:"금융위",link:"https://www.fsc.go.kr"},
    {title:"3단계 스트레스 DSR 시행방안 (2025.07.01)",source:"금융위",link:"https://www.fsc.go.kr"},
    {title:"2025년 세제개편안 (2025.07.25)",source:"기재부",link:"https://www.moef.go.kr"},
    {title:"최신 LTV·DTI·DSR 기준 (2026.01.01)",source:"금감원",link:"https://www.fss.or.kr"},
  ];
  const COMMUNITY_FALLBACK=[
    {title:"[공지] 피싱·불법 복제 계산기 주의",notice:true,link:"/community/"},
    {title:"[공지] 최신 세법 항상 자동 반영됩니다",notice:true,link:"/community/"},
    {title:"계산기 이용 결과 관련 질문은 관리자가 답변합니다",link:"/community/"},
  ];
  ...
  useEffect(()=>{
    ...
    Promise.all([
      ...
      fj(WORKER+"/news?category=policy&limit=6"),
      fj(WORKER+"/news?category=tax&limit=6"),
      fj(WORKER+"/community?limit=5")
    ]).then(([n,p,t,c])=>{
      if(!alive)return;
      const nArr=extract(n).slice(0,6);
      const pArr=extract(p).slice(0,5);
      const cArr=extract(c).slice(0,5);
      setNews({l:false,d:nArr.length?nArr:[]});
      setPolicy({l:false,d:pArr.length?pArr:POLICY_FALLBACK});
      setTaxTips({l:false,d:extract(t).slice(0,6)});
      setCommunity({l:false,d:cArr.length?cArr:COMMUNITY_FALLBACK});
    });
    return()=>{alive=false};
  },[]);
  useEffect(()=>{
      ...
      <div style={secStyle}>
        <div style={hdrStyle}>
          ...
          <div style={{display:"flex",gap:8,alignItems:"center"}}>
            <a href={effectiveUser?"/community/write.html":"#"} onClick={e=>{if(!effectiveUser){e.preventDefault();setAuthMode("login");setShowAuth(true);}}} style={{...moreLnk,background:"#0747A6",color:"#fff",padding:"4px 10px",borderRadius:6}}>글쓰기</a>
      ...
      <div style={{position:"relative"}}>
        ...
        <div style={{display:"grid",gridTemplateColumns:isMo?"1fr 1fr":"repeat(4,1fr)",gap:isMo?10:14,marginBottom:isMo?20:24}}>
          {[{svg:<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M19 21H5a2 2 0 01-2-2V5a2 2 0 012-2h11l5 5v11a2 2 0 01-2 2z"/><polyline points="17 21 17 13 7 13 7 21"/><polyline points="7 3 7 8 15 8"/></svg>,t:"계산 내역 저장",d:"히스토리 자동 보관"},{svg:<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4M12 8h.01"/></svg>,t:"AI 절세 가이드",d:"비회원 1회 → 회원 3회"},{svg:<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 8A6 6 0 006 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 01-3.46 0"/></svg>,t:"금리·공시가 알림",d:"변동 시 즉시 알림"},{svg:<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>,t:"맞춤 보고서",d:"PDF 다운로드"}].map((b,i)=>(
            <div key={i} style={{background:"rgba(255,255,255,0.1)",borderRadius:12,padding:isMo?"14px 12px":"16px",border:"1px solid rgba(255,255,255,0.15)",transition:"transform .2s,background .2s",cursor:"default"}} onMouseEnter={e=>{e.currentTarget.style.transform="scale(1.05)";e.currentTarget.style.background="rgba(255,255,255,0.18)";}} onMouseLeave={e=>{e.currentTarget.style.transform="scale(1)";e.currentTarget.style.background="rgba(255,255,255,0.1)";}}>
...
function CalcGrid({navigateCalc,isMo}){
  ...
  const DATA=[
    {cat:"tax",label:"세금 계산기",color:"#0747A6",items:[{id:"acquisition",name:"취득세",desc:"매매·증여·상속 시 취득세"},{id:"transfer",name:"양도소득세",desc:"부동산 매도 시 양도차익 세금"},{id:"inctax",name:"종합소득세",desc:"근로·사업·프리랜서 소득세"},{id:"yearend",name:"연말정산",desc:"직장인 환급액 계산"},{id:"compre",name:"종부세",desc:"공시가 기준 종합부동산세"},{id:"property",name:"재산세",desc:"매년 부과되는 재산세"},{id:"gift",name:"증여세",desc:"무상 증여 시 증여세"},{id:"inherit",name:"상속세",desc:"상속 재산에 대한 상속세"},{id:"holdtax",name:"보유세 통합",desc:"재산세+종부세 한번에"},{id:"rental",name:"임대소득세",desc:"주택임대소득 과세"},{id:"bldvat",name:"건물 부가세",desc:"상가·오피스 분양 VAT"},{id:"estincome",name:"임대 추정소득",desc:"간주임대료 기준 추정"},{id:"goodlord",name:"착한임대인 공제",desc:"임대료 인하분 세액공제"},{id:"imputedrent",name:"간주임대료",desc:"전세보증금 환산 과세"},{id:"legalinherit",name:"법정상속분",desc:"민법 1009조 배분"},{id:"progressive",name:"누진세 범용",desc:"세목별 누진세율 계산"}]},
    {cat:"loan",label:"대출 계산기",color:"#00875A",items:[{id:"mortgage",name:"대출이자",desc:"원리금균등·원금균등·만기일시"},{id:"dsr",name:"DSR",desc:"총부채원리금상환비율"},{id:"dti",name:"DTI",desc:"총부채상환비율"},{id:"ltv",name:"LTV·대출한도",desc:"담보인정비율 최대 대출액"},{id:"loanmax",name:"대출가능액",desc:"소득 기준 최대 대출 역산"},{id:"rti",name:"RTI",desc:"임대업 이자상환비율"},{id:"refinance",name:"대환대출 비교",desc:"기존 대출 vs 대환 이자 비교"}]},
    {cat:"cost",label:"비용 계산기",color:"#FF8B00",items:[{id:"commission",name:"중개수수료",desc:"매매·전세·월세 중개보수"},{id:"registration",name:"등기비용",desc:"등록면허세·인지세 합산"},{id:"legal",name:"법무사수수료",desc:"소유권이전 등기 대행"},{id:"stamp",name:"인지세",desc:"거래가액별 인지세"},{id:"bond",name:"채권할인료",desc:"국민주택채권 할인비용"},{id:"appraisal",name:"감정평가수수료",desc:"감정평가사 공식 수수료"},{id:"bond2",name:"국민주택채권 매입",desc:"채권 매입률·할인율 반영"},{id:"stamp2",name:"인지세 (전자계약)",desc:"전자계약 인지세 우대"},{id:"jeonseins",name:"전세보증금 보험료",desc:"HUG·SGI 보증보험료"}]},
    {cat:"life",label:"생활 계산기",color:"#6554C0",items:[{id:"netsalary",name:"연봉 실수령액",desc:"세금·4대보험 공제 후 월급"},{id:"insurance4",name:"4대보험료",desc:"국민연금·건강·고용 보험료"},{id:"pension",name:"국민연금 수령액",desc:"예상 월 연금 수령액"},{id:"cartax",name:"자동차세",desc:"배기량·연식별 자동차세"},{id:"retire",name:"퇴직금",desc:"근속연수별 퇴직금"},{id:"unemploy",name:"실업급여",desc:"고용보험 실업급여"},{id:"minwage",name:"최저임금",desc:"시급→월급→연봉 환산"},{id:"deposit",name:"예적금이자",desc:"예금·적금 세후 이자"},{id:"convert",name:"전월세전환",desc:"전세↔월세 상호 전환"},{id:"datediff",name:"날짜 계산기",desc:"보유기간·D-day 일수 계산"},{id:"luckyday",name:"손없는날 달력",desc:"이사·개업 좋은 날"}]},
    {cat:"realestate",label:"부동산 계산기",color:"#008DA6",items:[{id:"realprice",name:"실거래가 조회",desc:"국토부·호갱노노·네이버 통합 조회"},{id:"yield",name:"임대수익률",desc:"임대수입 순수익률 분석"},{id:"joint",name:"공동명의",desc:"단독 vs 공동 종부세 비교"},{id:"area",name:"평수변환",desc:"㎡ ↔ 평 상호 변환"},{id:"far",name:"용적률·건폐율",desc:"대지면적 기준 건축 규제"},{id:"auction",name:"경매비용",desc:"낙찰가 기준 총비용"},{id:"remodel",name:"리모델링수익",desc:"분담금 대비 수익률"},{id:"bldvalue",name:"건물잔존가치",desc:"경과연수별 감가상각"},{id:"subscription",name:"청약가점",desc:"무주택·부양가족·통장 가점"},{id:"netsale",name:"매도 실수령액",desc:"양도세·중개비 차감 실수령"},{id:"auction2",name:"경매 적정입찰가",desc:"수익률 기반 입찰가 산정"},{id:"auctiondiv",name:"경매 배당 분석",desc:"채권자 배당 순위·금액"},{id:"auctionloan",name:"경락잔금대출",desc:"경매 낙찰가 기준 대출한도"},{id:"reconyear",name:"재건축 연한",desc:"준공일 기준 재건축 가능"},{id:"remodel2",name:"리모델링 ROI",desc:"공사비·기회비용 반영 수익"},{id:"rentincrease",name:"임대료 5% 상한",desc:"임대차 2법 상한 계산"}]},
...
function CommunityPage({isMo,navigateHome,effectiveUser,setAuthMode,setShowAuth}){
  const[items,setItems]=useState([]);const[loading,setLoading]=useState(true);
  const[isAdmin,setIsAdmin]=useState(false);
  const lcToken=(()=>{try{return localStorage.getItem('lc_token')||''}catch{return ''}})();
  useEffect(()=>{let alive=true;
    fetch(LC_API+"/community?limit=30",{cache:"no-store"})
      .then(r=>r.ok?r.json():null).then(j=>{if(!alive)return;setItems(_spaExtract(j));setLoading(false);})
      .catch(()=>{if(alive){setItems([]);setLoading(false);}});
    if(lcToken){fetch(LC_REALESTATE_WORKER+"/auth/verify",{headers:{Authorization:"Bearer "+lcToken}}).then(r=>r.json()).then(j=>{if(alive&&j.valid&&j.isAdmin)setIsAdmin(true);}).catch(()=>{});}
    return()=>{alive=false};
  },[]);
  ...
  return(<div style={{maxWidth:1000,margin:"0 auto",padding:isMo?"24px 16px":"40px 24px",minHeight:"60vh"}}>
    ...
    {loading?<div style={{padding:40,textAlign:"center",color:"#6b778c"}}>불러오는 중...</div>:items.length===0?<div style={{padding:40,textAlign:"center",color:"#6b778c"}}>게시글이 없습니다.</div>:<div style={{background:"#fff",border:"1px solid #dfe1e6",borderRadius:12,overflow:"hidden"}}>{items.map((p,i)=>(<a key={i} href={"/community/?id="+(p.id||"")} style={{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"14px 20px",borderBottom:i<items.length-1?"1px solid #f4f5f7":"none",textDecoration:"none",color:"inherit",gap:12}}>
      <div style={{flex:1,minWidth:0}}>
        <div style={{fontSize:14,fontWeight:600,color:"#172B4D",marginBottom:4}}>{p.notice?"📌 ":""}{p.title||"(제목 없음)"}</div>
      ...
      {isAdmin&&<div style={{display:"flex",gap:4,flexShrink:0}}>
        <button onClick={e=>handlePin(p.id,e)} style={{padding:"4px 8px",fontSize:11,fontWeight:600,color:"#0747A6",background:"#eff6ff",border:"1px solid #bfdbfe",borderRadius:6,cursor:"pointer",fontFamily:"inherit"}}>고정</button>
        <button onClick={e=>handleDelete(p.id,e)} style={{padding:"4px 8px",fontSize:11,fontWeight:600,color:"#dc2626",background:"#fef2f2",border:"1px solid #fecaca",borderRadius:6,cursor:"pointer",fontFamily:"inherit"}}>삭제</button>
      </div>}
    </a>))}</div>}
  </div>);
}
...
export default function App(){
  ...
  const[lcName,setLcName]=useState(()=>{try{return localStorage.getItem('lc_name')||""}catch{return""}});
  ...
  // 2026.04.15 메가메뉴 상위 탭 클릭 시 안내 텍스트 빨간색 표시용 상태
  const[clickedCat,setClickedCat]=useState(null);
  const clickedRecently=useRef(false);
  const closeMenu=()=>{setShowInfoMenu(false);setClickedCat(null);clickedRecently.current=true;setTimeout(()=>{clickedRecently.current=false;},500);};
  const megaOpen=()=>{if(clickedRecently.current)return;setShowInfoMenu(true);};
  const megaClose=()=>{setShowInfoMenu(false);setClickedCat(prev=>prev==="info"?null:prev);};
  ...
  const navigateCalc=(catId,calcId)=>{setCat(catId);setCalc(calcId);setPage("calc");setSessionKey(k=>k+1);const slug=SLUGS[calcId]||calcId;history.pushState(null,"","/"+encodeURIComponent(slug));window.scrollTo(0,0);const info=CL.find(c=>c.id===calcId);if(info){saveHistory(calcId,info.l,1);fetch(LC_REALESTATE_WORKER+"/api/admin/track",{method:"POST",headers:{"Content-Type":"application/json; charset=utf-8"},body:JSON.stringify({calcId,calcName:info.l,referrer:document.referrer})}).catch(()=>{});}};
  ...
  const handleLogout=async()=>{setUser(null);try{localStorage.removeItem('lc_token');localStorage.removeItem('lc_email');localStorage.removeItem('lc_name');}catch{}setLcToken("");setLcEmail("");setLcName("");history.pushState(null,"","/");setPage("home");window.scrollTo(0,0);};
  const effectiveUser=user||(lcEmail?{email:lcEmail,user_metadata:{full_name:lcName||lcEmail.split("@")[0]},created_at:new Date().toISOString()}:null);
...
.guide-card .seo{counter-reset:guide-num}
.seo h3{font-size:17px;font-weight:800;color:#0a1628;margin:24px 0 8px;display:flex;align-items:center;gap:8px}
.guide-card .seo h3::before{counter-increment:guide-num;content:counter(guide-num);width:24px;height:24px;border-radius:7px;background:#deebff;color:#0747A6;display:inline-flex;align-items:center;justify-content:center;font-size:12px;font-weight:800;flex-shrink:0}
...
.req-mark{color:#3b82f6;margin-left:2px;font-weight:700}
          ...
          <div style={{position:"absolute",left:"50%",top:0,bottom:0,transform:"translateX(-50%)",display:"flex",alignItems:"center",gap:4}}>
            {CATS.map(c=>{const items=CL.filter(cl=>cl.c===c.id);const active=cat===c.id&&page!=="home";const hot=hoverCat===c.id;const clicked=clickedCat===c.id;return(
              <div key={c.id} onMouseEnter={()=>setHoverCat(c.id)} onMouseLeave={()=>{setHoverCat(null);setClickedCat(prev=>prev===c.id?null:prev);}} style={{position:"relative"}}>
                <button type="button" onMouseDown={(e)=>e.preventDefault()} onMouseEnter={()=>{setHoverCat(c.id);setClickedCat(c.id);}} onClick={(e)=>{e.preventDefault();e.stopPropagation();const next=hoverCat===c.id?null:c.id;setHoverCat(next);setClickedCat(next);}} style={{padding:"0 16px",border:"none",borderRadius:0,background:hot?"#ffffff":"transparent",color:hot?"#3b82f6":(active?"#0747A6":"#6B7280"),fontSize:16,fontWeight:active?700:600,cursor:"pointer",fontFamily:"inherit",borderBottom:hot?"none":(active?"3px solid #0747A6":"3px solid transparent"),transition:"transform 0.2s cubic-bezier(0.34, 1.56, 0.64, 1), color 0.15s, background .15s, box-shadow .15s",height:64,display:"inline-flex",alignItems:"center",gap:6,transform:hot?"translateY(-4px)":"translateY(0)",transformOrigin:"center center",willChange:"transform",position:"relative",zIndex:hot?1001:"auto",boxShadow:hot?"0 1px 0 0 #ffffff":"none",outline:"none"}}><span style={{display:"inline-flex"}}>{TAB_ICONS[c.id]}</span>{c.l}</button>
                {hot&&<div style={{position:"absolute",top:"100%",left:0,paddingTop:0,zIndex:1000,marginTop:-1}}>
                  <div onMouseEnter={()=>setClickedCat(null)} style={{background:"#fff",borderRadius:"0 0 8px 8px",border:"1px solid #E5E7EB",borderTop:"none",boxShadow:"0 8px 24px rgba(0,0,0,0.12)",padding:"8px 0",minWidth:220}}>
                    <div style={{fontSize:12,color:clicked?"#0141f9":"#6B7280",padding:"8px 16px 4px",borderBottom:"1px solid #F3F4F6",animation:"blink 1.5s ease-in-out infinite",fontWeight:clicked?700:400,transition:"color .15s"}}>아래 계산기 종류를 선택하세요</div>
            ...
            <div onMouseEnter={megaOpen} onMouseLeave={megaClose} style={{position:"relative"}}>
              ...
              {showInfoMenu&&<div onMouseEnter={()=>{if(clickedCat==="info")setClickedCat(null);}} style={{position:"absolute",top:"100%",right:0,marginTop:-1,width:720,background:"#fff",borderTop:"2px solid #0747A6",borderRadius:"0 0 12px 12px",boxShadow:"0 8px 24px rgba(0,0,0,0.12)",zIndex:1000,padding:24}}>
